...
public final class NameGenerator
{
    ...
    public static String generateName() {
        ...
        for (int i = 0; i < nameLength; ++i) {
            ...
            if ((NameGenerator.random.nextBoolean() || usedConsonants == 1) && usedVowels < 2) {
        ...
        final boolean number = NameGenerator.random.nextBoolean();
        if (number) {
            if (numberLength == 1) {
        ...
        final boolean leet = !number && NameGenerator.random.nextBoolean();
        if (leet) {
