...
public class PasswordField extends Gui
{
    ...
    public PasswordField(final FontRenderer fontrendererObj, final int x, final int y, final int par5Width, final int par6Height) {
        this.text = "";
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                j2 = this.fontRendererInstance.drawStringWithShadow(stars, (float)l, (float)i2, i);
            }
