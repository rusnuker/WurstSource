...
public final class Window
{
    ...
    public void pack() {
        ...
        maxChildWidth += 4;
        int titleBarWidth = Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.title) + 4;
        if (this.minimizable) {
            titleBarWidth += 11;
        }
        if (this.pinnable) {
    ...
    public void startDraggingScrollbar(final int mouseY) {
        ...
        final double scrollbarY = outerHeight * (-this.scrollOffset / (double)this.innerHeight) + 1.0;
