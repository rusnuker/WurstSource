...
public final class EditBlockListScreen extends GuiScreen
{
    ...
    public EditBlockListScreen(final GuiScreen prevScreen, final BlockListSetting blockList) {
    ...
    @Override
    public void initGui() {
        (this.listGui = new ListGui(this.mc, this, this.blockList.getBlockNames())).registerScrollButtons(7, 8);
        this.blockNameField = new GuiTextField(1, this.mc.fontRendererObj, this.width / 2 - 152, this.height - 55, 150, 18);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, String.valueOf(this.blockList.getName()) + " (" + this.listGui.getSize() + ")", this.width / 2, 12, 16777215);
        ...
        if (this.blockNameField.getText().isEmpty() && !this.blockNameField.isFocused()) {
            this.drawString(this.mc.fontRendererObj, "block name or ID", 68, this.height - 50, 8421504);
        }
        ...
        this.listGui.renderIconAndGetName(new ItemStack(this.blockToAdd), 52, this.height - 52, false);
        GL11.glPopMatrix();
    }
    ...
    private static class ListGui extends GuiSlot
    {
        ...
        protected void drawSlot(final int index, final int x, final int y, final int var4, final int var5, final int var6, final float partialTicks) {
            ...
            fr.drawString("ID: " + Block.getIdFromBlock(Block.getBlockFromName(name)), x + 28, y + 18, 10526880);
        }
