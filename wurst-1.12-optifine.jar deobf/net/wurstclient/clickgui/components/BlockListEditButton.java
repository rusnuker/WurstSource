...
public final class BlockListEditButton extends Component
{
    ...
    public void handleMouseClick(final int mouseX, final int mouseY, final int mouseButton) {
        ...
        Minecraft.getMinecraft().openScreen(new EditBlockListScreen(Minecraft.getMinecraft().currentScreen, this.setting));
    }
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        GL11.glEnable(3553);
        final FontRenderer fr = Fonts.segoe18;
        final String text = String.valueOf(this.setting.getName()) + ": " + this.setting.getBlockNames().size();
