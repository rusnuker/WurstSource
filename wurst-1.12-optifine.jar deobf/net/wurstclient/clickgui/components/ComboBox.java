...
public final class ComboBox extends Component
{
    ...
    public ComboBox(final EnumSetting setting) {
        ...
        this.popupWidth = Arrays.stream(setting.getValues()).mapToInt(v -> fontRenderer.getStringWidth(v.toString())).max().getAsInt();
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        fr.drawString(this.setting.getSelected().toString(), x4 + 2, y1 - 1, 15790320);
        GL11.glDisable(3553);
    }
