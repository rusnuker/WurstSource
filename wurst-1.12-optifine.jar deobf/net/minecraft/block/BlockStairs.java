...
public class BlockStairs extends Block
{
    ...
    protected static final Box AABB_SLAB_TOP;
    protected static final Box AABB_QTR_TOP_WEST;
    protected static final Box AABB_QTR_TOP_EAST;
    protected static final Box AABB_QTR_TOP_NORTH;
    protected static final Box AABB_QTR_TOP_SOUTH;
    protected static final Box AABB_OCT_TOP_NW;
    protected static final Box AABB_OCT_TOP_NE;
    protected static final Box AABB_OCT_TOP_SW;
    protected static final Box AABB_OCT_TOP_SE;
    protected static final Box AABB_SLAB_BOTTOM;
    protected static final Box AABB_QTR_BOT_WEST;
    protected static final Box AABB_QTR_BOT_EAST;
    protected static final Box AABB_QTR_BOT_NORTH;
    protected static final Box AABB_QTR_BOT_SOUTH;
    protected static final Box AABB_OCT_BOT_NW;
    protected static final Box AABB_OCT_BOT_NE;
    protected static final Box AABB_OCT_BOT_SW;
    protected static final Box AABB_OCT_BOT_SE;
    ...
    static {
        ...
        AABB_SLAB_TOP = new Box(0.0, 0.5, 0.0, 1.0, 1.0, 1.0);
        AABB_QTR_TOP_WEST = new Box(0.0, 0.5, 0.0, 0.5, 1.0, 1.0);
        AABB_QTR_TOP_EAST = new Box(0.5, 0.5, 0.0, 1.0, 1.0, 1.0);
        AABB_QTR_TOP_NORTH = new Box(0.0, 0.5, 0.0, 1.0, 1.0, 0.5);
        AABB_QTR_TOP_SOUTH = new Box(0.0, 0.5, 0.5, 1.0, 1.0, 1.0);
        AABB_OCT_TOP_NW = new Box(0.0, 0.5, 0.0, 0.5, 1.0, 0.5);
        AABB_OCT_TOP_NE = new Box(0.5, 0.5, 0.0, 1.0, 1.0, 0.5);
        AABB_OCT_TOP_SW = new Box(0.0, 0.5, 0.5, 0.5, 1.0, 1.0);
        AABB_OCT_TOP_SE = new Box(0.5, 0.5, 0.5, 1.0, 1.0, 1.0);
        AABB_SLAB_BOTTOM = new Box(0.0, 0.0, 0.0, 1.0, 0.5, 1.0);
        AABB_QTR_BOT_WEST = new Box(0.0, 0.0, 0.0, 0.5, 0.5, 1.0);
        AABB_QTR_BOT_EAST = new Box(0.5, 0.0, 0.0, 1.0, 0.5, 1.0);
        AABB_QTR_BOT_NORTH = new Box(0.0, 0.0, 0.0, 1.0, 0.5, 0.5);
        AABB_QTR_BOT_SOUTH = new Box(0.0, 0.0, 0.5, 1.0, 0.5, 1.0);
        AABB_OCT_BOT_NW = new Box(0.0, 0.0, 0.0, 0.5, 0.5, 0.5);
        AABB_OCT_BOT_NE = new Box(0.5, 0.0, 0.0, 1.0, 0.5, 0.5);
        AABB_OCT_BOT_SW = new Box(0.0, 0.0, 0.5, 0.5, 0.5, 1.0);
        AABB_OCT_BOT_SE = new Box(0.5, 0.0, 0.5, 1.0, 0.5, 1.0);
    }
    ...
    @Override
    public void addCollisionBoxToList(IBlockState state, final World worldIn, final BlockPos pos, final Box entityBox, final List<Box> collidingBoxes, @Nullable final Entity entityIn, final boolean p_185477_7_) {
        if (!p_185477_7_) {
            state = this.getActualState(state, worldIn, pos);
        }
        for (final Box axisalignedbb : getCollisionBoxList(state)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, axisalignedbb);
        }
    }
    
    private static List<Box> getCollisionBoxList(final IBlockState bstate) {
    ...
    private static Box getCollQuarterBlock(final IBlockState bstate) {
        final boolean flag = bstate.getValue(BlockStairs.HALF) == EnumHalf.TOP;
    ...
    private static Box getCollEighthBlock(final IBlockState bstate) {
    ...
    public BlockFaceShape func_193383_a(final IBlockAccess p_193383_1_, IBlockState p_193383_2_, final BlockPos p_193383_3_, final EnumFacing p_193383_4_) {
        ...
        if (p_193383_4_.getAxis() == EnumFacing.Axis.Y) {
            return (p_193383_4_ == EnumFacing.UP == (p_193383_2_.getValue(BlockStairs.HALF) == EnumHalf.TOP)) ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
        }
        final EnumShape blockstairs$enumshape = p_193383_2_.getValue(BlockStairs.SHAPE);
        if (blockstairs$enumshape == EnumShape.OUTER_LEFT || blockstairs$enumshape == EnumShape.OUTER_RIGHT) {
            return BlockFaceShape.UNDEFINED;
        }
        final EnumFacing enumfacing = p_193383_2_.getValue((IProperty<EnumFacing>)BlockStairs.FACING);
    ...
    @Override
    public Box getSelectedBoundingBox(final IBlockState state, final World worldIn, final BlockPos pos) {
    ...
    public RayTraceResult collisionRayTrace(final IBlockState blockState, final World worldIn, final BlockPos pos, final Vec3d start, final Vec3d end) {
        ...
        for (final Box axisalignedbb : getCollisionBoxList(this.getActualState(blockState, worldIn, pos))) {
