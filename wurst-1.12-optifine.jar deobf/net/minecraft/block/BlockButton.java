...
public abstract class BlockButton extends BlockDirectional
{
    ...
    protected static final Box AABB_DOWN_OFF;
    protected static final Box AABB_UP_OFF;
    protected static final Box AABB_NORTH_OFF;
    protected static final Box AABB_SOUTH_OFF;
    protected static final Box AABB_WEST_OFF;
    protected static final Box AABB_EAST_OFF;
    protected static final Box AABB_DOWN_ON;
    protected static final Box AABB_UP_ON;
    protected static final Box AABB_NORTH_ON;
    protected static final Box AABB_SOUTH_ON;
    protected static final Box AABB_WEST_ON;
    protected static final Box AABB_EAST_ON;
    private final boolean wooden;
    
    static {
        POWERED = PropertyBool.create("powered");
        AABB_DOWN_OFF = new Box(0.3125, 0.875, 0.375, 0.6875, 1.0, 0.625);
        AABB_UP_OFF = new Box(0.3125, 0.0, 0.375, 0.6875, 0.125, 0.625);
        AABB_NORTH_OFF = new Box(0.3125, 0.375, 0.875, 0.6875, 0.625, 1.0);
        AABB_SOUTH_OFF = new Box(0.3125, 0.375, 0.0, 0.6875, 0.625, 0.125);
        AABB_WEST_OFF = new Box(0.875, 0.375, 0.3125, 1.0, 0.625, 0.6875);
        AABB_EAST_OFF = new Box(0.0, 0.375, 0.3125, 0.125, 0.625, 0.6875);
        AABB_DOWN_ON = new Box(0.3125, 0.9375, 0.375, 0.6875, 1.0, 0.625);
        AABB_UP_ON = new Box(0.3125, 0.0, 0.375, 0.6875, 0.0625, 0.625);
        AABB_NORTH_ON = new Box(0.3125, 0.375, 0.9375, 0.6875, 0.625, 1.0);
        AABB_SOUTH_ON = new Box(0.3125, 0.375, 0.0, 0.6875, 0.625, 0.0625);
        AABB_WEST_ON = new Box(0.9375, 0.375, 0.3125, 1.0, 0.625, 0.6875);
        AABB_EAST_ON = new Box(0.0, 0.375, 0.3125, 0.0625, 0.625, 0.6875);
    }
    ...
    protected static boolean canPlaceBlock(final World worldIn, final BlockPos pos, final EnumFacing direction) {
        ...
        final boolean flag = iblockstate.func_193401_d(worldIn, blockpos, direction) == BlockFaceShape.SOLID;
        final Block block = iblockstate.getBlock();
        if (direction == EnumFacing.UP) {
            return block == Blocks.HOPPER || (!Block.func_193384_b(block) && flag);
        }
        return !Block.func_193382_c(block) && flag;
    }
    ...
    private void checkPressed(final IBlockState p_185616_1_, final World p_185616_2_, final BlockPos p_185616_3_) {
        final List<? extends Entity> list = p_185616_2_.getEntitiesWithinAABB((Class<? extends Entity>)EntityArrow.class, p_185616_1_.getBoundingBox(p_185616_2_, p_185616_3_).offset(p_185616_3_));
        final boolean flag = !list.isEmpty();
        final boolean flag2 = p_185616_1_.getValue((IProperty<Boolean>)BlockButton.POWERED);
        if (flag && !flag2) {
            p_185616_2_.setBlockState(p_185616_3_, p_185616_1_.withProperty((IProperty<Comparable>)BlockButton.POWERED, true));
            this.notifyNeighbors(p_185616_2_, p_185616_3_, p_185616_1_.getValue((IProperty<EnumFacing>)BlockButton.FACING));
            p_185616_2_.markBlockRangeForRenderUpdate(p_185616_3_, p_185616_3_);
            this.playClickSound(null, p_185616_2_, p_185616_3_);
        }
        if (!flag && flag2) {
            p_185616_2_.setBlockState(p_185616_3_, p_185616_1_.withProperty((IProperty<Comparable>)BlockButton.POWERED, false));
            this.notifyNeighbors(p_185616_2_, p_185616_3_, p_185616_1_.getValue((IProperty<EnumFacing>)BlockButton.FACING));
            p_185616_2_.markBlockRangeForRenderUpdate(p_185616_3_, p_185616_3_);
