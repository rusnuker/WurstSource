...
public class BlockCocoa extends BlockHorizontal implements IGrowable
{
    ...
    protected static final Box[] COCOA_EAST_AABB;
    protected static final Box[] COCOA_WEST_AABB;
    protected static final Box[] COCOA_NORTH_AABB;
    protected static final Box[] COCOA_SOUTH_AABB;
    
    static {
        AGE = PropertyInteger.create("age", 0, 2);
        COCOA_EAST_AABB = new Box[] { new Box(0.6875, 0.4375, 0.375, 0.9375, 0.75, 0.625), new Box(0.5625, 0.3125, 0.3125, 0.9375, 0.75, 0.6875), new Box(0.4375, 0.1875, 0.25, 0.9375, 0.75, 0.75) };
        COCOA_WEST_AABB = new Box[] { new Box(0.0625, 0.4375, 0.375, 0.3125, 0.75, 0.625), new Box(0.0625, 0.3125, 0.3125, 0.4375, 0.75, 0.6875), new Box(0.0625, 0.1875, 0.25, 0.5625, 0.75, 0.75) };
        COCOA_NORTH_AABB = new Box[] { new Box(0.375, 0.4375, 0.0625, 0.625, 0.75, 0.3125), new Box(0.3125, 0.3125, 0.0625, 0.6875, 0.75, 0.4375), new Box(0.25, 0.1875, 0.0625, 0.75, 0.75, 0.5625) };
        COCOA_SOUTH_AABB = new Box[] { new Box(0.375, 0.4375, 0.6875, 0.625, 0.75, 0.9375), new Box(0.3125, 0.3125, 0.5625, 0.6875, 0.75, 0.9375), new Box(0.25, 0.1875, 0.4375, 0.75, 0.75, 0.9375) };
    }
