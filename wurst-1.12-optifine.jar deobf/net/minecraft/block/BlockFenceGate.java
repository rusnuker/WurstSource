...
public class BlockFenceGate extends BlockHorizontal
{
    ...
    protected static final Box AABB_COLLIDE_ZAXIS;
    protected static final Box AABB_COLLIDE_XAXIS;
    protected static final Box AABB_COLLIDE_ZAXIS_INWALL;
    protected static final Box AABB_COLLIDE_XAXIS_INWALL;
    protected static final Box AABB_CLOSED_SELECTED_ZAXIS;
    protected static final Box AABB_CLOSED_SELECTED_XAXIS;
    
    static {
        OPEN = PropertyBool.create("open");
        POWERED = PropertyBool.create("powered");
        IN_WALL = PropertyBool.create("in_wall");
        AABB_COLLIDE_ZAXIS = new Box(0.0, 0.0, 0.375, 1.0, 1.0, 0.625);
        AABB_COLLIDE_XAXIS = new Box(0.375, 0.0, 0.0, 0.625, 1.0, 1.0);
        AABB_COLLIDE_ZAXIS_INWALL = new Box(0.0, 0.0, 0.375, 1.0, 0.8125, 0.625);
        AABB_COLLIDE_XAXIS_INWALL = new Box(0.375, 0.0, 0.0, 0.625, 0.8125, 1.0);
        AABB_CLOSED_SELECTED_ZAXIS = new Box(0.0, 0.0, 0.375, 1.0, 1.5, 0.625);
        AABB_CLOSED_SELECTED_XAXIS = new Box(0.375, 0.0, 0.0, 0.625, 1.5, 1.0);
    }
