...
public class BlockCake extends Block
{
    ...
    protected static final Box[] CAKE_AABB;
    
    static {
        BITES = PropertyInteger.create("bites", 0, 6);
        CAKE_AABB = new Box[] { new Box(0.0625, 0.0, 0.0625, 0.9375, 0.5, 0.9375), new Box(0.1875, 0.0, 0.0625, 0.9375, 0.5, 0.9375), new Box(0.3125, 0.0, 0.0625, 0.9375, 0.5, 0.9375), new Box(0.4375, 0.0, 0.0625, 0.9375, 0.5, 0.9375), new Box(0.5625, 0.0, 0.0625, 0.9375, 0.5, 0.9375), new Box(0.6875, 0.0, 0.0625, 0.9375, 0.5, 0.9375), new Box(0.8125, 0.0, 0.0625, 0.9375, 0.5, 0.9375) };
    }
