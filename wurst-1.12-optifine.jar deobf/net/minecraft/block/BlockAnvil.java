...
public class BlockAnvil extends BlockFalling
{
    ...
    protected static final Box X_AXIS_AABB;
    protected static final Box Z_AXIS_AABB;
    protected static final Logger LOGGER;
    
    static {
        FACING = BlockHorizontal.FACING;
        DAMAGE = PropertyInteger.create("damage", 0, 2);
        X_AXIS_AABB = new Box(0.0, 0.0, 0.125, 1.0, 1.0, 0.875);
        Z_AXIS_AABB = new Box(0.125, 0.0, 0.0, 0.875, 1.0, 1.0);
