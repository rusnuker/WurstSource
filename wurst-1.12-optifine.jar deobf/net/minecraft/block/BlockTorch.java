...
public class BlockTorch extends Block
{
    ...
    protected static final Box STANDING_AABB;
    protected static final Box TORCH_NORTH_AABB;
    protected static final Box TORCH_SOUTH_AABB;
    protected static final Box TORCH_WEST_AABB;
    protected static final Box TORCH_EAST_AABB;
    ...
    static {
        ...
        STANDING_AABB = new Box(0.4000000059604645, 0.0, 0.4000000059604645, 0.6000000238418579, 0.6000000238418579, 0.6000000238418579);
        TORCH_NORTH_AABB = new Box(0.3499999940395355, 0.20000000298023224, 0.699999988079071, 0.6499999761581421, 0.800000011920929, 1.0);
        TORCH_SOUTH_AABB = new Box(0.3499999940395355, 0.20000000298023224, 0.0, 0.6499999761581421, 0.800000011920929, 0.30000001192092896);
        TORCH_WEST_AABB = new Box(0.699999988079071, 0.20000000298023224, 0.3499999940395355, 1.0, 0.800000011920929, 0.6499999761581421);
        TORCH_EAST_AABB = new Box(0.0, 0.20000000298023224, 0.3499999940395355, 0.30000001192092896, 0.800000011920929, 0.6499999761581421);
    }
    ...
    private boolean canPlaceAt(final World worldIn, final BlockPos pos, final EnumFacing facing) {
        ...
        final BlockFaceShape blockfaceshape = iblockstate.func_193401_d(worldIn, blockpos, facing);
        return (facing.equals(EnumFacing.UP) && this.canPlaceOn(worldIn, blockpos)) || (facing != EnumFacing.UP && facing != EnumFacing.DOWN && (!Block.func_193382_c(block) && blockfaceshape == BlockFaceShape.SOLID));
    }
    ...
    public void randomDisplayTick(final IBlockState stateIn, final World worldIn, final BlockPos pos, final Random rand) {
        ...
        if (enumfacing.getAxis().isHorizontal()) {
            final EnumFacing enumfacing2 = enumfacing.getOpposite();
            worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0 + 0.27 * enumfacing2.getFrontOffsetX(), d2 + 0.22, d3 + 0.27 * enumfacing2.getFrontOffsetZ(), 0.0, 0.0, 0.0, new int[0]);
            worldIn.spawnParticle(EnumParticleTypes.FLAME, d0 + 0.27 * enumfacing2.getFrontOffsetX(), d2 + 0.22, d3 + 0.27 * enumfacing2.getFrontOffsetZ(), 0.0, 0.0, 0.0, new int[0]);
        }
        else {
