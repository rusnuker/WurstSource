...
public abstract class BlockSlab extends Block
{
    ...
    protected static final Box AABB_BOTTOM_HALF;
    protected static final Box AABB_TOP_HALF;
    
    static {
        HALF = PropertyEnum.create("half", EnumBlockHalf.class);
        AABB_BOTTOM_HALF = new Box(0.0, 0.0, 0.0, 1.0, 0.5, 1.0);
        AABB_TOP_HALF = new Box(0.0, 0.5, 0.0, 1.0, 1.0, 1.0);
    }
