...
public class BlockChorusPlant extends Block
{
    ...
    public Box getBoundingBox(IBlockState state, final IBlockAccess source, final BlockPos pos) {
        ...
        return new Box(f2, f3, f4, f5, f6, f7);
    }
    ...
    public void addCollisionBoxToList(IBlockState state, final World worldIn, final BlockPos pos, final Box entityBox, final List<Box> collidingBoxes, @Nullable final Entity entityIn, final boolean p_185477_7_) {
        ...
        Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.1875, 0.1875, 0.1875, 0.8125, 0.8125, 0.8125));
        if (state.getValue((IProperty<Boolean>)BlockChorusPlant.WEST)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.0, 0.1875, 0.1875, 0.1875, 0.8125, 0.8125));
        }
        if (state.getValue((IProperty<Boolean>)BlockChorusPlant.EAST)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.8125, 0.1875, 0.1875, 1.0, 0.8125, 0.8125));
        }
        if (state.getValue((IProperty<Boolean>)BlockChorusPlant.UP)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.1875, 0.8125, 0.1875, 0.8125, 1.0, 0.8125));
        }
        if (state.getValue((IProperty<Boolean>)BlockChorusPlant.DOWN)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.1875, 0.0, 0.1875, 0.8125, 0.1875, 0.8125));
        }
        if (state.getValue((IProperty<Boolean>)BlockChorusPlant.NORTH)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.1875, 0.1875, 0.0, 0.8125, 0.8125, 0.1875));
        }
        if (state.getValue((IProperty<Boolean>)BlockChorusPlant.SOUTH)) {
            Block.addCollisionBoxToList(pos, entityBox, collidingBoxes, new Box(0.1875, 0.1875, 0.8125, 0.8125, 0.8125, 1.0));
        }
    }
