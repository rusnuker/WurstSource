...
public class BlockTripWireHook extends Block
{
    ...
    protected static final Box HOOK_NORTH_AABB;
    protected static final Box HOOK_SOUTH_AABB;
    protected static final Box HOOK_WEST_AABB;
    protected static final Box HOOK_EAST_AABB;
    
    static {
        FACING = BlockHorizontal.FACING;
        POWERED = PropertyBool.create("powered");
        ATTACHED = PropertyBool.create("attached");
        HOOK_NORTH_AABB = new Box(0.3125, 0.0, 0.625, 0.6875, 0.625, 1.0);
        HOOK_SOUTH_AABB = new Box(0.3125, 0.0, 0.0, 0.6875, 0.625, 0.375);
        HOOK_WEST_AABB = new Box(0.625, 0.0, 0.3125, 1.0, 0.625, 0.6875);
        HOOK_EAST_AABB = new Box(0.0, 0.0, 0.3125, 0.375, 0.625, 0.6875);
    }
