...
public class BlockDispenser extends BlockContainer
{
    ...
    protected void dispense(final World worldIn, final BlockPos pos) {
        ...
        if (tileentitydispenser != null) {
            ...
            if (i < 0) {
                ...
                final ItemStack itemstack = tileentitydispenser.getInvStack(i);
    ...
    public IBlockState onBlockPlaced(final World worldIn, final BlockPos pos, final EnumFacing facing, final float hitX, final float hitY, final float hitZ, final int meta, final EntityLivingBase placer) {
        return this.getDefaultState().withProperty((IProperty<Comparable>)BlockDispenser.FACING, EnumFacing.func_190914_a(pos, placer)).withProperty((IProperty<Comparable>)BlockDispenser.TRIGGERED, false);
    }
    
    @Override
    public void onBlockPlacedBy(final World worldIn, final BlockPos pos, final IBlockState state, final EntityLivingBase placer, final ItemStack stack) {
        worldIn.setBlockState(pos, state.withProperty((IProperty<Comparable>)BlockDispenser.FACING, EnumFacing.func_190914_a(pos, placer)), 2);
    ...
    public IBlockState getStateFromMeta(final int meta) {
        return this.getDefaultState().withProperty((IProperty<Comparable>)BlockDispenser.FACING, EnumFacing.getFront(meta & 0x7)).withProperty((IProperty<Comparable>)BlockDispenser.TRIGGERED, (meta & 0x8) > 0);
    }
