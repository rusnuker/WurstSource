...
public class BlockCactus extends Block
{
    ...
    protected static final Box CACTUS_COLLISION_AABB;
    protected static final Box CACTUS_AABB;
    
    static {
        AGE = PropertyInteger.create("age", 0, 15);
        CACTUS_COLLISION_AABB = new Box(0.0625, 0.0, 0.0625, 0.9375, 0.9375, 0.9375);
        CACTUS_AABB = new Box(0.0625, 0.0, 0.0625, 0.9375, 1.0, 0.9375);
    }
    ...
    public Box getCollisionBoundingBox(final IBlockState blockState, final IBlockAccess worldIn, final BlockPos pos) {
        if (WurstClient.INSTANCE.hax.antiCactusMod.isActive()) {
