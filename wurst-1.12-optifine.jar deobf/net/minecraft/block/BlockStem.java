...
public class BlockStem extends BlockBush implements IGrowable
{
    ...
    protected static final Box[] STEM_AABB;
    
    static {
        AGE = PropertyInteger.create("age", 0, 7);
        FACING = BlockTorch.FACING;
        STEM_AABB = new Box[] { new Box(0.375, 0.0, 0.375, 0.625, 0.125, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 0.25, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 0.375, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 0.5, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 0.625, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 0.75, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 0.875, 0.625), new Box(0.375, 0.0, 0.375, 0.625, 1.0, 0.625) };
    }
