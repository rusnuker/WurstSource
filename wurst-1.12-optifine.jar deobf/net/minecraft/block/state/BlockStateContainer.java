...
public class BlockStateContainer
{
    ...
    protected BlockStateContainer(final Block p_i9_1_, final IProperty<?>[] p_i9_2_, final ImmutableMap<IUnlistedProperty<?>, Optional<?>> p_i9_3_) {
        this.block = p_i9_1_;
        final Map<String, IProperty<?>> map = Maps.newHashMap();
        ...
        final Map<Map<IProperty<?>, Comparable<?>>, StateImplementation> map2 = Maps.newLinkedHashMap();
        final List<StateImplementation> list = Lists.newArrayList();
        for (final List<Comparable<?>> list2 : Cartesian.cartesianProduct((Iterable<? extends Iterable<?>>)this.getAllowedValues())) {
            ...
            final StateImplementation blockstatecontainer$stateimplementation = this.createState(p_i9_1_, (ImmutableMap<IProperty<?>, Comparable<?>>)ImmutableMap.copyOf((Map)map3), p_i9_3_);
    ...
    public static class Builder
    {
        ...
        public Builder(final Block p_i11_1_) {
            this.listed = Lists.newArrayList();
            this.unlisted = Lists.newArrayList();
            this.block = p_i11_1_;
        }
    ...
    static class StateImplementation extends BlockStateBase
    {
        ...
        private Map<IProperty<?>, Comparable<?>> getPropertiesWithValue(final IProperty<?> property, final Comparable<?> value) {
            final Map<IProperty<?>, Comparable<?>> map = Maps.newHashMap((Map)this.properties);
        ...
        public float getAmbientOcclusionLightValue() {
            return EventFactory.getAmbientOcclusionLightValue(this.block.getAmbientOcclusionLightValue(this), this);
        }
        ...
        public boolean isNormalCube() {
            return this.block.isNormalCube(this) && EventFactory.isNormalCube();
        }
        ...
        @Override
        public Box getSelectedBoundingBox(final World worldIn, final BlockPos pos) {
        ...
        public boolean shouldSideBeRendered(final IBlockAccess blockAccess, final BlockPos pos, final EnumFacing facing) {
            return EventFactory.shouldSideBeRendered(this.block.shouldSideBeRendered(this, blockAccess, pos, facing), this);
        }
        ...
        @Nullable
        @Override
        public Box getCollisionBoundingBox(final IBlockAccess worldIn, final BlockPos pos) {
            return this.block.getCollisionBoundingBox(this, worldIn, pos);
        }
        
        @Override
        public void addCollisionBoxToList(final World worldIn, final BlockPos pos, final Box p_185908_3_, final List<Box> p_185908_4_, @Nullable final Entity p_185908_5_, final boolean p_185908_6_) {
            this.block.addCollisionBoxToList(this, worldIn, pos, p_185908_3_, p_185908_4_, p_185908_5_, p_185908_6_);
        }
        
        @Override
        public Box getBoundingBox(final IBlockAccess blockAccess, final BlockPos pos) {
            ...
            if (block$enumoffsettype != Block.EnumOffsetType.NONE && !(this.block instanceof BlockFlower)) {
                Box axisalignedbb = this.block.getBoundingBox(this, blockAccess, pos);
