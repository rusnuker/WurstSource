...
public interface IBlockProperties
{
    ...
    Box getSelectedBoundingBox(final World p0, final BlockPos p1);
    ...
    @Nullable
    Box getCollisionBoundingBox(final IBlockAccess p0, final BlockPos p1);
    
    void addCollisionBoxToList(final World p0, final BlockPos p1, final Box p2, final List<Box> p3, final Entity p4, final boolean p5);
    
    Box getBoundingBox(final IBlockAccess p0, final BlockPos p1);
