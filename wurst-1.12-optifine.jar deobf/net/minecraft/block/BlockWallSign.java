...
public class BlockWallSign extends BlockSign
{
    ...
    protected static final Box SIGN_EAST_AABB;
    protected static final Box SIGN_WEST_AABB;
    protected static final Box SIGN_SOUTH_AABB;
    protected static final Box SIGN_NORTH_AABB;
    
    static {
        FACING = BlockHorizontal.FACING;
        SIGN_EAST_AABB = new Box(0.0, 0.28125, 0.0, 0.125, 0.78125, 1.0);
        SIGN_WEST_AABB = new Box(0.875, 0.28125, 0.0, 1.0, 0.78125, 1.0);
        SIGN_SOUTH_AABB = new Box(0.0, 0.28125, 0.0, 1.0, 0.78125, 0.125);
        SIGN_NORTH_AABB = new Box(0.0, 0.28125, 0.875, 1.0, 0.78125, 1.0);
    }
