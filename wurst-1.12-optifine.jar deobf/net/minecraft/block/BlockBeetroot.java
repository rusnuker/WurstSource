...
public class BlockBeetroot extends BlockCrops
{
    ...
    private static final Box[] BEETROOT_AABB;
    
    static {
        BEETROOT_AGE = PropertyInteger.create("age", 0, 3);
        BEETROOT_AABB = new Box[] { new Box(0.0, 0.0, 0.0, 1.0, 0.125, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.25, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.375, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.5, 1.0) };
    }
