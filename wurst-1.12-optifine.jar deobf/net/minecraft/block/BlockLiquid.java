...
public abstract class BlockLiquid extends Block
{
    ...
    public Box getCollisionBoundingBox(final IBlockState blockState, final IBlockAccess worldIn, final BlockPos pos) {
        return WurstClient.INSTANCE.hax.jesusMod.shouldBeSolid() ? BlockLiquid.FULL_BLOCK_AABB : BlockLiquid.NULL_AABB;
    }
    ...
    public boolean canCollideCheck(final IBlockState state, final boolean hitIfLiquid) {
        return (hitIfLiquid && state.getValue((IProperty<Integer>)BlockLiquid.LEVEL) == 0) || WurstClient.INSTANCE.hax.liquidsMod.isActive();
    }
