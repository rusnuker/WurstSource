...
{
    protected static final Box PRESSED_AABB;
    protected static final Box UNPRESSED_AABB;
    protected static final Box PRESSURE_AABB;
    
    static {
        PRESSED_AABB = new Box(0.0625, 0.0, 0.0625, 0.9375, 0.03125, 0.9375);
        UNPRESSED_AABB = new Box(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);
        PRESSURE_AABB = new Box(0.125, 0.0, 0.125, 0.875, 0.25, 0.875);
    }
