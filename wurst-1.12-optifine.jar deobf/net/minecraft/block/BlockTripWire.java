...
public class BlockTripWire extends Block
{
    ...
    protected static final Box AABB;
    protected static final Box TRIP_WRITE_ATTACHED_AABB;
    ...
    static {
        ...
        AABB = new Box(0.0, 0.0625, 0.0, 1.0, 0.15625, 1.0);
        TRIP_WRITE_ATTACHED_AABB = new Box(0.0, 0.0, 0.0, 1.0, 0.5, 1.0);
    }
    ...
    public IBlockState withRotation(final IBlockState state, final Rotation rot) {
        switch (rot) {
            case CLOCKWISE_180: {
                return state.withProperty((IProperty<Comparable>)BlockTripWire.NORTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.SOUTH)).withProperty((IProperty<Comparable>)BlockTripWire.EAST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.WEST)).withProperty((IProperty<Comparable>)BlockTripWire.SOUTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.NORTH)).withProperty((IProperty<Comparable>)BlockTripWire.WEST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.EAST));
            }
            case COUNTERCLOCKWISE_90: {
                return state.withProperty((IProperty<Comparable>)BlockTripWire.NORTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.EAST)).withProperty((IProperty<Comparable>)BlockTripWire.EAST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.SOUTH)).withProperty((IProperty<Comparable>)BlockTripWire.SOUTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.WEST)).withProperty((IProperty<Comparable>)BlockTripWire.WEST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.NORTH));
            }
            case CLOCKWISE_90: {
                return state.withProperty((IProperty<Comparable>)BlockTripWire.NORTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.WEST)).withProperty((IProperty<Comparable>)BlockTripWire.EAST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.NORTH)).withProperty((IProperty<Comparable>)BlockTripWire.SOUTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.EAST)).withProperty((IProperty<Comparable>)BlockTripWire.WEST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.SOUTH));
            }
            default: {
                return state;
            }
    ...
    public IBlockState withMirror(final IBlockState state, final Mirror mirrorIn) {
        switch (mirrorIn) {
            case LEFT_RIGHT: {
                return state.withProperty((IProperty<Comparable>)BlockTripWire.NORTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.SOUTH)).withProperty((IProperty<Comparable>)BlockTripWire.SOUTH, (Boolean)state.getValue((IProperty<V>)BlockTripWire.NORTH));
            }
            case FRONT_BACK: {
                return state.withProperty((IProperty<Comparable>)BlockTripWire.EAST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.WEST)).withProperty((IProperty<Comparable>)BlockTripWire.WEST, (Boolean)state.getValue((IProperty<V>)BlockTripWire.EAST));
            }
            default: {
