...
public class BlockEndPortalFrame extends Block
{
    ...
    protected static final Box AABB_BLOCK;
    protected static final Box AABB_EYE;
    private static BlockPattern portalShape;
    
    static {
        FACING = BlockHorizontal.FACING;
        EYE = PropertyBool.create("eye");
        AABB_BLOCK = new Box(0.0, 0.0, 0.0, 1.0, 0.8125, 1.0);
        AABB_EYE = new Box(0.3125, 0.8125, 0.3125, 0.6875, 1.0, 0.6875);
    }
