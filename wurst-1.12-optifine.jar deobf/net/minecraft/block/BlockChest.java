...
public class BlockChest extends BlockContainer
{
    ...
    protected static final Box NORTH_CHEST_AABB;
    protected static final Box SOUTH_CHEST_AABB;
    protected static final Box WEST_CHEST_AABB;
    protected static final Box EAST_CHEST_AABB;
    protected static final Box NOT_CONNECTED_AABB;
    public final Type chestType;
    
    static {
        FACING = BlockHorizontal.FACING;
        NORTH_CHEST_AABB = new Box(0.0625, 0.0, 0.0, 0.9375, 0.875, 0.9375);
        SOUTH_CHEST_AABB = new Box(0.0625, 0.0, 0.0625, 0.9375, 0.875, 1.0);
        WEST_CHEST_AABB = new Box(0.0, 0.0, 0.0625, 0.9375, 0.875, 0.9375);
        EAST_CHEST_AABB = new Box(0.0625, 0.0, 0.0625, 1.0, 0.875, 0.9375);
        NOT_CONNECTED_AABB = new Box(0.0625, 0.0, 0.0625, 0.9375, 0.875, 0.9375);
    }
    ...
    private boolean isOcelotSittingOnChest(final World worldIn, final BlockPos pos) {
        for (final Entity entity : worldIn.getEntitiesWithinAABB((Class<? extends Entity>)EntityOcelot.class, new Box(pos.getX(), pos.getY() + 1, pos.getZ(), pos.getX() + 1, pos.getY() + 2, pos.getZ() + 1))) {
