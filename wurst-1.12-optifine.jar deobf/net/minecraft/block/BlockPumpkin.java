...
public class BlockPumpkin extends BlockHorizontal
{
    ...
    private void trySpawnGolem(final World worldIn, final BlockPos pos) {
        ...
        if (blockpattern$patternhelper != null) {
            ...
            for (final EntityPlayerMP entityplayermp : worldIn.getEntitiesWithinAABB((Class<? extends EntityPlayerMP>)EntityPlayerMP.class, entitysnowman.getEntityBoundingBox().expandXyz(5.0))) {
            ...
            if (blockpattern$patternhelper != null) {
                ...
                for (final EntityPlayerMP entityplayermp2 : worldIn.getEntitiesWithinAABB((Class<? extends EntityPlayerMP>)EntityPlayerMP.class, entityirongolem.getEntityBoundingBox().expandXyz(5.0))) {
                    CriteriaTriggers.field_192133_m.func_192229_a(entityplayermp2, entityirongolem);
                }
