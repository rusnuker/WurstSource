...
public class BlockFarmland extends Block
{
    ...
    protected static final Box FARMLAND_AABB;
    
    static {
        MOISTURE = PropertyInteger.create("moisture", 0, 7);
        FARMLAND_AABB = new Box(0.0, 0.0, 0.0, 1.0, 0.9375, 1.0);
    }
    ...
    private void func_190970_b(final World p_190970_1_, final BlockPos p_190970_2_) {
        final IBlockState iblockstate = Blocks.DIRT.getDefaultState();
        p_190970_1_.setBlockState(p_190970_2_, iblockstate);
        final Box axisalignedbb = iblockstate.getCollisionBoundingBox(p_190970_1_, p_190970_2_).offset(p_190970_2_);
        for (final Entity entity : p_190970_1_.getEntitiesWithinAABBExcludingEntity(null, axisalignedbb)) {
