...
public class BlockCrops extends BlockBush implements IGrowable
{
    ...
    private static final Box[] CROPS_AABB;
    
    static {
        AGE = PropertyInteger.create("age", 0, 7);
        CROPS_AABB = new Box[] { new Box(0.0, 0.0, 0.0, 1.0, 0.125, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.25, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.375, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.5, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.625, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.75, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.875, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 1.0, 1.0) };
    }
