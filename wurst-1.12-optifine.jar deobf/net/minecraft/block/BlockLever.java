...
public class BlockLever extends Block
{
    ...
    protected static final Box LEVER_NORTH_AABB;
    protected static final Box LEVER_SOUTH_AABB;
    protected static final Box LEVER_WEST_AABB;
    protected static final Box LEVER_EAST_AABB;
    protected static final Box LEVER_UP_AABB;
    protected static final Box LEVER_DOWN_AABB;
    
    static {
        FACING = PropertyEnum.create("facing", EnumOrientation.class);
        POWERED = PropertyBool.create("powered");
        LEVER_NORTH_AABB = new Box(0.3125, 0.20000000298023224, 0.625, 0.6875, 0.800000011920929, 1.0);
        LEVER_SOUTH_AABB = new Box(0.3125, 0.20000000298023224, 0.0, 0.6875, 0.800000011920929, 0.375);
        LEVER_WEST_AABB = new Box(0.625, 0.20000000298023224, 0.3125, 1.0, 0.800000011920929, 0.6875);
        LEVER_EAST_AABB = new Box(0.0, 0.20000000298023224, 0.3125, 0.375, 0.800000011920929, 0.6875);
        LEVER_UP_AABB = new Box(0.25, 0.0, 0.25, 0.75, 0.6000000238418579, 0.75);
        LEVER_DOWN_AABB = new Box(0.25, 0.4000000059604645, 0.25, 0.75, 1.0, 0.75);
    }
