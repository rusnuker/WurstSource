...
public class BlockTallGrass extends BlockBush implements IGrowable
{
    ...
    protected static final Box TALL_GRASS_AABB;
    
    static {
        TYPE = PropertyEnum.create("type", EnumType.class);
        TALL_GRASS_AABB = new Box(0.09999999403953552, 0.0, 0.09999999403953552, 0.8999999761581421, 0.800000011920929, 0.8999999761581421);
    }
