...
public class BlockBanner extends BlockContainer
{
    ...
    static {
        ...
        STANDING_AABB = new Box(0.25, 0.0, 0.25, 0.75, 1.0, 0.75);
    }
    ...
    public static class BlockBannerHanging extends BlockBanner
    {
        ...
        static {
            NORTH_AABB = new Box(0.0, 0.0, 0.875, 1.0, 0.78125, 1.0);
            SOUTH_AABB = new Box(0.0, 0.0, 0.0, 1.0, 0.78125, 0.125);
            WEST_AABB = new Box(0.875, 0.0, 0.0, 1.0, 0.78125, 1.0);
            EAST_AABB = new Box(0.0, 0.0, 0.0, 0.125, 0.78125, 1.0);
        }
