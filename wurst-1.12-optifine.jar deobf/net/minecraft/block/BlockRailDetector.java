...
public class BlockRailDetector extends BlockRailBase
{
    ...
    protected void updateConnectedRails(final World worldIn, final BlockPos pos, final IBlockState state, final boolean p_185592_4_) {
    ...
    protected <T extends EntityMinecart> List<T> findMinecarts(final World worldIn, final BlockPos pos, final Class<T> clazz, final Predicate<Entity>... filter) {
        final Box axisalignedbb = this.getDectectionBox(pos);
    ...
    private Box getDectectionBox(final BlockPos pos) {
        final float f = 0.2f;
