...
public class BlockNetherWart extends BlockBush
{
    ...
    private static final Box[] NETHER_WART_AABB;
    
    static {
        AGE = PropertyInteger.create("age", 0, 3);
        NETHER_WART_AABB = new Box[] { new Box(0.0, 0.0, 0.0, 1.0, 0.3125, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.5, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.6875, 1.0), new Box(0.0, 0.0, 0.0, 1.0, 0.875, 1.0) };
    }
