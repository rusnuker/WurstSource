...
public class BlockSkull extends BlockContainer
{
    ...
    protected static final Box DEFAULT_AABB;
    ...
    static {
        ...
        DEFAULT_AABB = new Box(0.25, 0.0, 0.25, 0.75, 0.5, 0.75);
        NORTH_AABB = new Box(0.25, 0.25, 0.5, 0.75, 0.75, 1.0);
        SOUTH_AABB = new Box(0.25, 0.25, 0.0, 0.75, 0.75, 0.5);
        WEST_AABB = new Box(0.5, 0.25, 0.25, 1.0, 0.75, 0.75);
        EAST_AABB = new Box(0.0, 0.25, 0.25, 0.5, 0.75, 0.75);
    }
    ...
    public void checkWitherSpawn(final World worldIn, final BlockPos pos, final TileEntitySkull te) {
        if (te.getSkullType() == 1 && pos.getY() >= 2 && worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote) {
            ...
            if (blockpattern$patternhelper != null) {
                ...
                entitywither.ignite();
                for (final EntityPlayerMP entityplayermp : worldIn.getEntitiesWithinAABB((Class<? extends EntityPlayerMP>)EntityPlayerMP.class, entitywither.getEntityBoundingBox().expandXyz(50.0))) {
