...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider
{
    ...
    private EntityItemFrame findItemFrame(final World worldIn, final EnumFacing facing, final BlockPos pos) {
        final List<EntityItemFrame> list = worldIn.getEntitiesWithinAABB((Class<? extends EntityItemFrame>)EntityItemFrame.class, new Box(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1), (com.google.common.base.Predicate<? super EntityItemFrame>)new Predicate<Entity>() {
