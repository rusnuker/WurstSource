...
public class PotionEffect implements Comparable<PotionEffect>
{
    ...
    private int deincrementDuration() {
        return WurstClient.INSTANCE.hax.potionSaverMod.isFrozen() ? this.duration : (--this.duration);
    }
    ...
    public String toString() {
        String s;
        if (this.amplifier > 0) {
            s = String.valueOf(this.getEffectName()) + " x " + (this.amplifier + 1) + ", Duration: " + this.duration;
        }
        else {
            s = String.valueOf(this.getEffectName()) + ", Duration: " + this.duration;
        }
