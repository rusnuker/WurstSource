...
public class PotionType
{
    ...
    public String getNamePrefixed(final String p_185174_1_) {
        return (this.baseName == null) ? (String.valueOf(p_185174_1_) + PotionType.REGISTRY.getNameForObject(this).getResourcePath()) : (String.valueOf(p_185174_1_) + this.baseName);
    }
