...
public class Potion
{
    ...
    public static String getPotionDurationString(final PotionEffect p_188410_0_, final float p_188410_1_) {
        if (p_188410_0_.getIsPotionDurationMax()) {
            return "**:**";
        }
        final int i = MathHelper.floor(p_188410_0_.getDuration() * p_188410_1_);
