...
{
    private static final Logger field_191551_b;
    private static final Pattern field_193583_c;
    ...
    public boolean hasUniqueId(final String key) {
        return this.hasKey(String.valueOf(key) + "Most", 99) && this.hasKey(String.valueOf(key) + "Least", 99);
    }
    ...
    public String toString() {
        ...
        if (NBTTagCompound.field_191551_b.isDebugEnabled()) {
            final List<String> list = Lists.newArrayList((Iterable)this.tagMap.keySet());
    ...
    protected static String func_193582_s(final String p_193582_0_) {
        return NBTTagCompound.field_193583_c.matcher(p_193582_0_).matches() ? p_193582_0_ : NBTTagString.func_193588_a(p_193582_0_);
    }
}
