...
public class EnchantmentHelper
{
    ...
    public static float func_191527_a(final EntityLivingBase p_191527_0_) {
        final int i = getMaxEnchantmentLevel(Enchantments.field_191530_r, p_191527_0_);
    ...
    public static int func_191529_b(final ItemStack p_191529_0_) {
        return getEnchantmentLevel(Enchantments.LUCK_OF_THE_SEA, p_191529_0_);
    }
    
    public static int func_191528_c(final ItemStack p_191528_0_) {
    ...
    public static boolean func_190938_b(final ItemStack p_190938_0_) {
        return getEnchantmentLevel(Enchantments.field_190941_k, p_190938_0_) > 0;
    }
    
    public static boolean func_190939_c(final ItemStack p_190939_0_) {
    ...
    public static ItemStack getEnchantedItem(final Enchantment p_92099_0_, final EntityLivingBase p_92099_1_) {
        ...
        return list2.isEmpty() ? ItemStack.field_190927_a : list2.get(p_92099_1_.getRNG().nextInt(list2.size()));
    }
    ...
    public static ItemStack addRandomEnchantment(final Random random, ItemStack p_77504_1_, final int p_77504_2_, final boolean allowTreasure) {
        final List<EnchantmentData> list = buildEnchantmentList(random, p_77504_1_, p_77504_2_, allowTreasure);
    ...
    public static List<EnchantmentData> buildEnchantmentList(final Random randomIn, final ItemStack itemStackIn, int p_77513_2_, final boolean allowTreasure) {
        final List<EnchantmentData> list = Lists.newArrayList();
        ...
        final List<EnchantmentData> list2 = getEnchantmentDatas(p_77513_2_, itemStackIn, allowTreasure);
        if (!list2.isEmpty()) {
