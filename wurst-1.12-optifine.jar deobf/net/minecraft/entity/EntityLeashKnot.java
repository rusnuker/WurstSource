...
public class EntityLeashKnot extends EntityHanging
{
    ...
    public EntityLeashKnot(final World worldIn, final BlockPos hangingPositionIn) {
        ...
        this.setEntityBoundingBox(new Box(this.posX - 0.1875, this.posY - 0.25 + 0.125, this.posZ - 0.1875, this.posX + 0.1875, this.posY + 0.25 + 0.125, this.posZ + 0.1875));
    ...
    public boolean processInitialInteract(final EntityPlayer player, final EnumHand stack) {
        ...
        boolean flag = false;
        final double d0 = 7.0;
        final List<EntityLiving> list = this.world.getEntitiesWithinAABB((Class<? extends EntityLiving>)EntityLiving.class, new Box(this.posX - 7.0, this.posY - 7.0, this.posZ - 7.0, this.posX + 7.0, this.posY + 7.0, this.posZ + 7.0));
    ...
    public static EntityLeashKnot getKnotForPosition(final World worldIn, final BlockPos pos) {
        ...
        for (final EntityLeashKnot entityleashknot : worldIn.getEntitiesWithinAABB((Class<? extends EntityLeashKnot>)EntityLeashKnot.class, new Box(i - 1.0, j - 1.0, k - 1.0, i + 1.0, j + 1.0, k + 1.0))) {
