...
public class EntityAIFindEntityNearest extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        final List<EntityLivingBase> list = this.mob.world.getEntitiesWithinAABB(this.classToCheck, this.mob.getEntityBoundingBox().expand(d0, 4.0, d0), (com.google.common.base.Predicate<? super EntityLivingBase>)this.predicate);
