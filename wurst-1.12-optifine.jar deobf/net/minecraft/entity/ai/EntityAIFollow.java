...
public class EntityAIFollow extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        final List<EntityLiving> list = this.field_192372_a.world.getEntitiesWithinAABB((Class<? extends EntityLiving>)EntityLiving.class, this.field_192372_a.getEntityBoundingBox().expandXyz(this.field_192380_i), (com.google.common.base.Predicate<? super EntityLiving>)this.field_192373_b);
        if (!list.isEmpty()) {
