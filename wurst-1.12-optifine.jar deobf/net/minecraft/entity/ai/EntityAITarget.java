...
public abstract class EntityAITarget extends EntityAIBase
{
    ...
    private boolean canEasilyReach(final EntityLivingBase target) {
        ...
        final int i = pathpoint.xCoord - MathHelper.floor(target.posX);
        final int j = pathpoint.zCoord - MathHelper.floor(target.posZ);
        return i * i + j * j <= 2.25;
    }
    
    public EntityAITarget func_190882_b(final int p_190882_1_) {
