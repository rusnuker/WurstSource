...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    public EntityAIFindEntityNearestPlayer(final EntityLiving entityLivingIn) {
        ...
        this.predicate = (Predicate<Entity>)new Predicate<Entity>() {
            public boolean apply(@Nullable final Entity p_apply_1_) {
                ...
                if (((EntityPlayer)p_apply_1_).abilities.disableDamage) {
                    return false;
                }
    ...
    public boolean shouldExecute() {
        ...
        final List<EntityPlayer> list = this.entityLiving.world.getEntitiesWithinAABB((Class<? extends EntityPlayer>)EntityPlayer.class, this.entityLiving.getEntityBoundingBox().expand(d0, 4.0, d0), (com.google.common.base.Predicate<? super EntityPlayer>)this.predicate);
    ...
    protected double maxTargetRange() {
        final IAttributeInstance iattributeinstance = this.entityLiving.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE);
