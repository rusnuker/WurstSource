...
public abstract class EntityArrow extends Entity implements IProjectile
{
    ...
    public void setAim(final Entity shooter, final float pitch, final float yaw, final float p_184547_4_, final float velocity, final float inaccuracy) {
        ...
        this.setThrowableHeading(f, f2, f3, velocity, inaccuracy);
    ...
    public void onUpdate() {
        ...
        if (iblockstate.getMaterial() != Material.AIR) {
            final Box axisalignedbb = iblockstate.getCollisionBoundingBox(this.world, blockpos);
    ...
    protected Entity findEntityOnPath(final Vec3d start, final Vec3d end) {
        Entity entity = null;
        final List<Entity> list = this.world.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expandXyz(1.0), EntityArrow.ARROW_TARGETS);
        double d0 = 0.0;
        for (int i = 0; i < list.size(); ++i) {
            final Entity entity2 = list.get(i);
            if (entity2 != this.shootingEntity || this.ticksInAir >= 5) {
                final Box axisalignedbb = entity2.getEntityBoundingBox().expandXyz(0.30000001192092896);
    ...
    public void onCollideWithPlayer(final EntityPlayer entityIn) {
        if (!this.world.isRemote && this.inGround && this.arrowShake <= 0) {
            boolean flag = this.pickupStatus == PickupStatus.ALLOWED || (this.pickupStatus == PickupStatus.CREATIVE_ONLY && entityIn.abilities.creativeMode);
    ...
    public void func_190547_a(final EntityLivingBase p_190547_1_, final float p_190547_2_) {
        ...
        this.setDamage(p_190547_2_ * 2.0f + this.rand.nextGaussian() * 0.25 + this.world.getDifficulty().getDifficultyId() * 0.11f);
        if (i > 0) {
    ...
    public enum PickupStatus
    {
        ...
        private PickupStatus(final String name, final int ordinal) {
        }
