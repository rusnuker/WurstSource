...
public class EntityFishHook extends Entity
{
    ...
    public EntityFishHook(final World p_i47290_1_, final EntityPlayer p_i47290_2_, final double p_i47290_3_, final double p_i47290_5_, final double p_i47290_7_) {
        super(p_i47290_1_);
    ...
    private void func_190626_a(final EntityPlayer p_190626_1_) {
    ...
    public void func_191516_a(final int p_191516_1_) {
        this.field_191519_ax = p_191516_1_;
    }
    
    public void func_191517_b(final int p_191517_1_) {
    ...
    private boolean func_190625_o() {
        ...
        if (!this.angler.isDead && this.angler.isEntityAlive() && (flag || flag2) && this.getDistanceSqToEntity(this.angler) <= 1024.0) {
            return false;
        }
        this.setDead();
        return true;
    ...
    private void func_190621_a(final BlockPos p_190621_1_) {
