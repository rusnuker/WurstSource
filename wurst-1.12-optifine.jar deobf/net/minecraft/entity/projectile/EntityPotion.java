...
public class EntityPotion extends EntityThrowable
{
    ...
    private void func_190545_n() {
        final Box axisalignedbb = this.getEntityBoundingBox().expand(4.0, 2.0, 4.0);
        final List<EntityLivingBase> list = this.world.getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, axisalignedbb, (com.google.common.base.Predicate<? super EntityLivingBase>)EntityPotion.field_190546_d);
        if (!list.isEmpty()) {
