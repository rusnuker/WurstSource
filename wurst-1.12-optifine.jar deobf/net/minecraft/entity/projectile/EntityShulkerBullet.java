...
public class EntityShulkerBullet extends Entity
{
    ...
    private void selectNextMoveDirection(@Nullable final EnumFacing.Axis p_184569_1_) {
        ...
        if (blockpos.distanceSqToCenter(this.posX, this.posY, this.posZ) >= 4.0) {
            ...
            final List<EnumFacing> list = Lists.newArrayList();
            ...
            if (list.isEmpty()) {
                for (int i = 5; !this.world.isAirBlock(blockpos2.offset(enumfacing)); enumfacing = EnumFacing.random(this.rand), --i) {
                    if (i <= 0) {
                        break;
                    }
                }
        ...
        if (!this.world.isRemote && this.world.getDifficulty() == EnumDifficulty.PEACEFUL) {
            ...
            if (!this.world.isRemote) {
                if (this.target == null && this.targetUniqueId != null) {
                    for (final EntityLivingBase entitylivingbase : this.world.getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, new Box(this.targetBlockPos.add(-2, -2, -2), this.targetBlockPos.add(2, 2, 2)))) {
                ...
                if (this.owner == null && this.ownerUniqueId != null) {
                    for (final EntityLivingBase entitylivingbase2 : this.world.getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, new Box(this.ownerBlockPos.add(-2, -2, -2), this.ownerBlockPos.add(2, 2, 2)))) {
