...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant
{
    ...
    public void writeEntityToNBT(final NBTTagCompound compound) {
        ...
        for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i) {
            final ItemStack itemstack = this.villagerInventory.getInvStack(i);
    ...
    static class PriceInfo extends Tuple<Integer, Integer>
    {
        public PriceInfo(final int p_i45810_1_, final int p_i45810_2_) {
            ...
            if (p_i45810_2_ < p_i45810_1_) {
                EntityVillager.field_190674_bx.warn("PriceRange({}, {}) invalid, {} smaller than {}", (Object)p_i45810_1_, (Object)p_i45810_2_, (Object)p_i45810_2_, (Object)p_i45810_1_);
            }
        }
