...
public class EntityWolf extends EntityTameable
{
    ...
    public boolean shouldAttackEntity(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            ...
            return (!(p_142018_1_ instanceof EntityPlayer) || !(p_142018_2_ instanceof EntityPlayer) || ((EntityPlayer)p_142018_2_).canAttackPlayer((EntityPlayer)p_142018_1_)) && (!(p_142018_1_ instanceof AbstractHorse) || !((AbstractHorse)p_142018_1_).isTame());
        }
        return false;
    }
    ...
    class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T>
    {
        ...
        public AIAvoidEntity(final EntityWolf p_i47251_2_, final Class<T> p_i47251_3_, final float p_i47251_4_, final double p_i47251_5_, final double p_i47251_7_) {
        ...
        public boolean shouldExecute() {
            return super.shouldExecute() && this.closestLivingEntity instanceof EntityLlama && (!this.field_190856_d.isTamed() && this.func_190854_a((EntityLlama)this.closestLivingEntity));
        }
        
        private boolean func_190854_a(final EntityLlama p_190854_1_) {
