...
public class EntitySheep extends EntityAnimal
{
    ...
    static {
        ...
        for (int length = (values = EnumDyeColor.values()).length, i = 0; i < length; ++i) {
            ...
            EntitySheep.DYE_TO_RGB.put(enumdyecolor, func_192020_c(enumdyecolor));
        }
        EntitySheep.DYE_TO_RGB.put(EnumDyeColor.WHITE, new float[] { 0.9019608f, 0.9019608f, 0.9019608f });
    }
    
    private static float[] func_192020_c(final EnumDyeColor p_192020_0_) {
        final float[] afloat = p_192020_0_.func_193349_f();
        final float f = 0.75f;
    ...
    private EnumDyeColor getDyeColorMixFromParents(final EntityAnimal father, final EntityAnimal mother) {
        ...
        this.inventoryCrafting.getInvStack(0).setItemDamage(i);
        this.inventoryCrafting.getInvStack(1).setItemDamage(j);
        final ItemStack itemstack = CraftingManager.findMatchingRecipe(this.inventoryCrafting, ((EntitySheep)father).world);
        int k;
