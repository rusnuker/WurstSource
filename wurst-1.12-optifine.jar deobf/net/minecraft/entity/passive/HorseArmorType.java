...
public enum HorseArmorType
{
    ...
    private HorseArmorType(final String name, final int ordinal, final int armorStrengthIn) {
        this.protection = armorStrengthIn;
        this.textureName = null;
        this.hash = "";
    }
    
    private HorseArmorType(final String name, final int ordinal, final int armorStrengthIn, final String p_i46800_4_, final String p_i46800_5_) {
        this.protection = armorStrengthIn;
