...
public class EntityHorse extends AbstractHorse
{
    ...
    public void writeEntityToNBT(final NBTTagCompound compound) {
        ...
        if (!this.horseChest.getInvStack(1).func_190926_b()) {
            compound.setTag("ArmorItem", this.horseChest.getInvStack(1).writeToNBT(new NBTTagCompound()));
        }
    }
    ...
    protected void updateHorseSlots() {
        ...
        this.setHorseArmorStack(this.horseChest.getInvStack(1));
    }
    ...
    public boolean processInteract(final EntityPlayer player, final EnumHand hand) {
        ...
        final boolean flag = !itemstack.func_190926_b();
    ...
    public static class GroupData implements IEntityLivingData
    {
        ...
        public GroupData(final int p_i47337_1_) {
