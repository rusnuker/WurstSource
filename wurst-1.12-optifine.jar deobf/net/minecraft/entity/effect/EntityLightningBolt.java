    ...
    public void onUpdate() {
        ...
        if (this.lightningState >= 0) {
            if (this.world.isRemote) {
                ...
                final double d0 = 3.0;
                final List<Entity> list = this.world.getEntitiesWithinAABBExcludingEntity(this, new Box(this.posX - 3.0, this.posY - 3.0, this.posZ - 3.0, this.posX + 3.0, this.posY + 6.0 + 3.0, this.posZ + 3.0));
