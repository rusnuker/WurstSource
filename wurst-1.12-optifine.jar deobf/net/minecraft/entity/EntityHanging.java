...
public abstract class EntityHanging extends Entity
{
    ...
    protected void updateBoundingBox() {
        if (this.facingDirection != null) {
            ...
            d8 /= 32.0;
            d9 /= 32.0;
            this.setEntityBoundingBox(new Box(d0 - d7, d2 - d8, d3 - d9, d0 + d7, d2 + d8, d3 + d9));
        }
    }
    ...
    public EntityItem entityDropItem(final ItemStack stack, final float offsetY) {
        final EntityItem entityitem = new EntityItem(this.world, this.posX + this.facingDirection.getFrontOffsetX() * 0.15f, this.posY + offsetY, this.posZ + this.facingDirection.getFrontOffsetZ() * 0.15f, stack);
