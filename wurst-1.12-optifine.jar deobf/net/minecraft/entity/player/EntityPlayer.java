...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    protected void updateSize() {
        ...
        if (f != this.width || f2 != this.height) {
            Box axisalignedbb = this.getEntityBoundingBox();
            axisalignedbb = new Box(axisalignedbb.minX, axisalignedbb.minY, axisalignedbb.minZ, axisalignedbb.minX + f, axisalignedbb.minY + f2, axisalignedbb.minZ + f);
    ...
    public void onLivingUpdate() {
        ...
        if (!this.world.isRemote) {
            iattributeinstance.setBaseValue(this.abilities.getWalkSpeed());
        }
        ...
        if ((!this.world.isRemote && (this.fallDistance > 0.5f || this.isInWater() || this.isRiding())) || this.abilities.isFlying) {
            this.func_192030_dh();
        }
    }
    ...
    protected void func_190776_cN() {
        for (int i = 0; i < this.inventory.getSizeInventory(); ++i) {
            final ItemStack itemstack = this.inventory.getInvStack(i);
    ...
    public EntityItem dropItem(final boolean dropAll) {
        return this.dropItem(this.inventory.decrStackSize(this.inventory.selectedSlot, (dropAll && !this.inventory.getCurrentItem().func_190926_b()) ? this.inventory.getCurrentItem().func_190916_E() : 1), false, true);
    }
    ...
    public void readEntityFromNBT(final NBTTagCompound compound) {
        ...
        this.inventory.selectedSlot = compound.getInteger("SelectedItemSlot");
        ...
        this.abilities.readCapabilitiesFromNBT(compound);
    ...
    public void writeEntityToNBT(final NBTTagCompound compound) {
        ...
        compound.setInteger("SelectedItemSlot", this.inventory.selectedSlot);
        ...
        this.abilities.writeCapabilitiesToNBT(compound);
    ...
    public EnumActionResult func_190775_a(final Entity p_190775_1_, final EnumHand p_190775_2_) {
        ...
        if (p_190775_1_.processInitialInteract(this, p_190775_2_)) {
            if (this.abilities.creativeMode && itemstack == this.getHeldItem(p_190775_2_) && itemstack.func_190916_E() < itemstack2.func_190916_E()) {
        ...
        if (!itemstack.func_190926_b() && p_190775_1_ instanceof EntityLivingBase) {
            ...
            if (itemstack.interactWithEntity(this, (EntityLivingBase)p_190775_1_, p_190775_2_)) {
                if (itemstack.func_190926_b() && !this.abilities.creativeMode) {
    ...
    public SleepResult trySleep(final BlockPos bedLocation) {
        ...
        if (!this.world.isRemote) {
            ...
            final double d0 = 8.0;
            final double d2 = 5.0;
            final List<EntityMob> list = this.world.getEntitiesWithinAABB((Class<? extends EntityMob>)EntityMob.class, new Box(bedLocation.getX() - 8.0, bedLocation.getY() - 5.0, bedLocation.getZ() - 8.0, bedLocation.getX() + 8.0, bedLocation.getY() + 5.0, bedLocation.getZ() + 8.0), (com.google.common.base.Predicate<? super EntityMob>)new SleepEnemyPredicate(this, null));
            if (!list.isEmpty()) {
    ...
    public void func_191986_a(final float p_191986_1_, final float p_191986_2_, final float p_191986_3_) {
        ...
        final double d2 = this.posY;
        final double d3 = this.posZ;
        if (this.abilities.isFlying && !this.isRiding()) {
            final double d4 = this.motionY;
            final float f = this.jumpMovementFactor;
            this.jumpMovementFactor = this.abilities.getFlySpeed() * (this.isSprinting() ? 2 : 1);
    ...
    public void setItemStackToSlot(final EntityEquipmentSlot slotIn, final ItemStack stack) {
        if (slotIn == EntityEquipmentSlot.MAINHAND) {
            ...
            this.inventory.mainInventory.set(this.inventory.selectedSlot, stack);
        }
    ...
    public boolean isPushedByWater() {
        final VelocityFromFluidListener.VelocityFromFluidEvent event = new VelocityFromFluidListener.VelocityFromFluidEvent();
        WurstClient.INSTANCE.getEventManager().fire(event);
        return !this.abilities.isFlying && !event.isCancelled();
    }
    ...
    public boolean canUseCommandBlock() {
        return this.abilities.creativeMode && this.canCommandSenderUseCommand(2, "");
    }
    ...
    public enum SleepResult
    {
        ...
        private SleepResult(final String name, final int ordinal) {
        }
    }
}
