    ...
    public void onUpdate() {
        ...
        if (this.world.isRemote) {
            ...
            if (flag) {
                if (this.rand.nextBoolean()) {
                    for (int i = 0; i < 2; ++i) {
                        ...
                        if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
                            ...
                            final int i2 = j & 0xFF;
                            this.world.func_190523_a(EnumParticleTypes.SPELL_MOB.getParticleID(), this.posX + f4, this.posY, this.posZ + f5, k / 255.0f, l / 255.0f, i2 / 255.0f, new int[0]);
                        }
                        else {
                            this.world.func_190523_a(enumparticletypes.getParticleID(), this.posX + f4, this.posY, this.posZ + f5, 0.0, 0.0, 0.0, aint);
                        }
                    }
                }
            }
                ...
                for (int k2 = 0; k2 < f6; ++k2) {
                    ...
                    if (enumparticletypes == EnumParticleTypes.SPELL_MOB) {
                        ...
                        this.world.func_190523_a(EnumParticleTypes.SPELL_MOB.getParticleID(), this.posX + f9, this.posY, this.posZ + f10, i3 / 255.0f, j2 / 255.0f, j3 / 255.0f, new int[0]);
                    }
                    else {
                        this.world.func_190523_a(enumparticletypes.getParticleID(), this.posX + f9, this.posY, this.posZ + f10, (0.5 - this.rand.nextDouble()) * 0.15, 0.009999999776482582, (0.5 - this.rand.nextDouble()) * 0.15, aint);
                    }
                }
            }
        }
            ...
            if (this.ticksExisted % 5 == 0) {
                ...
                final List<PotionEffect> lstPotions = Lists.newArrayList();
