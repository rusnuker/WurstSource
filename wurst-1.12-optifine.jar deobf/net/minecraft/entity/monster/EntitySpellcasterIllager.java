...
public abstract class EntitySpellcasterIllager extends AbstractIllager
{
    ...
    public enum SpellType
    {
        ...
        private SpellType(final String name, final int ordinal, final int p_i47561_3_, final double p_i47561_4_, final double p_i47561_6_, final double p_i47561_8_) {
