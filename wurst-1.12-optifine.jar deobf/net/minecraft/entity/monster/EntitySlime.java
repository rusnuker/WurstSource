...
public class EntitySlime extends EntityLiving implements IMob
{
    ...
    protected void setSlimeSize(final int size, final boolean p_70799_2_) {
    ...
    protected void dealDamage(final EntityLivingBase entityIn) {
        final int i = this.getSlimeSize();
        if (this.canEntityBeSeen(entityIn) && this.getDistanceSqToEntity(entityIn) < 0.6 * i * 0.6 * i && entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), (float)this.getAttackStrength())) {
    ...
    public boolean getCanSpawnHere() {
        ...
        final Chunk chunk = this.world.getChunkFromBlockCoords(blockpos);
    ...
    static class AISlimeAttack extends EntityAIBase
    {
        ...
        public boolean shouldExecute() {
            ...
            return entitylivingbase != null && entitylivingbase.isEntityAlive() && (!(entitylivingbase instanceof EntityPlayer) || !((EntityPlayer)entitylivingbase).abilities.disableDamage);
        }
        ...
        public boolean continueExecuting() {
            final EntityLivingBase entitylivingbase = this.slime.getAttackTarget();
            return entitylivingbase != null && entitylivingbase.isEntityAlive() && (!(entitylivingbase instanceof EntityPlayer) || !((EntityPlayer)entitylivingbase).abilities.disableDamage) && --this.growTieredTimer > 0;
        }
