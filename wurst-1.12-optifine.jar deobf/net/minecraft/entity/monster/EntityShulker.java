...
public class EntityShulker extends EntityGolem implements IMob
{
    ...
    public static final EnumDyeColor field_190771_bx;
    ...
    public void readEntityFromNBT(final NBTTagCompound compound) {
        ...
        this.dataManager.set(EntityShulker.ATTACHED_FACE, EnumFacing.getFront(compound.getByte("AttachFace")));
        this.dataManager.set(EntityShulker.PEEK_TICK, compound.getByte("Peek"));
        this.dataManager.set(EntityShulker.field_190770_bw, compound.getByte("Color"));
    ...
    public void writeEntityToNBT(final NBTTagCompound compound) {
        ...
        compound.setByte("Color", this.dataManager.get(EntityShulker.field_190770_bw));
    ...
    public void onUpdate() {
        ...
        if (this.isRiding()) {
            ...
            if (!this.world.isBlockNormalCube(blockpos2, false)) {
                ...
                for (int length = (values = EnumFacing.values()).length, i = 0; i < length; ++i) {
                    final EnumFacing enumfacing3 = values[i];
        ...
        if (blockpos != null) {
            ...
            switch (enumfacing4) {
                case DOWN: {
                    this.setEntityBoundingBox(new Box(this.posX - 0.5, this.posY, this.posZ - 0.5, this.posX + 0.5, this.posY + 1.0 + d3, this.posZ + 0.5));
                    d7 = d5;
                    break;
                }
                case UP: {
                    this.setEntityBoundingBox(new Box(this.posX - 0.5, this.posY - d3, this.posZ - 0.5, this.posX + 0.5, this.posY + 1.0, this.posZ + 0.5));
                    d7 = -d5;
                    break;
                }
                case NORTH: {
                    this.setEntityBoundingBox(new Box(this.posX - 0.5, this.posY, this.posZ - 0.5, this.posX + 0.5, this.posY + 1.0, this.posZ + 0.5 + d3));
                    d8 = d5;
                    break;
                }
                case SOUTH: {
                    this.setEntityBoundingBox(new Box(this.posX - 0.5, this.posY, this.posZ - 0.5 - d3, this.posX + 0.5, this.posY + 1.0, this.posZ + 0.5));
                    d8 = -d5;
                    break;
                }
                case WEST: {
                    this.setEntityBoundingBox(new Box(this.posX - 0.5, this.posY, this.posZ - 0.5, this.posX + 0.5 + d3, this.posY + 1.0, this.posZ + 0.5));
                    d6 = d5;
                    break;
                }
                case EAST: {
                    this.setEntityBoundingBox(new Box(this.posX - 0.5 - d3, this.posY, this.posZ - 0.5, this.posX + 0.5, this.posY + 1.0, this.posZ + 0.5));
                    d6 = -d5;
                    break;
                }
            }
                ...
                if (!list.isEmpty()) {
                    for (final Entity entity : list) {
                        if (!(entity instanceof EntityShulker) && !entity.noClip) {
                            entity.moveEntity(MoverType.SHULKER, d6, d7, d8);
                        }
                    }
                }
            }
    ...
    protected boolean tryTeleportToNewPosition() {
        if (!this.isAIDisabled() && this.isEntityAlive()) {
            ...
            for (int i = 0; i < 5; ++i) {
                ...
                if (blockpos2.getY() > 0 && this.world.isAirBlock(blockpos2) && this.world.func_191503_g(this) && this.world.getCollisionBoxes(this, new Box(blockpos2)).isEmpty()) {
                    boolean flag = false;
                    EnumFacing[] values;
    ...
    class AIAttack extends EntityAIBase
    {
        ...
        public void updateTask() {
            if (EntityShulker.this.world.getDifficulty() != EnumDifficulty.PEACEFUL) {
                ...
                final double d0 = EntityShulker.this.getDistanceSqToEntity(entitylivingbase);
                if (d0 < 400.0) {
    ...
    class AIAttackNearest extends EntityAINearestAttackableTarget<EntityPlayer>
    {
        ...
        @Override
        protected Box getTargetableArea(final double targetDistance) {
    ...
    {
        public BodyHelper(final EntityLivingBase p_i47062_2_) {
            super(p_i47062_2_);
        }
