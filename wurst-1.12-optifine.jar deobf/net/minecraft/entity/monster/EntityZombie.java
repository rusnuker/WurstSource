...
public class EntityZombie extends EntityMob
{
        ...
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (entitylivingbase != null && this.world.getDifficulty() == EnumDifficulty.HARD && this.rand.nextFloat() < this.getEntityAttribute(EntityZombie.SPAWN_REINFORCEMENTS_CHANCE).getAttributeValue() && this.world.getGameRules().getBoolean("doMobSpawning")) {
                ...
                for (int l = 0; l < 50; ++l) {
                    ...
                    if (this.world.getBlockState(new BlockPos(i2, j2 - 1, k2)).isFullyOpaque() && this.world.getLightFromNeighbors(new BlockPos(i2, j2, k2)) < 10) {
    ...
    public void onKillEntity(final EntityLivingBase entityLivingIn) {
        ...
        if ((this.world.getDifficulty() == EnumDifficulty.NORMAL || this.world.getDifficulty() == EnumDifficulty.HARD) && entityLivingIn instanceof EntityVillager) {
            ...
            entityzombievillager.onInitialSpawn(this.world.getDifficultyForLocation(new BlockPos(entityzombievillager)), new GroupData(false, (GroupData)null));
    ...
    public IEntityLivingData onInitialSpawn(final DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata) {
        ...
        if (livingdata == null) {
            livingdata = new GroupData(this.world.rand.nextFloat() < 0.05f, (GroupData)null);
        }
        if (livingdata instanceof GroupData) {
            ...
            if (entityzombie$groupdata.isChild) {
                ...
                if (this.world.rand.nextFloat() < 0.05) {
                    final List<EntityChicken> list = this.world.getEntitiesWithinAABB((Class<? extends EntityChicken>)EntityChicken.class, this.getEntityBoundingBox().expand(5.0, 3.0, 5.0), (com.google.common.base.Predicate<? super EntityChicken>)EntitySelectors.IS_STANDALONE);
                    if (!list.isEmpty()) {
                    ...
                    this.world.spawnEntityInWorld(entitychicken2);
    ...
    public void onDeath(final DamageSource cause) {
        ...
        if (cause.getEntity() instanceof EntityCreeper) {
            ...
            if (entitycreeper.getPowered() && entitycreeper.isAIEnabled()) {
                ...
                final ItemStack itemstack = this.func_190732_dj();
                if (!itemstack.func_190926_b()) {
