...
public class EntityEvoker extends EntitySpellcasterIllager
{
        ...
        private void func_190876_a(final double p_190876_1_, final double p_190876_3_, final double p_190876_5_, final double p_190876_7_, final float p_190876_9_, final int p_190876_10_) {
            ...
            while (true) {
                ...
                if (!EntityEvoker.this.world.isAirBlock(blockpos)) {
                    ...
                    final Box axisalignedbb = iblockstate.getCollisionBoundingBox(EntityEvoker.this.world, blockpos);
    ...
    public class AIWololoSpell extends AIUseSpell
    {
        ...
        public boolean shouldExecute() {
            ...
            final List<EntitySheep> list = EntityEvoker.this.world.getEntitiesWithinAABB((Class<? extends EntitySheep>)EntitySheep.class, EntityEvoker.this.getEntityBoundingBox().expand(16.0, 4.0, 16.0), (com.google.common.base.Predicate<? super EntitySheep>)this.field_190879_a);
            if (list.isEmpty()) {
                return false;
            }
