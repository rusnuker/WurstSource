...
public class EntityGhast extends EntityFlying implements IMob
{
        ...
        public void updateTask() {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.parentEntity) < 4096.0 && this.parentEntity.canEntityBeSeen(entitylivingbase)) {
                ...
                if (this.attackTimer == 20) {
                    ...
                    final double d3 = entitylivingbase.posX - (this.parentEntity.posX + vec3d.xCoord * 4.0);
                    ...
                    final double d5 = entitylivingbase.posZ - (this.parentEntity.posZ + vec3d.zCoord * 4.0);
                    ...
                    entitylargefireball.posX = this.parentEntity.posX + vec3d.xCoord * 4.0;
                    entitylargefireball.posY = this.parentEntity.posY + this.parentEntity.height / 2.0f + 0.5;
                    entitylargefireball.posZ = this.parentEntity.posZ + vec3d.zCoord * 4.0;
    ...
    static class GhastMoveHelper extends EntityMoveHelper
    {
        ...
        private boolean isNotColliding(final double x, final double y, final double z, final double p_179926_7_) {
            ...
            Box axisalignedbb = this.parentEntity.getEntityBoundingBox();
