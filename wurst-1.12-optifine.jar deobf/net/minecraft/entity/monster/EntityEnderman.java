...
public class EntityEnderman extends EntityMob
{
    ...
    protected boolean teleportToEntity(final Entity p_70816_1_) {
        ...
        final double d2 = this.posX + (this.rand.nextDouble() - 0.5) * 8.0 - vec3d.xCoord * 16.0;
        final double d3 = this.posY + (this.rand.nextInt(16) - 8) - vec3d.yCoord * 16.0;
        final double d4 = this.posZ + (this.rand.nextDouble() - 0.5) * 8.0 - vec3d.zCoord * 16.0;
        ...
        public void updateTask() {
            if (this.player != null) {
                ...
                if (this.targetEntity != null) {
                    ...
                    else if (this.targetEntity.getDistanceSqToEntity(this.enderman) > 256.0 && this.teleportTime++ >= 30 && this.enderman.teleportToEntity(this.targetEntity)) {
                        this.teleportTime = 0;
                    }
                }
                super.updateTask();
