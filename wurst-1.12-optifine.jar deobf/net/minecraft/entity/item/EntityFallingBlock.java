...
public class EntityFallingBlock extends Entity
{
    ...
    public void onUpdate() {
        ...
        if (this.fallTile.getMaterial() == Material.AIR) {
            ...
            if (!this.world.isRemote) {
                ...
                final boolean flag = this.fallTile.getBlock() == Blocks.field_192444_dS;
                ...
                if (!this.onGround && !flag2) {
                    ...
                    if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION) {
                        ...
                        if (!this.canSetAsBlock) {
                            if (this.world.func_190527_a(block, blockpos2, true, EnumFacing.UP, null) && (flag2 || !BlockFalling.canFallThrough(this.world.getBlockState(blockpos2.down()))) && this.world.setBlockState(blockpos2, this.fallTile, 3)) {
                            ...
                            ((BlockFalling)block).func_190974_b(this.world, blockpos2);
                        }
                    }
                }
            }
    ...
    public void fall(final float distance, final float damageMultiplier) {
        ...
        if (this.hurtEntities) {
            ...
            if (i > 0) {
                final List<Entity> list = Lists.newArrayList((Iterable)this.world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox()));
