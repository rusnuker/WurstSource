...
public class AdvancementManager
{
    ...
    private Map<ResourceLocation, Advancement.Builder> func_192781_c() {
        ...
        final Map<ResourceLocation, Advancement.Builder> map = Maps.newHashMap();
        ...
        for (final File file1 : FileUtils.listFiles(this.field_192785_d, new String[] { "json" }, true)) {
            ...
            if (astring.length == 2) {
                ...
                try {
                    ...
                    AdvancementManager.field_192782_a.error("Parsing error loading custom advancement " + resourcelocation, (Throwable)jsonparseexception);
                    this.field_193768_e = true;
                }
                catch (final IOException ioexception) {
                    AdvancementManager.field_192782_a.error("Couldn't read custom advancement " + resourcelocation + " from " + file1, (Throwable)ioexception);
                    this.field_193768_e = true;
                }
            }
        }
    ...
    private void func_192777_a(final Map<ResourceLocation, Advancement.Builder> p_192777_1_) {
        ...
        try {
                ...
                for (final Path path2 : Files.walk(path, new FileVisitOption[0])) {
                    if ("json".equals(FilenameUtils.getExtension(path2.toString()))) {
                        ...
                        try {
                            ...
                            AdvancementManager.field_192782_a.error("Parsing error loading built-in advancement " + resourcelocation, (Throwable)jsonparseexception);
                            this.field_193768_e = true;
                        }
                        catch (final IOException ioexception) {
                            AdvancementManager.field_192782_a.error("Couldn't read advancement " + resourcelocation + " from " + path2, (Throwable)ioexception);
                            this.field_193768_e = true;
                        }
                        finally {
            ...
            AdvancementManager.field_192782_a.error("Couldn't get a list of all built-in advancement files", (Throwable)urisyntaxexception);
            this.field_193768_e = true;
            return;
        }
        finally {
