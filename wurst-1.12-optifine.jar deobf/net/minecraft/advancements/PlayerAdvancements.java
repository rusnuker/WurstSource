...
public class PlayerAdvancements
{
    ...
    public PlayerAdvancements(final MinecraftServer p_i47422_1_, final File p_i47422_2_, final EntityPlayerMP p_i47422_3_) {
        this.field_192758_f = Maps.newLinkedHashMap();
        this.field_192759_g = Sets.newLinkedHashSet();
        this.field_192760_h = Sets.newLinkedHashSet();
        this.field_192761_i = Sets.newLinkedHashSet();
    ...
    private void func_192752_d() {
        final List<Advancement> list = Lists.newArrayList();
    ...
    private void func_192740_f() {
        if (this.field_192757_e.isFile()) {
            try {
                ...
                PlayerAdvancements.field_192753_a.error("Couldn't parse player advancements in " + this.field_192757_e, (Throwable)jsonparseexception);
            }
            catch (final IOException ioexception) {
                PlayerAdvancements.field_192753_a.error("Couldn't access player advancements in " + this.field_192757_e, (Throwable)ioexception);
            }
        }
        this.func_192748_e();
        this.func_192752_d();
    ...
    public void func_192749_b() {
        final Map<ResourceLocation, AdvancementProgress> map = Maps.newHashMap();
        for (final Map.Entry<Advancement, AdvancementProgress> entry : this.field_192758_f.entrySet()) {
        ...
        try {
            Files.write((CharSequence)PlayerAdvancements.field_192754_b.toJson((Object)map), this.field_192757_e, StandardCharsets.UTF_8);
        }
        catch (final IOException ioexception) {
            PlayerAdvancements.field_192753_a.error("Couldn't save player advancements to " + this.field_192757_e, (Throwable)ioexception);
        }
    }
    ...
    public void func_192741_b(final EntityPlayerMP p_192741_1_) {
        if (!this.field_192760_h.isEmpty() || !this.field_192761_i.isEmpty()) {
            final Map<ResourceLocation, AdvancementProgress> map = Maps.newHashMap();
            final Set<Advancement> set = Sets.newLinkedHashSet();
            final Set<ResourceLocation> set2 = Sets.newLinkedHashSet();
