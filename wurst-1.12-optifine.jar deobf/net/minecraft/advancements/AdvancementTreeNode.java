...
public class AdvancementTreeNode
{
    ...
    private final List<AdvancementTreeNode> field_192332_e;
    ...
    public AdvancementTreeNode(final Advancement p_i47466_1_, @Nullable final AdvancementTreeNode p_i47466_2_, @Nullable final AdvancementTreeNode p_i47466_3_, final int p_i47466_4_, final int p_i47466_5_) {
        this.field_192332_e = Lists.newArrayList();
        ...
        for (final Advancement advancement : p_i47466_1_.func_192069_e()) {
            advancementtreenode = this.func_192322_a(advancement, advancementtreenode);
        }
    }
    
    @Nullable
    private AdvancementTreeNode func_192322_a(final Advancement p_192322_1_, @Nullable AdvancementTreeNode p_192322_2_) {
        if (p_192322_1_.func_192068_c() != null) {
            ...
            for (final Advancement advancement : p_192322_1_.func_192069_e()) {
    ...
    private void func_192320_a() {
        if (this.field_192332_e.isEmpty()) {
            ...
            AdvancementTreeNode advancementtreenode = null;
            for (final AdvancementTreeNode advancementtreenode2 : this.field_192332_e) {
            ...
            this.func_192325_b();
            final float f = (this.field_192332_e.get(0).field_192336_i + this.field_192332_e.get(this.field_192332_e.size() - 1).field_192336_i) / 2.0f;
            if (this.field_192330_c != null) {
                this.field_192336_i = this.field_192330_c.field_192336_i + 1.0f;
    ...
    private float func_192319_a(final float p_192319_1_, final int p_192319_2_, float p_192319_3_) {
        ...
        for (final AdvancementTreeNode advancementtreenode : this.field_192332_e) {
            p_192319_3_ = advancementtreenode.func_192319_a(p_192319_1_ + this.field_192337_j, p_192319_2_ + 1, p_192319_3_);
        }
        return p_192319_3_;
    }
    
    private void func_192318_a(final float p_192318_1_) {
    ...
    private void func_192325_b() {
        ...
        for (int i = this.field_192332_e.size() - 1; i >= 0; --i) {
            ...
            final AdvancementTreeNode advancementtreenode = advancementTreeNode = this.field_192332_e.get(i);
            advancementTreeNode.field_192336_i += f;
            final AdvancementTreeNode advancementTreeNode2 = advancementtreenode;
            advancementTreeNode2.field_192337_j += f;
    ...
    private AdvancementTreeNode func_192324_a(AdvancementTreeNode p_192324_1_) {
        ...
        AdvancementTreeNode advancementtreenode3 = this.field_192330_c;
        AdvancementTreeNode advancementtreenode4 = this.field_192329_b.field_192332_e.get(0);
        float f = this.field_192337_j;
        float f2 = this.field_192337_j;
        float f3 = advancementtreenode3.field_192337_j;
        float f4 = advancementtreenode4.field_192337_j;
        while (advancementtreenode3.func_192317_d() != null && advancementtreenode.func_192321_c() != null) {
            advancementtreenode3 = advancementtreenode3.func_192317_d();
            advancementtreenode = advancementtreenode.func_192321_c();
            advancementtreenode4 = advancementtreenode4.func_192321_c();
            advancementtreenode2 = advancementtreenode2.func_192317_d();
            advancementtreenode2.field_192333_f = this;
            final float f5 = advancementtreenode3.field_192336_i + f3 - (advancementtreenode.field_192336_i + f) + 1.0f;
            if (f5 > 0.0f) {
                advancementtreenode3.func_192326_a(this, p_192324_1_).func_192316_a(this, f5);
                f += f5;
                f2 += f5;
            }
            f3 += advancementtreenode3.field_192337_j;
            f += advancementtreenode.field_192337_j;
            f4 += advancementtreenode4.field_192337_j;
            f2 += advancementtreenode2.field_192337_j;
        }
        if (advancementtreenode3.func_192317_d() != null && advancementtreenode2.func_192317_d() == null) {
            advancementtreenode2.field_192334_g = advancementtreenode3.func_192317_d();
            final AdvancementTreeNode advancementTreeNode = advancementtreenode2;
            advancementTreeNode.field_192337_j += f3 - f2;
        }
        else {
            if (advancementtreenode.func_192321_c() != null && advancementtreenode4.func_192321_c() == null) {
                advancementtreenode4.field_192334_g = advancementtreenode.func_192321_c();
                final AdvancementTreeNode advancementTreeNode2 = advancementtreenode4;
                advancementTreeNode2.field_192337_j += f - f4;
            }
            p_192324_1_ = this;
        }
        return p_192324_1_;
    ...
    private void func_192316_a(final AdvancementTreeNode p_192316_1_, final float p_192316_2_) {
        final float f = (float)(p_192316_1_.field_192331_d - this.field_192331_d);
        if (f != 0.0f) {
    ...
    private AdvancementTreeNode func_192326_a(final AdvancementTreeNode p_192326_1_, final AdvancementTreeNode p_192326_2_) {
    ...
    public static void func_192323_a(final Advancement p_192323_0_) {
        if (p_192323_0_.func_192068_c() == null) {
            throw new IllegalArgumentException("Can't position children of an invisible root!");
        }
        final AdvancementTreeNode advancementtreenode = new AdvancementTreeNode(p_192323_0_, null, null, 1, 0);
        advancementtreenode.func_192320_a();
        final float f = advancementtreenode.func_192319_a(0.0f, 0, advancementtreenode.field_192336_i);
        if (f < 0.0f) {
