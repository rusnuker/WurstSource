...
public class TickTrigger implements ICriterionTrigger<Instance>
{
    ...
    public TickTrigger() {
        this.field_193184_b = Maps.newHashMap();
    }
    ...
    static class Listeners
    {
        ...
        public Listeners(final PlayerAdvancements p_i47496_1_) {
            this.field_193505_b = Sets.newHashSet();
        ...
        public void func_193503_b() {
            for (final Listener<Instance> listener : Lists.newArrayList((Iterable)this.field_193505_b)) {
