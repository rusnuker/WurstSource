...
public class BiomeProvider
{
    ...
    protected BiomeProvider() {
        ...
        this.biomesToSpawnIn = Lists.newArrayList((Object[])new Biome[] { Biomes.FOREST, Biomes.PLAINS, Biomes.TAIGA, Biomes.TAIGA_HILLS, Biomes.FOREST_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_HILLS });
    }
    ...
    private BiomeProvider(final long seed, final WorldType worldTypeIn, final String options) {
        ...
        final GenLayer[] agenlayer = GenLayer.initializeAllBiomeGenerators(seed, worldTypeIn, this.field_190945_a);
