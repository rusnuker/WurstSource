...
public enum GameType
{
    ...
    private GameType(final String name, final int ordinal, final int idIn, final String nameIn, final String shortNameIn) {
        this.id = idIn;
        this.name = nameIn;
    ...
    public void configurePlayerCapabilities(final PlayerCapabilities capabilities) {
        if (this == GameType.CREATIVE) {
            ...
            capabilities.creativeMode = true;
            capabilities.disableDamage = true;
        }
        else if (this == GameType.SPECTATOR) {
            capabilities.allowFlying = true;
            capabilities.creativeMode = false;
            capabilities.disableDamage = true;
