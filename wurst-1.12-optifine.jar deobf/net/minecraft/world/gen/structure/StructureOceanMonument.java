...
public class StructureOceanMonument extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
        ...
        if (i == k && j == l) {
            if (!this.worldObj.getBiomeProvider().areBiomesViable(i * 16 + 8, j * 16 + 8, 16, StructureOceanMonument.SPAWN_BIOMES)) {
                return false;
            }
            final boolean flag = this.worldObj.getBiomeProvider().areBiomesViable(i * 16 + 8, j * 16 + 8, 29, StructureOceanMonument.WATER_BIOMES);
            if (flag) {
                return true;
            }
        }
    ...
    public BlockPos getClosestStrongholdPos(final World worldIn, final BlockPos pos, final boolean p_180706_3_) {
        ...
        return MapGenStructure.func_191069_a(worldIn, this, pos, this.spacing, this.separation, 10387313, true, 100, p_180706_3_);
    }
