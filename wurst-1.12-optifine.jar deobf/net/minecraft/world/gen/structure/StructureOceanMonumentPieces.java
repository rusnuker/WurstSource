...
public class StructureOceanMonumentPieces
{
    ...
    public static class MonumentBuilding extends Piece
    {
        ...
        public MonumentBuilding(final Random p_i45599_1_, final int p_i45599_2_, final int p_i45599_3_, final EnumFacing p_i45599_4_) {
            ...
            final List<MonumentRoomFitHelper> list2 = Lists.newArrayList();
            list2.add(new XYDoubleRoomFitHelper(null));
            list2.add(new YZDoubleRoomFitHelper(null));
            list2.add(new ZDoubleRoomFitHelper(null));
            list2.add(new XDoubleRoomFitHelper(null));
            list2.add(new YDoubleRoomFitHelper(null));
            list2.add(new FitSimpleRoomTopHelper(null));
            list2.add(new FitSimpleRoomHelper(null));
        ...
        private List<RoomDefinition> generateRoomGraph(final Random p_175836_1_) {
                    ...
                    for (int i4 = 0; i4 < 3; ++i4) {
                        ...
                        if (astructureoceanmonumentpieces$roomdefinition[l4] != null) {
                            ...
                            for (int length = (values = EnumFacing.values()).length, n = 0; n < length; ++n) {
                                ...
                                final int i5 = k4 + enumfacing.getFrontOffsetX();
                                final int j5 = i4 + enumfacing.getFrontOffsetY();
                                final int k5 = j4 + enumfacing.getFrontOffsetZ();
            ...
            final List<RoomDefinition> list = Lists.newArrayList();
            RoomDefinition[] array;
            for (int length2 = (array = astructureoceanmonumentpieces$roomdefinition).length, n2 = 0; n2 < length2; ++n2) {
                final RoomDefinition structureoceanmonumentpieces$roomdefinition4 = array[n2];
            ...
            for (final RoomDefinition structureoceanmonumentpieces$roomdefinition5 : list) {
                ...
                while (j6 < 2 && k6 < 5) {
                    ...
                    if (structureoceanmonumentpieces$roomdefinition5.hasOpening[l6]) {
                        final int i7 = EnumFacing.getFront(l6).getOpposite().getIndex();
