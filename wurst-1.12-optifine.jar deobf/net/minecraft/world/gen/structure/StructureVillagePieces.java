...
public class StructureVillagePieces
{
    ...
    public static List<PieceWeight> getStructureVillageWeightedPieceList(final Random random, final int size) {
        final List<PieceWeight> list = Lists.newArrayList();
        ...
        while (j < 5) {
            ...
            for (final PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList) {
                ...
                if (k < 0) {
                    ...
                    if (structurevillagepieces$pieceweight == start.structVillagePieceWeight && start.structureVillageWeightedPieceList.size() > 1) {
                        break;
                    }
    ...
    public static class Start extends Well
    {
        ...
        public Start(final BiomeProvider chunkManagerIn, final int p_i2104_2_, final Random rand, final int p_i2104_4_, final int p_i2104_5_, final List<PieceWeight> p_i2104_6_, final int p_i2104_7_) {
            ...
            final Biome biome = chunkManagerIn.getBiome(new BlockPos(p_i2104_4_, 0, p_i2104_5_), Biomes.DEFAULT);
    ...
    abstract static class Village extends StructureComponent
    {
        ...
        protected IBlockState getBiomeSpecificBlockState(final IBlockState blockstateIn) {
            if (this.structureType == 1) {
                ...
                if (blockstateIn.getBlock() == Blocks.OAK_STAIRS) {
                    return Blocks.SANDSTONE_STAIRS.getDefaultState().withProperty((IProperty<Comparable>)BlockStairs.FACING, (EnumFacing)blockstateIn.getValue((IProperty<V>)BlockStairs.FACING));
                }
                ...
                if (blockstateIn.getBlock() == Blocks.LOG || blockstateIn.getBlock() == Blocks.LOG2) {
                    return Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE).withProperty(BlockLog.LOG_AXIS, (BlockLog.EnumAxis)blockstateIn.getValue((IProperty<V>)BlockLog.LOG_AXIS));
                }
                if (blockstateIn.getBlock() == Blocks.PLANKS) {
                    return Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE);
                }
                if (blockstateIn.getBlock() == Blocks.OAK_STAIRS) {
                    return Blocks.SPRUCE_STAIRS.getDefaultState().withProperty((IProperty<Comparable>)BlockStairs.FACING, (EnumFacing)blockstateIn.getValue((IProperty<V>)BlockStairs.FACING));
                }
                ...
                if (blockstateIn.getBlock() == Blocks.LOG || blockstateIn.getBlock() == Blocks.LOG2) {
                    return Blocks.LOG2.getDefaultState().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.LOG_AXIS, (BlockLog.EnumAxis)blockstateIn.getValue((IProperty<V>)BlockLog.LOG_AXIS));
                }
                if (blockstateIn.getBlock() == Blocks.PLANKS) {
                    return Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA);
                }
                if (blockstateIn.getBlock() == Blocks.OAK_STAIRS) {
                    return Blocks.ACACIA_STAIRS.getDefaultState().withProperty((IProperty<Comparable>)BlockStairs.FACING, (EnumFacing)blockstateIn.getValue((IProperty<V>)BlockStairs.FACING));
                }
                if (blockstateIn.getBlock() == Blocks.COBBLESTONE) {
        ...
        protected void func_189927_a(final World p_189927_1_, final StructureBoundingBox p_189927_2_, final Random p_189927_3_, final int p_189927_4_, final int p_189927_5_, final int p_189927_6_, final EnumFacing p_189927_7_) {
            if (!this.isZombieInfested) {
        ...
        protected void func_189926_a(final World p_189926_1_, final EnumFacing p_189926_2_, final int p_189926_3_, final int p_189926_4_, final int p_189926_5_, final StructureBoundingBox p_189926_6_) {
            if (!this.isZombieInfested) {
        ...
        protected void func_189924_a(final int p_189924_1_) {
