...
public class StructureStrongholdPieces
{
    ...
    public static void prepareStructurePieces() {
        ...
        for (int length = (piece_WEIGHTS = StructureStrongholdPieces.PIECE_WEIGHTS).length, i = 0; i < length; ++i) {
            final PieceWeight structurestrongholdpieces$pieceweight = piece_WEIGHTS[i];
    ...
    static /* synthetic */ void access$2(final Class strongComponentType) {
        StructureStrongholdPieces.strongComponentType = strongComponentType;
    }
