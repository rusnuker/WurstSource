    ...
    private void generatePositions() {
        ...
        if (l < this.structureCoords.length) {
            for (int i2 = 0; i2 < this.structureCoords.length; ++i2) {
                ...
                final BlockPos blockpos = this.worldObj.getBiomeProvider().findBiomePosition((j2 << 4) + 8, (k2 << 4) + 8, 112, this.allowedBiomes, random);
                if (blockpos != null) {
                    j2 = blockpos.getX() >> 4;
                    k2 = blockpos.getZ() >> 4;
                }
