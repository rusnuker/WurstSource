...
public class StructureNetherBridgePieces
{
            ...
            while (j < 5 && flag) {
                ...
                for (final PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_) {
                    ...
                    if (k < 0) {
                        ...
                        if (structurenetherbridgepieces$pieceweight == p_175871_1_.theNetherBridgePieceWeight && !structurenetherbridgepieces$pieceweight.allowInRow) {
                            break;
                        }
    ...
    public static class Start extends Crossing3
    {
        ...
        public Start(final Random p_i2059_1_, final int p_i2059_2_, final int p_i2059_3_) {
            ...
            for (int length = (access$1 = StructureNetherBridgePieces.PRIMARY_COMPONENTS).length, i = 0; i < length; ++i) {
            ...
            for (int length2 = (access$2 = StructureNetherBridgePieces.SECONDARY_COMPONENTS).length, j = 0; j < length2; ++j) {
