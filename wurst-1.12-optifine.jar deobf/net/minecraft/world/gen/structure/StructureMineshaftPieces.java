...
public class StructureMineshaftPieces
{
    ...
    private static Peice func_189940_a(final List<StructureComponent> p_189940_0_, final Random p_189940_1_, final int p_189940_2_, final int p_189940_3_, final int p_189940_4_, @Nullable final EnumFacing p_189940_5_, final int p_189940_6_, final MapGenMineshaft.Type p_189940_7_) {
    ...
    private static Peice func_189938_b(final StructureComponent p_189938_0_, final List<StructureComponent> p_189938_1_, final Random p_189938_2_, final int p_189938_3_, final int p_189938_4_, final int p_189938_5_, final EnumFacing p_189938_6_, final int p_189938_7_) {
        if (p_189938_7_ > 8) {
            return null;
        }
        if (Math.abs(p_189938_3_ - p_189938_0_.getBoundingBox().minX) <= 80 && Math.abs(p_189938_5_ - p_189938_0_.getBoundingBox().minZ) <= 80) {
            ...
            final Peice structuremineshaftpieces$peice = func_189940_a(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1, mapgenmineshaft$type);
    ...
    public static class Corridor extends Peice
    {
        ...
        public void buildComponent(final StructureComponent componentIn, final List<StructureComponent> listIn, final Random rand) {
            ...
            if (enumfacing != null) {
                switch (enumfacing) {
                    default: {
                        if (j <= 1) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, enumfacing, i);
                            break;
                        }
                        if (j == 2) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.WEST, i);
                            break;
                        }
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, EnumFacing.EAST, i);
                        break;
                    }
                    case SOUTH: {
                        if (j <= 1) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, enumfacing, i);
                            break;
                        }
                        if (j == 2) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.WEST, i);
                            break;
                        }
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ - 3, EnumFacing.EAST, i);
                        break;
                    }
                    case WEST: {
                        if (j <= 1) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i);
                            break;
                        }
                        if (j == 2) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                            break;
                        }
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;
                    }
                    case EAST: {
                        if (j <= 1) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, enumfacing, i);
                            break;
                        }
                        if (j == 2) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                            break;
                        }
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX - 3, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;
                    }
                }
            }
            if (i < 8) {
                if (enumfacing != EnumFacing.NORTH && enumfacing != EnumFacing.SOUTH) {
                    for (int i2 = this.boundingBox.minX + 3; i2 + 3 <= this.boundingBox.maxX; i2 += 5) {
                        ...
                        if (j2 == 0) {
                            func_189938_b(componentIn, listIn, rand, i2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                        }
                        else if (j2 == 1) {
                            func_189938_b(componentIn, listIn, rand, i2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                        }
                    }
                }
                else {
                    for (int k = this.boundingBox.minZ + 3; k + 3 <= this.boundingBox.maxZ; k += 5) {
                        ...
                        if (l == 0) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, k, EnumFacing.WEST, i + 1);
                        }
                        else if (l == 1) {
                            func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, k, EnumFacing.EAST, i + 1);
                        }
                    }
                }
            }
        ...
        public boolean addComponentParts(final World worldIn, final Random randomIn, final StructureBoundingBox structureBoundingBoxIn) {
            ...
            final IBlockState iblockstate = this.func_189917_F_();
            ...
            this.func_189914_a(worldIn, structureBoundingBoxIn, randomIn, 0.8f, 0, 2, 0, 2, 2, i2, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false, 0);
            if (this.hasSpiders) {
                this.func_189914_a(worldIn, structureBoundingBoxIn, randomIn, 0.6f, 0, 0, 0, 2, 1, i2, Blocks.WEB.getDefaultState(), Blocks.AIR.getDefaultState(), false, 8);
            }
            for (int j2 = 0; j2 < this.sectionCount; ++j2) {
                final int k2 = 2 + j2 * 5;
                this.func_189921_a(worldIn, structureBoundingBoxIn, 0, 0, k2, 2, 2, randomIn);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1f, 0, 2, k2 - 1);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1f, 2, 2, k2 - 1);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1f, 0, 2, k2 + 1);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.1f, 2, 2, k2 + 1);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05f, 0, 2, k2 - 2);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05f, 2, 2, k2 - 2);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05f, 0, 2, k2 + 2);
                this.func_189922_a(worldIn, structureBoundingBoxIn, randomIn, 0.05f, 2, 2, k2 + 2);
                ...
                if (this.hasSpiders && !this.spawnerPlaced) {
                    ...
                    if (structureBoundingBoxIn.isVecInside(blockpos) && this.func_189916_b(worldIn, 1, 0, i3, structureBoundingBoxIn) < 8) {
            ...
            for (int l3 = 0; l3 <= 2; ++l3) {
                for (int i4 = 0; i4 <= i2; ++i4) {
                    ...
                    if (iblockstate2.getMaterial() == Material.AIR && this.func_189916_b(worldIn, l3, -1, i4, structureBoundingBoxIn) < 8) {
                        final int l4 = -1;
            ...
            if (this.hasRails) {
                ...
                for (int j4 = 0; j4 <= i2; ++j4) {
                    ...
                    if (iblockstate4.getMaterial() != Material.AIR && iblockstate4.isFullBlock()) {
                        final float f = (this.func_189916_b(worldIn, 1, 0, j4, structureBoundingBoxIn) > 8) ? 0.9f : 0.7f;
        ...
        private void func_189921_a(final World p_189921_1_, final StructureBoundingBox p_189921_2_, final int p_189921_3_, final int p_189921_4_, final int p_189921_5_, final int p_189921_6_, final int p_189921_7_, final Random p_189921_8_) {
            if (this.func_189918_a(p_189921_1_, p_189921_2_, p_189921_3_, p_189921_7_, p_189921_6_, p_189921_5_)) {
                final IBlockState iblockstate = this.func_189917_F_();
                final IBlockState iblockstate2 = this.func_189919_b();
        ...
        private void func_189922_a(final World p_189922_1_, final StructureBoundingBox p_189922_2_, final Random p_189922_3_, final float p_189922_4_, final int p_189922_5_, final int p_189922_6_, final int p_189922_7_) {
    ...
    public static class Cross extends Peice
    {
        ...
        public void buildComponent(final StructureComponent componentIn, final List<StructureComponent> listIn, final Random rand) {
            ...
            switch (this.corridorDirection) {
                default: {
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
                }
                case SOUTH: {
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                    break;
                }
            ...
            if (this.isMultipleFloors) {
                if (rand.nextBoolean()) {
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                }
                if (rand.nextBoolean()) {
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.WEST, i);
                }
                if (rand.nextBoolean()) {
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.minZ + 1, EnumFacing.EAST, i);
                }
                if (rand.nextBoolean()) {
                    func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.minY + 3 + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                }
            }
        }
        ...
        private void func_189923_b(final World p_189923_1_, final StructureBoundingBox p_189923_2_, final int p_189923_3_, final int p_189923_4_, final int p_189923_5_, final int p_189923_6_) {
    ...
    abstract static class Peice extends StructureComponent
    {
        ...
        protected boolean func_189918_a(final World p_189918_1_, final StructureBoundingBox p_189918_2_, final int p_189918_3_, final int p_189918_4_, final int p_189918_5_, final int p_189918_6_) {
    ...
    {
        private final List<StructureBoundingBox> roomsLinkedToTheRoom;
        ...
        public void buildComponent(final StructureComponent componentIn, final List<StructureComponent> listIn, final Random rand) {
            ...
            for (int k = 0; k < this.boundingBox.getXSize(); k += 4) {
                ...
                final Peice structuremineshaftpieces$peice = func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                if (structuremineshaftpieces$peice != null) {
            ...
            for (int k = 0; k < this.boundingBox.getXSize(); k += 4) {
                ...
                final Peice structuremineshaftpieces$peice2 = func_189938_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            ...
            for (int k = 0; k < this.boundingBox.getZSize(); k += 4) {
                ...
                final Peice structuremineshaftpieces$peice3 = func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
            ...
            for (int k = 0; k < this.boundingBox.getZSize(); k += 4) {
                ...
                final StructureComponent structurecomponent = func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
    ...
    public static class Stairs extends Peice
    {
        ...
        public void buildComponent(final StructureComponent componentIn, final List<StructureComponent> listIn, final Random rand) {
            ...
            if (enumfacing != null) {
                switch (enumfacing) {
                    default: {
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i);
                        break;
                    }
                    case SOUTH: {
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
                        break;
                    }
                    case WEST: {
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, i);
                        break;
                    }
                    case EAST: {
                        func_189938_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, i);
                        break;
                    }
                }
            }
