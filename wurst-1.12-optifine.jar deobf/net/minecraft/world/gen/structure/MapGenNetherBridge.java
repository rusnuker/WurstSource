...
public class MapGenNetherBridge extends MapGenStructure
{
    ...
    public MapGenNetherBridge() {
        (this.spawnList = Lists.newArrayList()).add(new Biome.SpawnListEntry(EntityBlaze.class, 10, 2, 3));
            ...
            for (int i2 = -l; i2 <= l; ++i2) {
                ...
                for (int j2 = -l; j2 <= l; ++j2) {
                    ...
                    if (flag || flag2) {
                        final int k2 = j + i2;
                        final int l2 = k + j2;
                        if (this.canSpawnStructureAtCoords(k2, l2) && (!p_180706_3_ || !worldIn.func_190526_b(k2, l2))) {
