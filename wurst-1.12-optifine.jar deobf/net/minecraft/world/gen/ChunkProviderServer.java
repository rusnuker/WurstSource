...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public Chunk getLoadedChunk(final int x, final int z) {
        ...
        final Chunk chunk = (Chunk)this.id2ChunkMap.get(i);
        if (chunk != null) {
    ...
    public boolean saveChunks(final boolean p_186027_1_) {
        int i = 0;
        final List<Chunk> list = Lists.newArrayList((Iterable)this.id2ChunkMap.values());
        ...
        if (!this.worldObj.disableLevelSaving) {
            if (!this.droppedChunksSet.isEmpty()) {
                ...
                while (i < 100 && iterator.hasNext()) {
                    ...
                    final Chunk chunk = (Chunk)this.id2ChunkMap.get((Object)olong);
