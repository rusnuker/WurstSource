...
public class WorldGenMinable extends WorldGenerator
{
    ...
    public WorldGenMinable(final IBlockState state, final int blockCount) {
        this(state, blockCount, (Predicate<IBlockState>)new StonePredicate(null));
    }
    ...
    public boolean generate(final World worldIn, final Random rand, final BlockPos position) {
        ...
        for (int i = 0; i < this.numberOfBlocks; ++i) {
            ...
            final int j = MathHelper.floor(d7 - d11 / 2.0);
            final int k = MathHelper.floor(d8 - d12 / 2.0);
            final int l = MathHelper.floor(d9 - d11 / 2.0);
                        ...
                        if (d13 * d13 + d14 * d14 < 1.0) {
                            for (int j3 = l; j3 <= k2; ++j3) {
                                ...
                                if (d13 * d13 + d14 * d14 + d15 * d15 < 1.0) {
                                    ...
                                    if (this.predicate.apply((Object)worldIn.getBlockState(blockpos))) {
    ...
    static class StonePredicate implements Predicate<IBlockState>
    {
        ...
        public boolean apply(final IBlockState p_apply_1_) {
            if (p_apply_1_ != null && p_apply_1_.getBlock() == Blocks.STONE) {
                final BlockStone.EnumType blockstone$enumtype = p_apply_1_.getValue(BlockStone.VARIANT);
