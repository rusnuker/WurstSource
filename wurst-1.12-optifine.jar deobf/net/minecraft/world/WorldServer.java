...
public class WorldServer extends World implements IThreadListener
{
    ...
    protected BlockPos adjustPosToNearbyEntity(final BlockPos pos) {
        ...
        final Box axisalignedbb = new Box(blockpos, new BlockPos(blockpos.getX(), this.getHeight(), blockpos.getZ())).expandXyz(3.0);
    ...
    private boolean canAddEntity(final Entity entityIn) {
        if (entityIn.isDead) {
            WorldServer.LOGGER.warn("Tried to add entity {} but it was marked as removed already", (Object)EntityList.func_191301_a(entityIn));
            return false;
        }
        ...
        if (this.entitiesByUuid.containsKey(uuid)) {
            ...
            if (this.unloadedEntityList.contains(entity)) {
                ...
                if (!(entityIn instanceof EntityPlayer)) {
                    WorldServer.LOGGER.warn("Keeping entity {} that already exists with UUID {}", (Object)EntityList.func_191301_a(entity), (Object)uuid.toString());
                    return false;
                }
