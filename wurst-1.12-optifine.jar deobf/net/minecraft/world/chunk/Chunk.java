...
public class Chunk
{
    ...
    public void addEntity(final Entity entityIn) {
        ...
        if (i != this.xPosition || j != this.zPosition) {
            Chunk.LOGGER.warn("Wrong location! ({}, {}) should be ({}, {}), {}", (Object)i, (Object)j, (Object)this.xPosition, (Object)this.zPosition, (Object)entityIn);
            entityIn.setDead();
        }
                ...
                for (final Entity entity : this.entityLists[k]) {
                    if (entity.getEntityBoundingBox().intersectsWith(aabb) && entity != entityIn) {
                        ...
                        for (int length = (array = aentity).length, l = 0; l < length; ++l) {
                            ...
                            if (entity2 != entityIn && entity2.getEntityBoundingBox().intersectsWith(aabb) && (p_177414_4_ == null || p_177414_4_.apply((Object)entity2))) {
    ...
    public <T extends Entity> void getEntitiesOfTypeWithinAAAB(final Class<? extends T> entityClass, final Box aabb, final List<T> listToFill, final Predicate<? super T> filter) {
        ...
        for (int k = i; k <= j; ++k) {
            for (final T t : this.entityLists[k].getByClass(entityClass)) {
                if (t.getEntityBoundingBox().intersectsWith(aabb) && (filter == null || filter.apply((Object)t))) {
                    listToFill.add(t);
                }
            }
        }
