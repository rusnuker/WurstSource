...
public class LootFunctionManager
{
    ...
    public static <T extends LootFunction> void registerFunction(final LootFunction.Serializer<? extends T> p_186582_0_) {
        final ResourceLocation resourcelocation = p_186582_0_.getFunctionName();
        final Class<T> oclass = (Class<T>)p_186582_0_.getFunctionClass();
        ...
        LootFunctionManager.NAME_TO_SERIALIZER_MAP.put(resourcelocation, p_186582_0_);
        LootFunctionManager.CLASS_TO_SERIALIZER_MAP.put(oclass, p_186582_0_);
    }
