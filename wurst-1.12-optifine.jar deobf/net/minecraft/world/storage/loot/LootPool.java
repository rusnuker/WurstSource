...
public class LootPool
{
    ...
    protected void createLootRoll(final Collection<ItemStack> stacks, final Random rand, final LootContext context) {
        final List<LootEntry> list = Lists.newArrayList();
        int i = 0;
        LootEntry[] lootEntries;
        for (int length = (lootEntries = this.lootEntries).length, l = 0; l < length; ++l) {
            final LootEntry lootentry = lootEntries[l];
