...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    public void writePlayerData(final EntityPlayer player) {
        try {
            ...
            final File file1 = new File(this.playersDirectory, String.valueOf(player.getCachedUniqueIdString()) + ".dat.tmp");
            final File file2 = new File(this.playersDirectory, String.valueOf(player.getCachedUniqueIdString()) + ".dat");
    ...
    public NBTTagCompound readPlayerData(final EntityPlayer player) {
        ...
        try {
            final File file1 = new File(this.playersDirectory, String.valueOf(player.getCachedUniqueIdString()) + ".dat");
