...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable
{
    ...
    public void func_194026_b(final ITextComponent p_194026_1_) {
        try {
            NetHandlerLoginServer.LOGGER.info("Disconnecting {}: {}", (Object)this.getConnectionInfo(), (Object)p_194026_1_.getUnformattedText());
        ...
        new Thread("User Authenticator #" + NetHandlerLoginServer.AUTHENTICATOR_THREAD_ID.incrementAndGet()) {
            ...
            public void run() {
                ...
                try {
                    ...
                    NetHandlerLoginServer.access$3(NetHandlerLoginServer.this, NetHandlerLoginServer.this.server.getMinecraftSessionService().hasJoinedServer(new GameProfile((UUID)null, gameprofile.getName()), s, this.func_191235_a()));
