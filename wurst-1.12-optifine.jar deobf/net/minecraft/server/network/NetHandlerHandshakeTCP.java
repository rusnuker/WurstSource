        ...
        switch (packetIn.getRequestedState()) {
            case LOGIN: {
                ...
                if (packetIn.getProtocolVersion() > 335) {
                    final ITextComponent itextcomponent = new TextComponentTranslation("multiplayer.disconnect.outdated_server", new Object[] { "1.12" });
                    this.networkManager.sendPacket(new SPacketDisconnect(itextcomponent));
                    this.networkManager.closeChannel(itextcomponent);
                    break;
                }
                if (packetIn.getProtocolVersion() < 335) {
                    final ITextComponent itextcomponent2 = new TextComponentTranslation("multiplayer.disconnect.outdated_client", new Object[] { "1.12" });
