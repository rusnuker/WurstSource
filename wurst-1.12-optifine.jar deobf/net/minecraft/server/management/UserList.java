...
public class UserList<K, V extends UserListEntry<K>>
{
    ...
    private static final ParameterizedType USER_LIST_ENTRY_TYPE;
    ...
    public UserList(final File saveFile) {
        ...
        gsonbuilder.registerTypeHierarchyAdapter((Class)UserListEntry.class, (Object)new Serializer((Serializer)null));
    ...
    public void removeEntry(final K entry) {
