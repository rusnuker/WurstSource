...
public class PlayerChunkMapEntry
{
    ...
    public void addPlayer(final EntityPlayerMP player) {
        if (this.players.contains(player)) {
            PlayerChunkMapEntry.LOGGER.debug("Failed to add player. {} already is in chunk {}, {}", (Object)player, (Object)this.pos.chunkXPos, (Object)this.pos.chunkZPos);
        }
        else {
    ...
    public void sendNearbySpecialEntities(final EntityPlayerMP player) {
        if (this.sentToPlayers) {
    ...
    public void update() {
        if (this.sentToPlayers && this.chunk != null && this.changes != 0) {
            if (this.changes == 1) {
                final int i = (this.changedBlocks[0] >> 12 & 0xF) + this.pos.chunkXPos * 16;
                final int j = this.changedBlocks[0] & 0xFF;
                final int k = (this.changedBlocks[0] >> 8 & 0xF) + this.pos.chunkZPos * 16;
                ...
                for (int l = 0; l < this.changes; ++l) {
                    final int i2 = (this.changedBlocks[l] >> 12 & 0xF) + this.pos.chunkXPos * 16;
                    final int j2 = this.changedBlocks[l] & 0xFF;
                    final int k2 = (this.changedBlocks[l] >> 8 & 0xF) + this.pos.chunkZPos * 16;
