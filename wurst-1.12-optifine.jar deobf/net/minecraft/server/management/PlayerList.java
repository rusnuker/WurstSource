...
public abstract class PlayerList
{
    ...
    public void initializeConnectionToPlayer(final NetworkManager netManager, final EntityPlayerMP playerIn) {
        ...
        PlayerList.LOG.info("{}[{}] logged in with entity id {} at ({}, {}, {})", (Object)playerIn.getName(), (Object)s2, (Object)playerIn.getEntityId(), (Object)playerIn.posX, (Object)playerIn.posY, (Object)playerIn.posZ);
        ...
        nethandlerplayserver.sendPacket(new SPacketHeldItemChange(playerIn.inventory.selectedSlot));
    ...
    protected void writePlayerData(final EntityPlayerMP playerIn) {
        ...
        final PlayerAdvancements playeradvancements = this.field_192055_p.get(playerIn.getUniqueID());
    ...
    public EntityPlayerMP createPlayerForUser(final GameProfile profile) {
        ...
        for (final EntityPlayerMP entityplayermp3 : list) {
            entityplayermp3.connection.func_194028_b(new TextComponentTranslation("multiplayer.disconnect.duplicate_login", new Object[0]));
        }
    ...
    public EntityPlayerMP recreatePlayerEntity(final EntityPlayerMP playerIn, final int dimension, final boolean conqueredEnd) {
        ...
        final EntityPlayerMP entityplayermp = new EntityPlayerMP(this.mcServer, this.mcServer.worldServerForDimension(playerIn.dimension), playerIn.getGameProfile(), playerinteractionmanager);
    ...
    public void changePlayerDimension(final EntityPlayerMP player, final int dimensionIn) {
        ...
        final WorldServer worldserver = this.mcServer.worldServerForDimension(player.dimension);
        player.dimension = dimensionIn;
        final WorldServer worldserver2 = this.mcServer.worldServerForDimension(player.dimension);
    ...
    public String getFormattedListOfPlayers(final boolean includeUUIDs) {
        String s = "";
        final List<EntityPlayerMP> list = Lists.newArrayList((Iterable)this.playerEntityList);
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (includeUUIDs) {
                s = String.valueOf(s) + " (" + list.get(i).getCachedUniqueIdString() + ")";
            }
        }
        return s;
    }
    ...
    public void addOp(final GameProfile profile) {
        final int i = this.mcServer.getOpPermissionLevel();
        ((UserList<K, UserListOpsEntry>)this.ops).addEntry(new UserListOpsEntry(profile, this.mcServer.getOpPermissionLevel(), this.ops.bypassesPlayerLimit(profile)));
    ...
    public void syncPlayerInventory(final EntityPlayerMP playerIn) {
        ...
        playerIn.connection.sendPacket(new SPacketHeldItemChange(playerIn.inventory.selectedSlot));
    }
    ...
    public void sendChatMsgImpl(final ITextComponent component, final boolean isSystem) {
    ...
    public void sendChatMsg(final ITextComponent component) {
    ...
    public PlayerAdvancements func_192054_h(final EntityPlayerMP p_192054_1_) {
        final UUID uuid = p_192054_1_.getUniqueID();
        PlayerAdvancements playeradvancements = this.field_192055_p.get(uuid);
        if (playeradvancements == null) {
            final File file1 = new File(this.mcServer.worldServerForDimension(0).getSaveHandler().getWorldDirectory(), "advancements");
            final File file2 = new File(file1, uuid + ".json");
    ...
    public void func_193244_w() {
        for (final PlayerAdvancements playeradvancements : this.field_192055_p.values()) {
