...
public class TileEntityPiston extends TileEntity implements ITickable
{
    ...
    public Box getAABB(final IBlockAccess p_184321_1_, final BlockPos p_184321_2_) {
        return this.getAABB(p_184321_1_, p_184321_2_, this.progress).union(this.getAABB(p_184321_1_, p_184321_2_, this.lastProgress));
    }
    
    public Box getAABB(final IBlockAccess p_184319_1_, final BlockPos p_184319_2_, float p_184319_3_) {
    ...
    private void moveCollidedEntities(final float p_184322_1_) {
        ...
        this.func_190606_j().addCollisionBoxToList(this.world, BlockPos.ORIGIN, new Box(BlockPos.ORIGIN), list, null, true);
        if (!list.isEmpty()) {
            final Box axisalignedbb = this.func_190607_a(this.func_191515_a(list));
                ...
                for (int i = 0; i < list2.size(); ++i) {
                    ...
                    if (entity.getPushReaction() != EnumPushReaction.IGNORE) {
                        ...
                        for (int j = 0; j < list.size(); ++j) {
                            final Box axisalignedbb2 = this.func_190610_a(this.func_190607_a(list.get(j)), enumfacing, d0);
                            final Box axisalignedbb3 = entity.getEntityBoundingBox();
    ...
    private Box func_191515_a(final List<Box> p_191515_1_) {
        double d0 = 0.0;
        double d2 = 0.0;
        double d3 = 0.0;
        double d4 = 1.0;
        double d5 = 1.0;
        double d6 = 1.0;
        for (final Box axisalignedbb : p_191515_1_) {
        ...
        return new Box(d0, d2, d3, d4, d5, d6);
    }
    
    private double func_190612_a(final Box p_190612_1_, final EnumFacing p_190612_2_, final Box p_190612_3_) {
    ...
    private Box func_190607_a(final Box p_190607_1_) {
    ...
    private Box func_190610_a(final Box p_190610_1_, final EnumFacing p_190610_2_, final double p_190610_3_) {
        ...
        switch (p_190610_2_) {
            case WEST: {
                return new Box(p_190610_1_.minX + d2, p_190610_1_.minY, p_190610_1_.minZ, p_190610_1_.minX + d3, p_190610_1_.maxY, p_190610_1_.maxZ);
            }
            case EAST: {
                return new Box(p_190610_1_.maxX + d2, p_190610_1_.minY, p_190610_1_.minZ, p_190610_1_.maxX + d3, p_190610_1_.maxY, p_190610_1_.maxZ);
            }
            case DOWN: {
                return new Box(p_190610_1_.minX, p_190610_1_.minY + d2, p_190610_1_.minZ, p_190610_1_.maxX, p_190610_1_.minY + d3, p_190610_1_.maxZ);
            }
            default: {
                return new Box(p_190610_1_.minX, p_190610_1_.maxY + d2, p_190610_1_.minZ, p_190610_1_.maxX, p_190610_1_.maxY + d3, p_190610_1_.maxZ);
            }
            case NORTH: {
                return new Box(p_190610_1_.minX, p_190610_1_.minY, p_190610_1_.minZ + d2, p_190610_1_.maxX, p_190610_1_.maxY, p_190610_1_.minZ + d3);
            }
            case SOUTH: {
                return new Box(p_190610_1_.minX, p_190610_1_.minY, p_190610_1_.maxZ + d2, p_190610_1_.maxX, p_190610_1_.maxY, p_190610_1_.maxZ + d3);
            }
        }
    }
    
    private void func_190605_a(final Entity p_190605_1_, final EnumFacing p_190605_2_, final double p_190605_3_) {
        final Box axisalignedbb = p_190605_1_.getEntityBoundingBox();
        final Box axisalignedbb2 = Block.FULL_BLOCK_AABB.offset(this.pos);
    ...
    private static double func_190611_b(final Box p_190611_0_, final EnumFacing p_190611_1_, final Box p_190611_2_) {
    ...
    private static double func_190608_c(final Box p_190608_0_, final EnumFacing p_190608_1_, final Box p_190608_2_) {
    ...
    private static double func_190604_d(final Box p_190604_0_, final EnumFacing p_190604_1_, final Box p_190604_2_) {
    ...
    public void func_190609_a(final World p_190609_1_, final BlockPos p_190609_2_, final Box p_190609_3_, final List<Box> p_190609_4_, @Nullable final Entity p_190609_5_) {
        if (!this.extending && this.shouldHeadBeRendered) {
