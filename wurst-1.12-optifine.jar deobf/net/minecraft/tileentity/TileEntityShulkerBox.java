...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory
{
    ...
    public Box func_190584_a(final IBlockState p_190584_1_) {
        return this.func_190587_b(p_190584_1_.getValue(BlockShulkerBox.field_190957_a));
    }
    
    public Box func_190587_b(final EnumFacing p_190587_1_) {
    ...
    private Box func_190588_c(final EnumFacing p_190588_1_) {
    ...
    private void func_190589_G() {
        ...
        if (iblockstate.getBlock() instanceof BlockShulkerBox) {
            ...
            final Box axisalignedbb = this.func_190588_c(enumfacing).offset(this.pos);
    ...
    public enum AnimationStatus
    {
        ...
        private AnimationStatus(final String name, final int ordinal) {
        }
    }
}
