...
public abstract class MobSpawnerBaseLogic
{
    ...
    private WeightedSpawnerEntity randomEntity;
    ...
    private ResourceLocation func_190895_g() {
        final String s = this.randomEntity.getNbt().getString("id");
        return StringUtils.isNullOrEmpty(s) ? null : new ResourceLocation(s);
    }
    
    public void func_190894_a(@Nullable final ResourceLocation p_190894_1_) {
        if (p_190894_1_ != null) {
        ...
        if (!this.isActivated()) {
            ...
            if (this.getSpawnerWorld().isRemote) {
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    final NBTTagCompound nbttagcompound = this.randomEntity.getNbt();
                    ...
                    final int k = world.getEntitiesWithinAABB(entity.getClass(), new Box(blockpos.getX(), blockpos.getY(), blockpos.getZ(), blockpos.getX() + 1, blockpos.getY() + 1, blockpos.getZ() + 1).expandXyz(this.spawnRange)).size();
    ...
    public NBTTagCompound writeToNBT(final NBTTagCompound p_189530_1_) {
        final ResourceLocation resourcelocation = this.func_190895_g();
