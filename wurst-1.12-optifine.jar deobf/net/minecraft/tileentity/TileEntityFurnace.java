...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void setInventorySlotContents(final int index, final ItemStack stack) {
        ...
        final boolean flag = !stack.func_190926_b() && stack.isItemEqual(itemstack) && ItemStack.areItemStackTagsEqual(stack, itemstack);
    ...
    public void readFromNBT(final NBTTagCompound compound) {
        ...
        ItemStackHelper.func_191283_b(compound, this.furnaceItemStacks = NonNullList.func_191197_a(this.getSizeInventory(), ItemStack.field_190927_a));
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || (!itemstack.func_190926_b() && !this.furnaceItemStacks.get(0).func_190926_b())) {
                    ...
                    if (this.isBurning()) {
                        ...
                        if (!itemstack.func_190926_b()) {
                            ...
                            if (itemstack.func_190926_b()) {
                                ...
                                this.furnaceItemStacks.set(1, (item2 == null) ? ItemStack.field_190927_a : new ItemStack(item2));
                            }
                        }
                    }
                }
    ...
    private boolean canSmelt() {
        ...
        return itemstack2.func_190926_b() || (itemstack2.isItemEqual(itemstack) && ((itemstack2.func_190916_E() < this.getInventoryStackLimit() && itemstack2.func_190916_E() < itemstack2.getMaxStackSize()) || itemstack2.func_190916_E() < itemstack.getMaxStackSize()));
    }
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            if (itemstack.getItem() == Item.getItemFromBlock(Blocks.SPONGE) && itemstack.getMetadata() == 1 && !this.furnaceItemStacks.get(1).func_190926_b() && this.furnaceItemStacks.get(1).getItem() == Items.BUCKET) {
