...
public class TileEntityBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private boolean canBrew() {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            if (!itemstack2.func_190926_b() && PotionHelper.hasConversions(itemstack2, itemstack)) {
                return true;
            }
        }
        return false;
    ...
    public void readFromNBT(final NBTTagCompound compound) {
        ...
        ItemStackHelper.func_191283_b(compound, this.brewingItemStacks = NonNullList.func_191197_a(this.getSizeInventory(), ItemStack.field_190927_a));
    ...
    public boolean isItemValidForSlot(final int index, final ItemStack stack) {
        ...
        return (item == Items.POTIONITEM || item == Items.SPLASH_POTION || item == Items.LINGERING_POTION || item == Items.GLASS_BOTTLE) && this.getInvStack(index).func_190926_b();
    }
