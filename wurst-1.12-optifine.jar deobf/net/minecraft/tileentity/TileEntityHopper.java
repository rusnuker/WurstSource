...
public class TileEntityHopper extends TileEntityLockableLoot implements IHopper, ITickable
{
    ...
    private boolean transferItemsOut() {
        ...
        for (int i = 0; i < this.getSizeInventory(); ++i) {
            if (!this.getInvStack(i).func_190926_b()) {
                final ItemStack itemstack = this.getInvStack(i).copy();
    ...
    private boolean isInventoryFull(final IInventory inventoryIn, final EnumFacing side) {
        if (inventoryIn instanceof ISidedInventory) {
            ...
            for (int length = (array = aint).length, l = 0; l < length; ++l) {
                final int k = array[l];
                final ItemStack itemstack1 = isidedinventory.getInvStack(k);
            ...
            for (int i = inventoryIn.getSizeInventory(), j = 0; j < i; ++j) {
                final ItemStack itemstack2 = inventoryIn.getInvStack(j);
    ...
    private static boolean isInventoryEmpty(final IInventory inventoryIn, final EnumFacing side) {
        if (inventoryIn instanceof ISidedInventory) {
            ...
            for (int length = (array = aint).length, l = 0; l < length; ++l) {
                final int i = array[l];
                if (!isidedinventory.getInvStack(i).func_190926_b()) {
                    return false;
                }
            }
        }
            ...
            for (int j = inventoryIn.getSizeInventory(), k = 0; k < j; ++k) {
                if (!inventoryIn.getInvStack(k).func_190926_b()) {
                    return false;
                }
            }
        }
    ...
    private static boolean pullItemFromSlot(final IHopper hopper, final IInventory inventoryIn, final int index, final EnumFacing direction) {
        final ItemStack itemstack = inventoryIn.getInvStack(index);
    ...
    private static ItemStack insertStack(final IInventory inventoryIn, final IInventory stack, ItemStack index, final int side, final EnumFacing p_174916_4_) {
        final ItemStack itemstack = stack.getInvStack(side);
    ...
    public static List<EntityItem> getCaptureItems(final World worldIn, final double p_184292_1_, final double p_184292_3_, final double p_184292_5_) {
        return worldIn.getEntitiesWithinAABB((Class<? extends EntityItem>)EntityItem.class, new Box(p_184292_1_ - 0.5, p_184292_3_, p_184292_5_ - 0.5, p_184292_1_ + 0.5, p_184292_3_ + 1.5, p_184292_5_ + 0.5), (com.google.common.base.Predicate<? super EntityItem>)EntitySelectors.IS_ALIVE);
    }
    ...
    public static IInventory getInventoryAtPosition(final World worldIn, final double x, final double y, final double z) {
        ...
        if (iinventory == null) {
            final List<Entity> list = worldIn.getEntitiesInAABBexcluding(null, new Box(x - 0.5, y - 0.5, z - 0.5, x + 0.5, y + 0.5, z + 0.5), EntitySelectors.HAS_INVENTORY);
            if (!list.isEmpty()) {
