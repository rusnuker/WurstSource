...
public class TileEntityChest extends TileEntityLockableLoot implements ITickable
{
    ...
    public void update() {
        ...
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + i + j + k) % 200 == 0) {
            ...
            final float f = 5.0f;
            for (final EntityPlayer entityplayer : this.world.getEntitiesWithinAABB((Class<? extends EntityPlayer>)EntityPlayer.class, new Box(i - 5.0f, j - 5.0f, k - 5.0f, i + 1 + 5.0f, j + 1 + 5.0f, k + 1 + 5.0f))) {
