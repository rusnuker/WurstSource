...
public class NbtTagValue
{
    ...
    public NbtTagValue(final String p_i66_1_, String p_i66_2_) {
        this.parents = null;
        this.name = null;
        this.negative = false;
        this.type = 0;
        this.value = null;
        this.valueFormat = 0;
        final String[] astring = Config.tokenize(p_i66_1_, ".");
        ...
        if (this.type == 0 && NbtTagValue.PATTERN_HEX_COLOR.matcher(p_i66_2_).matches()) {
            this.valueFormat = 1;
        }
        this.value = p_i66_2_;
    }
    ...
    private boolean matches(final NBTBase p_matches_1_) {
        ...
        final String s = getNbtString(p_matches_1_, this.valueFormat);
        if (s == null) {
            return false;
        }
        switch (this.type) {
