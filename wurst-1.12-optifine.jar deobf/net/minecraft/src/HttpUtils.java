...
public class HttpUtils
{
    ...
    public static String post(final String p_post_0_, final Map<String, String> p_post_1_, final byte[] p_post_2_) throws IOException {
        HttpURLConnection httpurlconnection = null;
        String s4;
        try {
            ...
            if (p_post_1_ != null) {
                for (final String s : p_post_1_.keySet()) {
