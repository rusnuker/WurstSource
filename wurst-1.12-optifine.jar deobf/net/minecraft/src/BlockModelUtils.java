...
public class BlockModelUtils
{
    ...
    public static Box getOffsetBoundingBox(final Box p_getOffsetBoundingBox_0_, final Block.EnumOffsetType p_getOffsetBoundingBox_1_, final BlockPos p_getOffsetBoundingBox_2_) {
