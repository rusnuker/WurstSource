...
public enum BlockDir
{
    ...
    private BlockDir(final String name, final int ordinal, final EnumFacing p_i12_3_) {
        this.facing1 = p_i12_3_;
    }
    
    private BlockDir(final String name, final int ordinal, final EnumFacing p_i13_3_, final EnumFacing p_i13_4_) {
