...
public class CustomItemProperties
{
    ...
    public CustomItemProperties(final Properties p_i30_1_, final String p_i30_2_) {
        this.name = null;
        this.basePath = null;
        this.type = 1;
        this.items = null;
    ...
    private static Map parseTextures(final Properties p_parseTextures_0_, final String p_parseTextures_1_) {
        ...
        for (final Object s2 : set) {
            ...
            s4 = fixTextureName(s4, p_parseTextures_1_);
            map2.put(s3, s4);
        }
        return map2;
    }
    ...
    private static Map parseModels(final Properties p_parseModels_0_, final String p_parseModels_1_) {
        ...
        for (final Object s2 : set) {
            final String s3 = (String)s2;
            String s4 = map.get(s3);
            s4 = fixModelName(s4, p_parseModels_1_);
            map2.put(s3, s4);
        }
        return map2;
    }
    ...
    private NbtTagValue[] parseNbtTagValues(final Properties p_parseNbtTagValues_1_) {
        ...
        for (final Object s2 : map.keySet()) {
            ...
            final String s5 = s3.substring(s.length());
            final NbtTagValue nbttagvalue = new NbtTagValue(s5, s4);
    ...
    private static Map getMatchingProperties(final Properties p_getMatchingProperties_0_, final String p_getMatchingProperties_1_) {
        ...
        for (final Object s0 : p_getMatchingProperties_0_.keySet()) {
            final String s2 = (String)s0;
            final String s3 = p_getMatchingProperties_0_.getProperty(s2);
            if (s2.startsWith(p_getMatchingProperties_1_)) {
                map.put(s2, s3);
            }
        }
        return map;
