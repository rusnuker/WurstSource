...
public class StrUtils
{
    ...
    public static String fillLeft(String p_fillLeft_0_, final int p_fillLeft_1_, final char p_fillLeft_2_) {
        ...
        final int i = p_fillLeft_1_ - p_fillLeft_0_.length();
        while (stringbuffer.length() < i) {
            stringbuffer.append(p_fillLeft_2_);
        }
        return String.valueOf(stringbuffer.toString()) + p_fillLeft_0_;
    }
    ...
    public static String replacePrefix(String p_replacePrefix_0_, final String p_replacePrefix_1_, String p_replacePrefix_2_) {
        ...
        return String.valueOf(p_replacePrefix_2_) + p_replacePrefix_0_;
    }
    ...
    public static String addSuffixCheck(final String p_addSuffixCheck_0_, final String p_addSuffixCheck_1_) {
        if (p_addSuffixCheck_0_ != null && p_addSuffixCheck_1_ != null) {
            return p_addSuffixCheck_0_.endsWith(p_addSuffixCheck_1_) ? p_addSuffixCheck_0_ : (String.valueOf(p_addSuffixCheck_0_) + p_addSuffixCheck_1_);
        }
        return p_addSuffixCheck_0_;
    }
    
    public static String addPrefixCheck(final String p_addPrefixCheck_0_, final String p_addPrefixCheck_1_) {
        if (p_addPrefixCheck_0_ != null && p_addPrefixCheck_1_ != null) {
            return p_addPrefixCheck_0_.endsWith(p_addPrefixCheck_1_) ? p_addPrefixCheck_0_ : (String.valueOf(p_addPrefixCheck_1_) + p_addPrefixCheck_0_);
        }
