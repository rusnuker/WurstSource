...
public class CustomColormap implements CustomColors.IColorizer
{
    ...
    public CustomColormap(final Properties p_i29_1_, final String p_i29_2_, final int p_i29_3_, final int p_i29_4_, final String p_i29_5_) {
        this.name = null;
        this.basePath = null;
        this.format = -1;
    ...
    public int getColor(final IBlockAccess p_getColor_1_, final BlockPos p_getColor_2_) {
        final Biome biome = CustomColors.getColorBiome(p_getColor_1_, p_getColor_2_);
    ...
    public int getColor(final Biome p_getColor_1_, final BlockPos p_getColor_2_) {
        if (this.format == 0) {
    ...
    public int getColorSmooth(final IBlockAccess p_getColorSmooth_1_, final double p_getColorSmooth_2_, final double p_getColorSmooth_4_, final double p_getColorSmooth_6_, final int p_getColorSmooth_8_) {
        ...
        final int i = MathHelper.floor(p_getColorSmooth_2_);
        final int j = MathHelper.floor(p_getColorSmooth_4_);
        final int k = MathHelper.floor(p_getColorSmooth_6_);
        int l = 0;
        int i2 = 0;
        int j2 = 0;
        int k2 = 0;
    ...
    private int getColorVanilla(final Biome p_getColorVanilla_1_, final BlockPos p_getColorVanilla_2_) {
        final double d0 = MathHelper.clamp(p_getColorVanilla_1_.getFloatTemperature(p_getColorVanilla_2_), 0.0f, 1.0f);
        double d2 = MathHelper.clamp(p_getColorVanilla_1_.getRainfall(), 0.0f, 1.0f);
        d2 *= d0;
    ...
    private int getColorGrid(final Biome p_getColorGrid_1_, final BlockPos p_getColorGrid_2_) {
        final int i = Biome.getIdForBiome(p_getColorGrid_1_);
