...
public class ConnectedParser
{
    ...
    public static Comparable getPropertyValue(final String p_getPropertyValue_0_, final Collection<Comparable> p_getPropertyValue_1_) {
        for (final Comparable comparable : p_getPropertyValue_1_) {
    ...
    public Biome[] parseBiomes(String p_parseBiomes_1_) {
        ...
        if (flag) {
            final List<Biome> list2 = Lists.newArrayList((Iterator)Biome.REGISTRY.iterator());
