...
public class BlockPosM extends BlockPos
{
    ...
    public BlockPosM(final int p_i16_1_, final int p_i16_2_, final int p_i16_3_) {
        this(p_i16_1_, p_i16_2_, p_i16_3_, 0);
    }
    
    public BlockPosM(final double p_i17_1_, final double p_i17_3_, final double p_i17_5_) {
        this(MathHelper.floor(p_i17_1_), MathHelper.floor(p_i17_3_), MathHelper.floor(p_i17_5_));
    }
    
    public BlockPosM(final int p_i18_1_, final int p_i18_2_, final int p_i18_3_, final int p_i18_4_) {
        super(0, 0, 0);
        this.mx = p_i18_1_;
        this.my = p_i18_2_;
        this.mz = p_i18_3_;
