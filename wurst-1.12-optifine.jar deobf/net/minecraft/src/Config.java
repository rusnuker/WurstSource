...
public class Config
{
    ...
    public static int getMinecraftVersionInt() {
        if (Config.minecraftVersionInt < 0) {
            final String[] astring = tokenize("1.12", ".");
            int i = 0;
            if (astring.length > 0) {
    ...
    public static IResourcePack[] getResourcePacks() {
        ...
        final List<ResourcePackRepository.Entry> list = resourcepackrepository.getRepositoryEntries();
    ...
    public static DisplayMode getLargestDisplayMode() {
        ...
        if (Config.desktopDisplayMode.getWidth() > displaymode.getWidth()) {
            return Config.desktopDisplayMode;
        }
        return (Config.desktopDisplayMode.getWidth() == displaymode.getWidth() && Config.desktopDisplayMode.getHeight() > displaymode.getHeight()) ? Config.desktopDisplayMode : displaymode;
    }
    ...
    public static WorldServer getWorldServer() {
        final World world = Config.minecraft.world;
        if (world == null) {
            return null;
        }
        ...
        try {
            final WorldServer worldserver = integratedserver.worldServerForDimension(dimensiontype.getId());
            return worldserver;
        }
    ...
    public static void checkDisplaySettings() {
        ...
        if (i > 0) {
            ...
            try {
                ...
                try {
                ...
                catch (final LWJGLException lwjglexception3) {
                    ...
                    catch (final LWJGLException lwjglexception4) {
    ...
    public static void showGuiMessage(final String p_showGuiMessage_0_, final String p_showGuiMessage_1_) {
        ...
        Config.minecraft.openScreen(guimessage);
    }
