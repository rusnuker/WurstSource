...
public class ConnectedProperties
{
    ...
    private int[] parseCtmTileIndexes(final Properties p_parseCtmTileIndexes_1_) {
        ...
        for (final Object object : p_parseCtmTileIndexes_1_.keySet()) {
    ...
    public static IProperty getProperty(final String p_getProperty_0_, final Collection<IProperty> p_getProperty_1_) {
        for (final IProperty iproperty : p_getProperty_1_) {
