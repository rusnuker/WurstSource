...
public class RecipeBookServer extends RecipeBook
{
    ...
    public void func_192825_a(final NBTTagCompound p_192825_1_) {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i) {
            ...
            if (irecipe == null) {
                RecipeBookServer.field_192828_d.info("Tried to load unrecognized recipe: {} removed now.", (Object)resourcelocation);
            }
            else {
                this.func_194073_a(irecipe);
            }
        ...
        for (int j = 0; j < nbttaglist2.tagCount(); ++j) {
            ...
            if (irecipe2 == null) {
                RecipeBookServer.field_192828_d.info("Tried to load unrecognized recipe: {} removed now.", (Object)resourcelocation2);
            }
            else {
