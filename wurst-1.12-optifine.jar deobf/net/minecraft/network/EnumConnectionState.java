    ...
    PLAY(0) {
        {
            ...
            if (WurstClient.INSTANCE.options.mc112x_compatibility >= 2) {
                this.registerPacket(EnumPacketDirection.CLIENTBOUND, SPacketNewKeepAlive.class);
            }
            else {
            ...
            if (WurstClient.INSTANCE.options.mc112x_compatibility >= 1) {
                this.registerPacket(EnumPacketDirection.CLIENTBOUND, SPacketSomethingNew.class);
            }
            ...
            if (WurstClient.INSTANCE.options.mc112x_compatibility >= 2) {
                this.registerPacket(EnumPacketDirection.SERVERBOUND, CPacketNewKeepAlive.class);
            }
            else {
            ...
            if (WurstClient.INSTANCE.options.mc112x_compatibility >= 1) {
                this.registerPacket(EnumPacketDirection.SERVERBOUND, CPacketSomethingNew.class);
            }
