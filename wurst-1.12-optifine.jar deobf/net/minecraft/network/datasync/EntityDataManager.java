...
public class EntityDataManager
{
    ...
    public <T> void setDirty(final DataParameter<T> key) {
        DataEntry.access$0((DataEntry<Object>)this.getEntry(key), true);
        this.dirty = true;
    }
    ...
    public static class DataEntry<T>
    {
        ...
        static /* synthetic */ void access$0(final DataEntry dataEntry, final boolean dirty) {
            dataEntry.dirty = dirty;
        }
    }
}
