...
public class LegacyPingHandler extends ChannelInboundHandlerAdapter
{
    ...
    public LegacyPingHandler(final NetworkSystem networkSystemIn) {
    ...
    public void channelRead(final ChannelHandlerContext p_channelRead_1_, final Object p_channelRead_2_) throws Exception {
        ...
        try {
            if (bytebuf.readUnsignedByte() == 254) {
                ...
                switch (i) {
                    case 0: {
                        LegacyPingHandler.LOGGER.debug("Ping: (<1.3.x) from {}:{}", (Object)inetsocketaddress.getAddress(), (Object)inetsocketaddress.getPort());
                    ...
                    case 1: {
                        ...
                        LegacyPingHandler.LOGGER.debug("Ping: (1.4-1.5.x) from {}:{}", (Object)inetsocketaddress.getAddress(), (Object)inetsocketaddress.getPort());
                    ...
                    default: {
                        ...
                        flag2 &= "MC|PingHost".equals(new String(bytebuf.readBytes(bytebuf.readShort() * 2).array(), StandardCharsets.UTF_16BE));
                        ...
                        LegacyPingHandler.LOGGER.debug("Ping: (1.6) from {}:{}", (Object)inetsocketaddress.getAddress(), (Object)inetsocketaddress.getPort());
