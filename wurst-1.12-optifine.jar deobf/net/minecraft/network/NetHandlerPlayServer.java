...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
        ...
        if (isMoveVehiclePacketInvalid(packetIn)) {
            ...
            if (entity != this.playerEntity && entity.getControllingPassenger() == this.playerEntity && entity == this.lowestRiddenEnt) {
                ...
                if (d11 - d10 > 100.0 && (!this.serverController.isSinglePlayer() || !this.serverController.getServerOwner().equals(entity.getName()))) {
                    NetHandlerPlayServer.LOGGER.warn("{} (vehicle of {}) moved too quickly! {},{},{}", (Object)entity.getName(), (Object)this.playerEntity.getName(), (Object)d7, (Object)d8, (Object)d9);
                ...
                if (this.targetPos != null) {
                    ...
                    if (this.playerEntity.isRiding()) {
                        ...
                        if (this.playerEntity.isPlayerSleeping()) {
                            ...
                            if (i > 5) {
                                NetHandlerPlayServer.LOGGER.debug("{} is sending move packets too frequently ({} packets since last tick)", (Object)this.playerEntity.getName(), (Object)i);
                                i = 1;
                            }
                            if (!this.playerEntity.isInvulnerableDimensionChange() && (!this.playerEntity.getServerWorld().getGameRules().getBoolean("disableElytraMovementCheck") || !this.playerEntity.isElytraFlying())) {
                                ...
                                if (d12 - d11 > f3 * i && (!this.serverController.isSinglePlayer() || !this.serverController.getServerOwner().equals(this.playerEntity.getName()))) {
                                    NetHandlerPlayServer.LOGGER.warn("{} moved too quickly! {},{},{}", (Object)this.playerEntity.getName(), (Object)d8, (Object)d9, (Object)d10);
                            ...
                            this.floating &= (!this.serverController.isFlightAllowed() && !this.playerEntity.abilities.allowFlying);
    ...
    public void onDisconnect(final ITextComponent reason) {
        NetHandlerPlayServer.LOGGER.info("{} lost connection: {}", (Object)this.playerEntity.getName(), (Object)reason.getUnformattedText());
    ...
    public void processHeldItemChange(final CPacketHeldItemChange packetIn) {
        ...
        if (packetIn.getSlotId() >= 0 && packetIn.getSlotId() < InventoryPlayer.getHotbarSize()) {
            this.playerEntity.inventory.selectedSlot = packetIn.getSlotId();
            this.playerEntity.markPlayerActive();
        }
        else {
    ...
    @Override
    public void func_191985_a(final CPacketRecipePlacement p_191985_1_) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet<NetHandlerPlayServer>)p_191985_1_, this, this.playerEntity.getServerWorld());
        this.playerEntity.markPlayerActive();
        if (this.playerEntity.openContainer.windowId == p_191985_1_.func_192613_a() && this.playerEntity.openContainer.getCanCraft(this.playerEntity)) {
            ...
            if (!p_191985_1_.func_192610_d().isEmpty()) {
                for (final CPacketRecipePlacement.ItemMove cpacketrecipeplacement$itemmove : p_191985_1_.func_192610_d()) {
                    final ItemStack itemstack = this.playerEntity.openContainer.getSlot(cpacketrecipeplacement$itemmove.field_192674_b).getStack();
                    if (this.func_193074_a(cpacketrecipeplacement$itemmove.field_192673_a, itemstack)) {
                        final int i = cpacketrecipeplacement$itemmove.field_192673_a.func_190916_E();
                        if (cpacketrecipeplacement$itemmove.field_192675_c == -1) {
                            ...
                            final ItemStack itemstack2 = this.playerEntity.inventory.getInvStack(cpacketrecipeplacement$itemmove.field_192675_c);
            ...
            if (!p_191985_1_.func_192615_c().isEmpty()) {
                for (final CPacketRecipePlacement.ItemMove cpacketrecipeplacement$itemmove2 : p_191985_1_.func_192615_c()) {
                    final ItemStack itemstack3 = this.playerEntity.inventory.getInvStack(cpacketrecipeplacement$itemmove2.field_192675_c);
                    if (this.func_193074_a(cpacketrecipeplacement$itemmove2.field_192673_a, itemstack3)) {
                        final int j = cpacketrecipeplacement$itemmove2.field_192673_a.func_190916_E();
                        if (itemstack3.func_190916_E() == j) {
                            this.playerEntity.inventory.removeStackFromSlot(cpacketrecipeplacement$itemmove2.field_192675_c);
                        }
                        else {
                            itemstack3.func_190918_g(j);
                        }
                        this.playerEntity.openContainer.func_192388_b(cpacketrecipeplacement$itemmove2.field_192674_b, cpacketrecipeplacement$itemmove2.field_192673_a);
                    }
                }
            }
            this.playerEntity.openContainer.detectAndSendChanges();
    ...
    private boolean func_193074_a(final ItemStack p_193074_1_, final ItemStack p_193074_2_) {
        final ItemStack itemstack = p_193074_2_.copy();
    ...
    public void processPlayerAbilities(final CPacketPlayerAbilities packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet<NetHandlerPlayServer>)packetIn, this, this.playerEntity.getServerWorld());
        this.playerEntity.abilities.isFlying = (packetIn.isFlying() && this.playerEntity.abilities.allowFlying);
    }
    ...
    public void processCustomPayload(final CPacketCustomPayload packetIn) {
        ...
        if ("MC|BEdit".equals(s)) {
            ...
            try {
                ...
                this.playerEntity.connection.sendPacket(new SPacketSetSlot(-2, this.playerEntity.inventory.selectedSlot, this.playerEntity.inventory.getInvStack(this.playerEntity.inventory.selectedSlot)));
                this.playerEntity.connection.sendPacket(new SPacketSetSlot(-2, j3, this.playerEntity.inventory.getInvStack(j3)));
                this.playerEntity.connection.sendPacket(new SPacketHeldItemChange(this.playerEntity.inventory.selectedSlot));
            }
