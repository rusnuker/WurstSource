...
public class ParticleCloud extends Particle
{
    ...
    public void onUpdate() {
        ...
        final EntityPlayer entityplayer = this.worldObj.getClosestPlayer(this.posX, this.posY, this.posZ, 2.0, false);
        if (entityplayer != null) {
            final Box axisalignedbb = entityplayer.getEntityBoundingBox();
