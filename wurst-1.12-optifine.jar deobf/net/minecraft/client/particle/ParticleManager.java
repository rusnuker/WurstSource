...
public class ParticleManager
{
    ...
    public ParticleManager(final World worldIn, final TextureManager rendererIn) {
        this.fxLayers = new ArrayDeque[4][];
        this.particleEmitters = Queues.newArrayDeque();
        this.rand = new Random();
        this.particleTypes = Maps.newHashMap();
        this.queueEntityFX = Queues.newArrayDeque();
    ...
    public void func_191271_a(final Entity p_191271_1_, final EnumParticleTypes p_191271_2_, final int p_191271_3_) {
    ...
    public void updateEffects() {
        ...
        if (!this.queueEntityFX.isEmpty()) {
            for (Particle particle = this.queueEntityFX.poll(); particle != null; particle = this.queueEntityFX.poll()) {
                ...
                final int k = particle.isTransparent() ? 0 : 1;
    ...
    private void updateEffectLayer(final int layer) {
        this.worldObj.theProfiler.startSection(new StringBuilder(String.valueOf(layer)).toString());
        for (int i = 0; i < 2; ++i) {
            this.worldObj.theProfiler.startSection(new StringBuilder(String.valueOf(i)).toString());
    ...
    public void addBlockHitEffects(final BlockPos pos, final EnumFacing side) {
        ...
        if (iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE) {
            ...
            final float f = 0.1f;
            final Box axisalignedbb = iblockstate.getBoundingBox(this.worldObj, pos);
