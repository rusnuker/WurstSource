...
public class SearchTree<T> implements ISearchTree<T>
{
    ...
    public SearchTree(final Function<T, Iterable<String>> p_i47612_1_, final Function<T, Iterable<ResourceLocation>> p_i47612_2_) {
        ...
        this.field_194048_e = Lists.newArrayList();
    ...
    public void func_194043_a(final T p_194043_1_) {
        this.field_194049_f.put((Object)p_194043_1_, this.field_194048_e.size());
    ...
    public List<T> func_194038_a(final String p_194038_1_) {
        ...
        return list2.isEmpty() ? list : Lists.newArrayList((Iterator)new MergingIterator((Iterator<Object>)list.iterator(), (Iterator<Object>)list2.iterator(), (it.unimi.dsi.fastutil.objects.Object2IntMap<Object>)this.field_194049_f));
    }
    ...
    static class MergingIterator<T> extends AbstractIterator<T>
    {
        ...
        protected T computeNext() {
            ...
            if (this.field_194036_d == this.field_194037_e) {
                ...
                i = Integer.compare(this.field_194035_c.getInt((Object)this.field_194036_d), this.field_194035_c.getInt((Object)this.field_194037_e));
            }
