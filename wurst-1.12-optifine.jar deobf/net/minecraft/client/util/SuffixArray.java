...
public class SuffixArray<T>
{
    ...
    public SuffixArray() {
        this.field_194061_a = Lists.newArrayList();
    ...
    public void func_194058_a() {
        ...
        this.field_194067_g = (IntList)new IntArrayList(intlist1.size());
        this.field_194068_h = (IntList)new IntArrayList(intlist2.size());
    ...
    private void func_194060_b() {
        for (int i2 = 0; i2 < this.field_194067_g.size(); ++i2) {
            SuffixArray.field_194064_d.debug("{} {}", (Object)i2, (Object)this.func_194059_a(i2));
        }
    ...
    private String func_194059_a(final int p_194059_1_) {
        ...
        for (int k2 = 0; j2 + k2 < this.field_194065_e.size(); ++k2) {
            ...
            final int l2 = (int)this.field_194065_e.get(j2 + k2);
            if (l2 == -1) {
                break;
            }
    ...
    public List<T> func_194055_a(final String p_194055_1_) {
        ...
        while (j2 < k2) {
            ...
            if (SuffixArray.field_194062_b) {
                SuffixArray.field_194064_d.debug("comparing lower \"{}\" with {} \"{}\": {}", (Object)p_194055_1_, (Object)l2, (Object)this.func_194059_a(l2), (Object)i3);
            }
            if (i3 > 0) {
                j2 = l2 + 1;
            }
        ...
        if (j2 >= 0 && j2 < i2) {
            ...
            while (j2 < k2) {
                ...
                if (SuffixArray.field_194062_b) {
                    SuffixArray.field_194064_d.debug("comparing upper \"{}\" with {} \"{}\": {}", (Object)p_194055_1_, (Object)j3, (Object)this.func_194059_a(j3), (Object)j4);
                }
                if (j4 >= 0) {
                    j2 = j3 + 1;
                }
