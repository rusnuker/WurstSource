...
public class GuiConnecting extends GuiScreen
{
        ...
        new Thread("Server Connector #" + GuiConnecting.CONNECTION_ID.incrementAndGet()) {
            ...
            public void run() {
                ...
                try {
                    ...
                    GuiConnecting.this.networkManager.sendPacket(new C00Handshake(ServerHook.getProtocolVersion(), ip, port, EnumConnectionState.LOGIN));
                    ...
                    GuiConnecting.this.mc.openScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new TextComponentTranslation("disconnect.genericReason", new Object[] { "Unknown host" })));
                }
                    ...
                    GuiConnecting.this.mc.openScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new TextComponentTranslation("disconnect.genericReason", new Object[] { s })));
                }
            }
        }.start();
    }
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.id == 0) {
            ...
            this.mc.openScreen(this.previousGuiScreen);
        }
    }
