...
public class PlayerControllerMP
{
    ...
    public void setOverrideReach(final boolean overrideReach) {
    ...
    public void setGameType(final GameType type) {
        (this.currentGameType = type).configurePlayerCapabilities(this.mc.player.abilities);
    }
    ...
    public boolean clickBlock(final BlockPos loc, final EnumFacing face) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            this.blockHitDelay = (WurstClient.INSTANCE.hax.fastBreakMod.isActive() ? 0 : 5);
        }
    ...
    public boolean onPlayerDamageBlock(final BlockPos posBlock, final EnumFacing directionFacing) {
        EventFactory.onPlayerDamageBlock(posBlock, directionFacing);
        ...
        else if (WurstClient.INSTANCE.hax.fastBreakMod.shouldSpamPackets()) {
            this.connection.sendPacket(new CPacketPlayerDigging(CPacketPlayerDigging.Action.STOP_DESTROY_BLOCK, posBlock, directionFacing));
        }
        this.mc.world.sendBlockBreakProgress(this.mc.player.getEntityId(), this.currentBlock, (int)(this.curBlockDamageMP * 10.0f) - 1);
        return true;
    ...
    private void syncCurrentPlayItem() {
        final int i = this.mc.player.inventory.selectedSlot;
    ...
    public EnumActionResult processRightClickBlock(final EntityPlayerSP player, final WorldClient worldIn, final BlockPos stack, final EnumFacing pos, final Vec3d facing, final EnumHand vec) {
        WurstClient.INSTANCE.hax.chestEspMod.openChest(stack);
        this.syncCurrentPlayItem();
    ...
    public void func_192831_a(final int p_192831_1_, final List<CPacketRecipePlacement.ItemMove> p_192831_2_, final List<CPacketRecipePlacement.ItemMove> p_192831_3_, final EntityPlayer p_192831_4_) {
        final short short1 = p_192831_4_.openContainer.getNextTransactionID(p_192831_4_.inventory);
    ...
    public boolean extendedReach() {
        return this.overrideReach || this.currentGameType.isCreative();
    }
