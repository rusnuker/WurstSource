...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void onDisconnect(final ITextComponent reason) {
        if (this.previousGuiScreen != null && this.previousGuiScreen instanceof GuiScreenRealmsProxy) {
            this.mc.openScreen(new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.previousGuiScreen).getProxy(), "connect.failed", reason).getProxy());
        }
        else {
            this.mc.openScreen(new GuiDisconnected(this.previousGuiScreen, "connect.failed", reason));
        }
    }
