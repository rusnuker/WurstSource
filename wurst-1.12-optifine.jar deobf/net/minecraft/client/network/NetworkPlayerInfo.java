...
public class NetworkPlayerInfo
{
    ...
    public NetworkPlayerInfo(final GameProfile profile) {
        this.playerTextures = Maps.newEnumMap((Class)MinecraftProfileTexture.Type.class);
    ...
    public String getPlayerNameForReal() {
        return (this.getDisplayName() != null) ? this.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(this.getPlayerTeam(), this.getGameProfile().getName());
    }
                    ...
                    public void skinAvailable(final MinecraftProfileTexture.Type typeIn, final ResourceLocation location, final MinecraftProfileTexture profileTexture) {
                        switch (typeIn) {
                            case SKIN: {
                                ...
                                NetworkPlayerInfo.access$0(NetworkPlayerInfo.this, profileTexture.getMetadata("model"));
    ...
    static /* synthetic */ void access$0(final NetworkPlayerInfo networkPlayerInfo, final String skinType) {
