...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public TextureMap(final String p_i6_1_, final ITextureMapPopulator p_i6_2_, final boolean p_i6_3_) {
        this.iconGrid = null;
        this.iconGridSize = -1;
    ...
    public void loadTextureAtlas(final IResourceManager resourceManager) {
        ...
        for (int m = 0; m < list.size(); ++m) {
            ...
            if (k2 >= 1 && i2 >= 1) {
                ...
                if (j3 < l) {
                    TextureMap.LOGGER.warn("Texture {} with size {}x{} limits mip level from {} to {}", (Object)resourcelocation, (Object)textureatlassprite2.getIconWidth(), (Object)textureatlassprite2.getIconHeight(), (Object)MathHelper.log2(l), (Object)MathHelper.log2(j3));
                    l = j3;
                }
        ...
        if (i4 < this.mipmapLevels) {
            TextureMap.LOGGER.warn("{}: dropping miplevel from {} to {}, because of minimum power of two: {}", (Object)this.basePath, (Object)this.mipmapLevels, (Object)i4, (Object)l2);
        ...
        final Map<String, TextureAtlasSprite> map = Maps.newHashMap((Map)this.mapRegisteredSprites);
        for (final TextureAtlasSprite textureatlassprite3 : stitcher.getStichSlots()) {
            ...
            if (textureatlassprite3 == this.missingImage || this.generateMipmaps(resourceManager, textureatlassprite3)) {
    ...
    private int detectMinimumSpriteSize(final Map<?, ?> p_detectMinimumSpriteSize_1_, final IResourceManager p_detectMinimumSpriteSize_2_, final int p_detectMinimumSpriteSize_3_) {
        ...
        for (final Map.Entry entry : p_detectMinimumSpriteSize_1_.entrySet()) {
            final TextureAtlasSprite textureatlassprite6 = entry.getValue();
