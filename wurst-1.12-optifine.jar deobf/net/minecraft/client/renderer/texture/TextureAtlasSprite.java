...
public class TextureAtlasSprite
{
    ...
    private TextureAtlasSprite(final TextureAtlasSprite p_i4_1_) {
    ...
    public float getUnInterpolatedU(final float p_188537_1_) {
        final float f = this.maxU - this.minU;
    ...
    public void loadSpriteFrames(final IResource resource, final int mipmaplevels) throws IOException {
        ...
        if (animationmetadatasection == null) {
            ...
            if (animationmetadatasection.getFrameCount() > 0) {
                ...
                final List<AnimationFrame> list = Lists.newArrayList();
                for (int l = 0; l < i; ++l) {
