...
public class GlStateManager
{
    ...
    public enum CullFace
    {
        ...
        private CullFace(final String name, final int ordinal, final int modeIn) {
            this.mode = modeIn;
        }
    }
    ...
    public enum DestFactor
    {
        ...
        private DestFactor(final String name, final int ordinal, final int factorIn) {
    ...
    public enum FogMode
    {
        ...
        private FogMode(final String name, final int ordinal, final int capabilityIn) {
    ...
    public enum LogicOp
    {
        ...
        private LogicOp(final String name, final int ordinal, final int opcodeIn) {
    ...
    public enum Profile
    {
        ...
        private Profile(final String name, final int ordinal) {
        }
    ...
    public enum SourceFactor
    {
        ...
        private SourceFactor(final String name, final int ordinal, final int factorIn) {
            this.factor = factorIn;
        }
    }
