...
public class BlockFluidRenderer
{
    ...
    public boolean renderFluid(final IBlockAccess blockAccess, final IBlockState blockStateIn, final BlockPos blockPosIn, final BufferBuilder worldRendererIn) {
        boolean flag4;
        try {
            if (Config.isShaders()) {
            ...
            final RenderEnv renderenv = worldRendererIn.getRenderEnv(blockAccess, blockStateIn, blockPosIn);
            ...
            if (flag2 || flag3 || aboolean[0] || aboolean[1] || aboolean[2] || aboolean[3]) {
                ...
                if (flag3) {
                    ...
                    worldRendererIn.pos(d0, d2, d3 + 1.0).color(f * 0.5f, f2 * 0.5f, f3 * 0.5f, 1.0f).tex(f28, f31).lightmap(i3, j2).endVertex();
                    worldRendererIn.pos(d0, d2, d3).color(f * 0.5f, f2 * 0.5f, f3 * 0.5f, 1.0f).tex(f28, f30).lightmap(i3, j2).endVertex();
                    worldRendererIn.pos(d0 + 1.0, d2, d3).color(f * 0.5f, f2 * 0.5f, f3 * 0.5f, 1.0f).tex(f29, f30).lightmap(i3, j2).endVertex();
                    worldRendererIn.pos(d0 + 1.0, d2, d3 + 1.0).color(f * 0.5f, f2 * 0.5f, f3 * 0.5f, 1.0f).tex(f29, f31).lightmap(i3, j2).endVertex();
                    flag4 = true;
                }
                for (int i4 = 0; i4 < 4; ++i4) {
                    ...
                    if (aboolean[i4]) {
                        ...
                        if (f34 > f32 || f35 > f33) {
                            ...
                            flag4 = true;
                            final float f36 = textureatlassprite2.getInterpolatedU(0.0);
                            final float f37 = textureatlassprite2.getInterpolatedU(8.0);
                            ...
                            final float f40 = textureatlassprite2.getInterpolatedV(8.0);
                            final float f41 = textureatlassprite2.getInterpolatedV((1.0f - f32) * 16.0f * 0.5f);
                            ...
                            final float f43 = (i4 < 2) ? 0.8f : 0.6f;
                            final float f44 = 1.0f * f43 * f;
                            final float f45 = 1.0f * f43 * f2;
                            final float f46 = 1.0f * f43 * f3;
                            worldRendererIn.pos(d4, d2 + f34, d6).color(f44, f45, f46, 1.0f).tex(f36, f38).lightmap(k4, l4).endVertex();
                            worldRendererIn.pos(d5, d2 + f35, d7).color(f44, f45, f46, 1.0f).tex(f37, f39).lightmap(k4, l4).endVertex();
                            worldRendererIn.pos(d5, d2 + f33, d7).color(f44, f45, f46, 1.0f).tex(f37, f42).lightmap(k4, l4).endVertex();
                            worldRendererIn.pos(d4, d2 + f32, d6).color(f44, f45, f46, 1.0f).tex(f36, f41).lightmap(k4, l4).endVertex();
