...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void func_191961_a(final IBakedModel p_191961_1_, final ItemStack p_191961_2_) {
        this.func_191967_a(p_191961_1_, -1, p_191961_2_);
    }
    
    public void func_191965_a(final IBakedModel p_191965_1_, final int p_191965_2_) {
        this.func_191967_a(p_191965_1_, p_191965_2_, ItemStack.field_190927_a);
    }
    
    private void func_191967_a(final IBakedModel p_191967_1_, final int p_191967_2_, final ItemStack p_191967_3_) {
    ...
    private void func_191966_a(final IBakedModel p_191966_1_) {
    ...
    private void func_191969_a(final BufferBuilder p_191969_1_, final BakedQuad p_191969_2_, final int p_191969_3_) {
    ...
    private void func_191970_a(final BufferBuilder p_191970_1_, final List<BakedQuad> p_191970_2_, final int p_191970_3_, final ItemStack p_191970_4_) {
        final boolean flag = p_191970_3_ == -1 && !p_191970_4_.func_190926_b();
        for (int i = 0, j = p_191970_2_.size(); i < j; ++i) {
            final BakedQuad bakedquad = p_191970_2_.get(i);
            int k = p_191970_3_;
    ...
    protected void func_191962_a(final ItemStack p_191962_1_, final int p_191962_2_, final int p_191962_3_, IBakedModel p_191962_4_) {
    ...
    public void renderItemOverlayIntoGUI(final FontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, @Nullable final String text) {
        if (!stack.func_190926_b()) {
            if (stack.func_190916_E() != 1 || text != null) {
                final String s = (text == null) ? String.valueOf(stack.func_190916_E()) : text;
                GlStateManager.disableLighting();
    ...
    private void registerItems() {
        ...
        for (int length = (values = EnumDyeColor.values()).length, i = 0; i < length; ++i) {
            ...
            this.registerBlock(Blocks.field_192443_dR, enumdyecolor.getMetadata(), String.valueOf(enumdyecolor.func_192396_c()) + "_concrete");
            this.registerBlock(Blocks.field_192444_dS, enumdyecolor.getMetadata(), String.valueOf(enumdyecolor.func_192396_c()) + "_concrete_powder");
        }
