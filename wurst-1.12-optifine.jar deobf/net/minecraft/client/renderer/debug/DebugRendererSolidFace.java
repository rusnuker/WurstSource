...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer
{
    ...
    public DebugRendererSolidFace(final Minecraft p_i47478_1_) {
        this.field_193851_a = p_i47478_1_;
    }
    
    @Override
    public void render(final float p_190060_1_, final long p_190060_2_) {
        final EntityPlayer entityplayer = this.field_193851_a.player;
        ...
        final World world = this.field_193851_a.player.world;
        final Iterable<BlockPos> iterable = BlockPos.func_191532_a(MathHelper.floor(entityplayer.posX - 6.0), MathHelper.floor(entityplayer.posY - 6.0), MathHelper.floor(entityplayer.posZ - 6.0), MathHelper.floor(entityplayer.posX + 6.0), MathHelper.floor(entityplayer.posY + 6.0), MathHelper.floor(entityplayer.posZ + 6.0));
        ...
        for (final BlockPos blockpos : iterable) {
            ...
            if (iblockstate.getBlock() != Blocks.AIR) {
                final Box axisalignedbb = iblockstate.getSelectedBoundingBox(world, blockpos).expandXyz(0.002).offset(-d0, -d2, -d3);
