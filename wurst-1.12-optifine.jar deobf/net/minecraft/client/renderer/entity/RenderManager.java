...
public class RenderManager
{
    ...
    public <T extends Entity> Render<T> getEntityClassRenderObject(final Class entityClass) {
        Render<T> render = this.entityRenderMap.get(entityClass);
        if (render == null && entityClass != Entity.class) {
            render = (Render<T>)this.getEntityClassRenderObject(entityClass.getSuperclass());
    ...
    public boolean isRenderMultipass(final Entity p_188390_1_) {
    ...
    public void renderEntityStatic(final Entity entityIn, final float partialTicks, final boolean p_188388_3_) {
        ...
        this.doRenderEntity(entityIn, d0 - this.renderPosX, d2 - this.renderPosY, d3 - this.renderPosZ, f, partialTicks, p_188388_3_);
    }
    
    public void doRenderEntity(final Entity entityIn, final double x, final double y, final double z, final float yaw, final float partialTicks, final boolean p_188391_10_) {
        ...
        catch (final Throwable throwable5) {
    ...
    public void renderMultipass(final Entity p_188389_1_, final float p_188389_2_) {
        ...
        final double d0 = p_188389_1_.lastTickPosX + (p_188389_1_.posX - p_188389_1_.lastTickPosX) * p_188389_2_;
        final double d2 = p_188389_1_.lastTickPosY + (p_188389_1_.posY - p_188389_1_.lastTickPosY) * p_188389_2_;
        final double d3 = p_188389_1_.lastTickPosZ + (p_188389_1_.posZ - p_188389_1_.lastTickPosZ) * p_188389_2_;
        final float f = p_188389_1_.prevRotationYaw + (p_188389_1_.rotationYaw - p_188389_1_.prevRotationYaw) * p_188389_2_;
        ...
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)j, (float)k);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        final Render<Entity> render = this.getEntityRenderObject(p_188389_1_);
        if (render != null && this.renderEngine != null) {
            render.renderMultipass(p_188389_1_, d0 - this.renderPosX, d2 - this.renderPosY, d3 - this.renderPosZ, f, p_188389_2_);
        }
    }
    ...
    private void renderDebugBoundingBox(final Entity entityIn, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        final Box axisalignedbb = entityIn.getEntityBoundingBox();
        ...
        if (aentity != null) {
            ...
            for (int length = (array = aentity).length, i = 0; i < length; ++i) {
                ...
                final Box axisalignedbb2 = entity.getEntityBoundingBox();
        ...
        bufferbuilder.pos(x + vec3d.xCoord * 2.0, y + entityIn.getEyeHeight() + vec3d.yCoord * 2.0, z + vec3d.zCoord * 2.0).color(0, 0, 255, 255).endVertex();
        tessellator.draw();
    ...
    public void set(@Nullable final World worldIn) {
        this.worldObj = worldIn;
        if (worldIn == null) {
