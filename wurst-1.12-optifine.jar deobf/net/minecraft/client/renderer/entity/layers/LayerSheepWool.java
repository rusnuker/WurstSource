...
public class LayerSheepWool implements LayerRenderer<EntitySheep>
{
    ...
    @Override
    public void doRenderLayer(final EntitySheep entitylivingbaseIn, final float limbSwing, final float limbSwingAmount, final float partialTicks, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scale) {
