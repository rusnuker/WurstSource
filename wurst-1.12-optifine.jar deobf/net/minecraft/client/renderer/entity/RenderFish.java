...
public class RenderFish extends Render<EntityFishHook>
{
    ...
    public void doRender(final EntityFishHook entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        final EntityPlayer entityplayer = entity.func_190619_l();
        if (entityplayer != null && !this.renderOutlines) {
            ...
            if ((this.renderManager.options == null || this.renderManager.options.thirdPersonView <= 0) && entityplayer == Minecraft.getMinecraft().player) {
                ...
                d5 = entityplayer.prevPosX + (entityplayer.posX - entityplayer.prevPosX) * partialTicks + vec3d.xCoord;
                d6 = entityplayer.prevPosY + (entityplayer.posY - entityplayer.prevPosY) * partialTicks + vec3d.yCoord;
                d7 = entityplayer.prevPosZ + (entityplayer.posZ - entityplayer.prevPosZ) * partialTicks + vec3d.zCoord;
