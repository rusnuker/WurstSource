...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    private ModelRotation(final String name, final int ordinal, final int x, final int y) {
    ...
    public javax.vecmath.Matrix4f getMatrix() {
        return (javax.vecmath.Matrix4f)(Reflector.ForgeHooksClient_getMatrix.exists() ? Reflector.call(Reflector.ForgeHooksClient_getMatrix, this) : new javax.vecmath.Matrix4f(this.getMatrix4d()));
    }
