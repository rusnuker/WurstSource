...
public class StateMap extends StateMapperBase
{
    ...
    protected ModelResourceLocation getModelResourceLocation(final IBlockState state) {
        final Map<IProperty<?>, Comparable<?>> map = Maps.newLinkedHashMap((Map)state.getProperties());
        String s;
        if (this.name == null) {
    ...
    private <T extends Comparable<T>> String removeName(final IProperty<T> p_187490_1_, final Map<IProperty<?>, Comparable<?>> p_187490_2_) {
