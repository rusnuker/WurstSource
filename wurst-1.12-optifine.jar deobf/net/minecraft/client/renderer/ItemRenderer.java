...
public class ItemRenderer
{
    ...
    private void renderMapFirstPerson(final ItemStack stack) {
        ...
        tessellator.draw();
        final MapData mapdata = Items.FILLED_MAP.getMapData(stack, this.mc.world);
        if (mapdata != null) {
    ...
    public void updateEquippedItem() {
        ...
        if (entityplayersp.isRowingBoat()) {
            ...
            if (Reflector.ForgeHooksClient_shouldCauseReequipAnimation.exists()) {
                final boolean flag = Reflector.callBoolean(Reflector.ForgeHooksClient_shouldCauseReequipAnimation, this.itemStackMainHand, itemstack, entityplayersp.inventory.selectedSlot);
