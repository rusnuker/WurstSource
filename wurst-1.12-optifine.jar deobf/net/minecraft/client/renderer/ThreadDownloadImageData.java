...
public class ThreadDownloadImageData extends SimpleTexture
{
    ...
    private static final AtomicInteger TEXTURE_DOWNLOADER_THREAD_ID;
    @Nullable
    ...
    public ThreadDownloadImageData(@Nullable final File cacheFileIn, final String imageUrlIn, final ResourceLocation textureResourceLocation, @Nullable final IImageBuffer imageBufferIn) {
        ...
        if (this.imageThread == null) {
            if (this.cacheFile != null && this.cacheFile.isFile()) {
                ...
                try {
                    ...
                    ThreadDownloadImageData.LOGGER.error("Couldn't load skin {}", (Object)this.cacheFile, (Object)ioexception);
