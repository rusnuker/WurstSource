...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
            ...
            if (clickevent.getAction() == ClickEvent.Action.OPEN_URL) {
                ...
                try {
                    ...
                    if (this.mc.gameSettings.chatLinksPrompt) {
                        ...
                        this.mc.openScreen(new GuiConfirmOpenLink(this, clickevent.getValue(), 31102009, false));
                    }
                    else {
                ...
                final URI uri2 = new File(clickevent.getValue().replace("\\.\\", "\\")).toURI();
    ...
    public void sendChatMessage(final String msg, final boolean addToChat) {
        ...
        if (!addToChat) {
            this.mc.player.connection.sendPacket(new CPacketChatMessage(msg));
            return;
        }
    ...
    private void openWebLink(final URI url) {
        try {
            ...
            GuiScreen.LOGGER.error("Couldn't open link: {}", (Object)((throwable2 == null) ? "<UNKNOWN>" : throwable2.getMessage()));
        }
    }
