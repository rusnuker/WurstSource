...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public ServerListEntryNormal(final GuiMultiplayer p_i45048_1_, final ServerData serverIn) {
    ...
    public void func_192634_a(final int p_192634_1_, final int p_192634_2_, final int p_192634_3_, final int p_192634_4_, final int p_192634_5_, final int p_192634_6_, final int p_192634_7_, final boolean p_192634_8_, final float p_192634_9_) {
        ...
        final boolean flag = this.server.version > 335;
        final boolean flag2 = this.server.version < 335;
        boolean flag3 = false;
        switch (WurstClient.INSTANCE.options.mc112x_compatibility) {
            case 2: {
                flag3 = (this.server.version != 340);
                break;
            }
            case 1: {
                flag3 = (this.server.version != 338);
                break;
            }
            default: {
                flag3 = !WMinecraft.PROTOCOLS.containsKey(this.server.version);
                break;
            }
        }
        ...
        final String s2 = flag3 ? (TextFormatting.DARK_RED + this.server.gameVersion) : (TextFormatting.GREEN + this.server.gameVersion + TextFormatting.RESET + " " + this.server.populationInfo);
