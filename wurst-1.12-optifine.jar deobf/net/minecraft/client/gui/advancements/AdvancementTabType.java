...
enum AdvancementTabType
{
    ...
    static {
        ...
        for (int length = (values = values()).length, j = 0; j < length; ++j) {
            final AdvancementTabType advancementtabtype = values[j];
            i += advancementtabtype.field_192664_j;
        }
        field_192659_e = i;
    }
    
    private AdvancementTabType(final String name, final int ordinal, final int p_i47386_3_, final int p_i47386_4_, final int p_i47386_5_, final int p_i47386_6_, final int p_i47386_7_) {
