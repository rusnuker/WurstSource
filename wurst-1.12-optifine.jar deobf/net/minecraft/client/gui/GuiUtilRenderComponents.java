...
public class GuiUtilRenderComponents
{
    ...
    public static List<ITextComponent> splitText(final ITextComponent textComponent, final int maxTextLenght, final FontRenderer fontRendererIn, final boolean p_178908_3_, final boolean forceTextColor) {
        ...
        final List<ITextComponent> list = Lists.newArrayList();
        final List<ITextComponent> list2 = Lists.newArrayList((Iterable)textComponent);
        for (int j = 0; j < list2.size(); ++j) {
            ...
            final String s3 = removeTextColorsIfConfigured(String.valueOf(itextcomponent2.getStyle().getFormattingCode()) + s, forceTextColor);
