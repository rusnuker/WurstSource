...
public class GuiScreenServerList extends GuiScreen
{
    ...
    public void initGui() {
        ...
        (this.ipEdit = new GuiTextField(2, this.fontRendererObj, this.width / 2 - 100, 116, 200, 20)).setMaxStringLength(128);
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 1) {
                ...
                ServerHook.updateLastServerFromDirectConnect((GuiMultiplayer)this.lastScreen, this.serverData);
