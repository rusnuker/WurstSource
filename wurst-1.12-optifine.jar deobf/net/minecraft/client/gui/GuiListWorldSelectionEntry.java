...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void joinWorld() {
        if (this.worldSummary.askToOpenWorld()) {
            this.client.openScreen(new GuiYesNo(new GuiYesNoCallback() {
                @Override
                public void confirmClicked(final boolean result, final int id) {
                    if (result) {
                        ...
                        GuiListWorldSelectionEntry.this.client.openScreen(GuiListWorldSelectionEntry.this.worldSelScreen);
                    }
                }
    ...
    public void deleteWorld() {
        this.client.openScreen(new GuiYesNo(new GuiYesNoCallback() {
            ...
            public void confirmClicked(final boolean result, final int id) {
                if (result) {
                    GuiListWorldSelectionEntry.this.client.openScreen(new GuiScreenWorking());
    ...
    public void editWorld() {
        this.client.openScreen(new GuiWorldEdit(this.worldSelScreen, this.worldSummary.getFileName()));
    }
    
    public void recreateWorld() {
        this.client.openScreen(new GuiScreenWorking());
        ...
        if (worldinfo != null) {
            ...
            this.client.openScreen(guicreateworld);
        }
    }
