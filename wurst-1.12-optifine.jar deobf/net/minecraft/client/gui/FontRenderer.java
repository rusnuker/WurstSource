...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawString(String text, final float x, final float y, final int color, final boolean dropShadow) {
        text = WurstClient.INSTANCE.hax.nameProtectMod.protect(text);
        this.enableAlpha();
        this.resetStyles();
        int i;
        if (dropShadow) {
