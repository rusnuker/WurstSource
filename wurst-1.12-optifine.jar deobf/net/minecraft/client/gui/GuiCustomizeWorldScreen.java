...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public GuiCustomizeWorldScreen(final GuiScreen p_i45521_1_, final String p_i45521_2_) {
        ...
        this.numberFilter = (Predicate<String>)new Predicate<String>() {
            public boolean apply(@Nullable final String p_apply_1_) {
                ...
                return p_apply_1_.isEmpty() || (f != null && Floats.isFinite((float)f) && f >= 0.0f);
            }
        };
    ...
    public void loadValues(final String p_175324_1_) {
    ...
    public void setEntryValue(final int id, final String value) {
        ...
        switch (id) {
            ...
            case 137: {
                ...
                f2 = this.settings.depthNoiseScaleExponent;
                break;
            }
            case 138: {
        ...
        if (f2 != f && f != 0.0f) {
            ((GuiTextField)this.list.getComponent(id)).setText(this.getFormattedValue(id, f2));
        }
        ((GuiSlider)this.list.getComponent(id - 132 + 100)).setSliderValue(f2, false);
        if (!this.settings.equals(this.defaultSettings)) {
            this.setSettingsModified(true);
        }
    }
    
    private void setSettingsModified(final boolean p_181031_1_) {
    ...
    public String getText(final int id, final String name, final float value) {
        return String.valueOf(name) + ": " + this.getFormattedValue(id, value);
    }
    
    private String getFormattedValue(final int p_175330_1_, final float p_175330_2_) {
        switch (p_175330_1_) {
            case 100:
            case 101:
            case 102:
            ...
            case 162: {
                ...
                if ((int)p_175330_2_ >= Biome.getIdForBiome(Biomes.HELL)) {
                    final Biome biome1 = Biome.getBiomeForId((int)p_175330_2_ + 2);
                    return (biome1 != null) ? biome1.getBiomeName() : "?";
                }
                final Biome biome2 = Biome.getBiomeForId((int)p_175330_2_);
                return (biome2 != null) ? biome2.getBiomeName() : "?";
            }
        }
    }
    ...
    public void setEntryValue(final int id, final float value) {
        ...
        if (id >= 100 && id < 116) {
            final Gui gui = this.list.getComponent(id - 100 + 132);
            if (gui != null) {
            ...
            switch (button.id) {
                ...
                case 301: {
                    for (int i = 0; i < this.list.getSize(); ++i) {
                        final GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = this.list.getListEntry(i);
                        final Gui gui = guipagebuttonlist$guientry.getComponent1();
                        if (gui instanceof GuiButton) {
                            final GuiButton guibutton = (GuiButton)gui;
                            if (guibutton instanceof GuiSlider) {
                                final float f = ((GuiSlider)guibutton).getSliderPosition() * (0.75f + this.random.nextFloat() * 0.5f) + (this.random.nextFloat() * 0.1f - 0.05f);
                        ...
                        final Gui gui2 = guipagebuttonlist$guientry.getComponent2();
                        if (gui2 instanceof GuiButton) {
                            final GuiButton guibutton2 = (GuiButton)gui2;
                            if (guibutton2 instanceof GuiSlider) {
                                final float f2 = ((GuiSlider)guibutton2).getSliderPosition() * (0.75f + this.random.nextFloat() * 0.5f) + (this.random.nextFloat() * 0.1f - 0.05f);
                                ((GuiSlider)guibutton2).setSliderPosition(MathHelper.clamp(f2, 0.0f, 1.0f));
                            }
                ...
                case 305: {
                    this.mc.openScreen(new GuiScreenCustomizePresets(this));
                    break;
                }
                case 306: {
    ...
    private void enterConfirmation(final int p_175322_1_) {
    ...
    private void setConfirmationControls(final boolean p_175329_1_) {
    ...
    private void modifyFocusValue(final float p_175327_1_) {
        final Gui gui = this.list.getFocusedControl();
        if (gui instanceof GuiTextField) {
            ...
            if (f2 != null) {
                ...
                final String s = this.getFormattedValue(guitextfield.getId(), f2);
