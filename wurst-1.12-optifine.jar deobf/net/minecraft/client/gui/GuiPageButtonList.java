...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    public GuiPageButtonList(final Minecraft mcIn, final int widthIn, final int heightIn, final int topIn, final int bottomIn, final int slotHeightIn, final GuiResponder p_i45536_7_, final GuiListEntry[]... p_i45536_8_) {
        ...
        this.editBoxes = Lists.newArrayList();
    ...
    private void populateComponents() {
        GuiListEntry[][] pages;
        for (int length = (pages = this.pages).length, j = 0; j < length; ++j) {
            final GuiListEntry[] aguipagebuttonlist$guilistentry = pages[j];
    ...
    private void markVisibility(final int p_178060_1_, final int p_178060_2_) {
        GuiListEntry[] array;
        for (int length = (array = this.pages[p_178060_1_]).length, i = 0; i < length; ++i) {
        ...
        GuiListEntry[] array2;
        for (int length2 = (array2 = this.pages[p_178060_2_]).length, j = 0; j < length2; ++j) {
    ...
    private GuiTextField createTextField(final int p_178068_1_, final int p_178068_2_, final EditBoxEntry p_178068_3_) {
        final GuiTextField guitextfield = new GuiTextField(p_178068_3_.getId(), this.mc.fontRendererObj, p_178068_1_, p_178068_2_, 150, 20);
        ...
        if (this.focusedControl instanceof GuiTextField) {
            ...
            if (!GuiScreen.isKeyComboCtrlV(p_178062_2_)) {
                ...
                for (int length = (array = astring).length, n = 0; n < length; ++n) {
                    ...
                    guitextfield2.func_190516_a(guitextfield2.getId(), s2);
    ...
    public static class GuiEntry implements IGuiListEntry
    {
        ...
        private void func_192636_a(final Gui p_192636_1_, final int p_192636_2_, final int p_192636_3_, final int p_192636_4_, final boolean p_192636_5_, final float p_192636_6_) {
            if (p_192636_1_ != null) {
        ...
        private void func_192635_a(final GuiButton p_192635_1_, final int p_192635_2_, final int p_192635_3_, final int p_192635_4_, final boolean p_192635_5_, final float p_192635_6_) {
