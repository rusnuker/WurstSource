...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) throws IOException {
        ...
        for (int k = 0; k < 3; ++k) {
            ...
            if (l >= 0 && i2 >= 0 && l < 108 && i2 < 19 && this.container.enchantItem(this.mc.player, k)) {
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            if (k2 == 0) {
                ...
                final String s = new StringBuilder().append(k2).toString();
                final int l2 = 86 - this.fontRendererObj.getStringWidth(s);
                final String s2 = EnchantmentNameParts.getInstance().generateNewRandomName(this.fontRendererObj, l2);
                FontRenderer fontrenderer = this.mc.standardGalacticFontRenderer;
                int i3 = 6839882;
                if ((k < l + 1 || this.mc.player.experienceLevel < k2) && !this.mc.player.abilities.creativeMode) {
                    this.drawTexturedModalRect(i2, j + 14 + 19 * l, 0, 185, 108, 19);
    ...
    public void drawScreen(final int mouseX, final int mouseY, float partialTicks) {
        ...
        final boolean flag = this.mc.player.abilities.creativeMode;
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0 && enchantment != null) {
                ...
                list.add(new StringBuilder().append(TextFormatting.WHITE).append(TextFormatting.ITALIC).append(I18n.format("container.enchant.clue", enchantment.getTranslatedName(l))).toString());
                if (!flag) {
                    list.add("");
