...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void func_193029_f() {
        this.buttonList.add(new GuiButton(-1, this.width / 2 - 154, this.height - 28, 150, 20, WurstClient.INSTANCE.isEnabled() ? "Disable Wurst" : "Enable Wurst"));
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == -1) {
                ...
                button.displayString = (WurstClient.INSTANCE.isEnabled() ? "Disable Wurst" : "Enable Wurst");
            }
            if (button.id == 0) {
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        protected void drawSlot(final int p_192637_1_, final int p_192637_2_, final int p_192637_3_, final int p_192637_4_, final int p_192637_5_, final int p_192637_6_, final float p_192637_7_) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, (i == 0) ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s3, p_192637_2_ + 2, p_192637_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2, (j == 0) ? 6316128 : 9474192);
        }
    }
}
