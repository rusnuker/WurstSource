...
public class GuiWinGame extends GuiScreen
{
    ...
    public void updateScreen() {
        ...
        final float f = (this.totalScrollLength + this.height + this.height + 24) / 0.5f;
        if (this.time > f) {
            ...
            try {
                ...
                if (this.field_193980_h) {
                    ...
                    while ((s2 = bufferedreader.readLine()) != null) {
                        String s3;
                        String s4;
                        for (s2 = s2.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); s2.contains(s); s2 = String.valueOf(s3) + TextFormatting.WHITE + TextFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s4) {
                ...
                while ((s5 = bufferedreader2.readLine()) != null) {
                    s5 = s5.replaceAll("PLAYERNAME", this.mc.getSession().getUsername());
                    s5 = s5.replaceAll("\t", "    ");
    ...
    private void drawWinGameScreen(final int p_146575_1_, final int p_146575_2_, final float p_146575_3_) {
        ...
        final float f = -this.time * 0.5f * 0.5f;
        final float f2 = this.height - this.time * 0.5f * 0.5f;
        final float f3 = 0.015625f;
        float f4 = this.time * 0.02f;
        final float f5 = (this.totalScrollLength + this.height + this.height + 24) / 0.5f;
