...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null) {
                        ...
                        if (j2 < 200 || flag) {
                            ...
                            if (l2 > 3) {
                                final int i3 = 0;
                                final int j3 = -i2 * 9;
                                Gui.drawRect(-2, j3 - 9, 0 + k + 4, j3, l2 / 2 << 24);
    ...
    public void printChatMessageWithOptionalDeletion(ITextComponent chatComponent, final int chatLineId) {
        final ChatInputListener.ChatInputEvent event = new ChatInputListener.ChatInputEvent(chatComponent, this.drawnChatLines);
    ...
    private void setChatLine(final ITextComponent chatComponent, final int chatLineId, final int updateCounter, final boolean displayOnly) {
        ...
        final List<ITextComponent> list = GuiUtilRenderComponents.splitText(chatComponent, i, this.mc.fontRendererObj, false, false);
