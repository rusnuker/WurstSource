...
public class MapItemRenderer
{
    ...
    @Nullable
    public Instance func_191205_a(final String p_191205_1_) {
    ...
    @Nullable
    public MapData func_191207_a(@Nullable final Instance p_191207_1_) {
        ...
        private void render(final boolean noOverlayRendering) {
            ...
            for (final MapDecoration mapdecoration : this.mapData.mapDecorations.values()) {
                if (!noOverlayRendering || mapdecoration.func_191180_f()) {
                    ...
                    final byte b0 = mapdecoration.getType();
