...
public class GuiEditStructure extends GuiScreen
{
    ...
    public void initGui() {
        ...
        (this.nameEdit = new GuiTextField(2, this.fontRendererObj, this.width / 2 - 152, 40, 300, 20)).setMaxStringLength(64);
        ...
        (this.posXEdit = new GuiTextField(3, this.fontRendererObj, this.width / 2 - 152, 80, 80, 20)).setMaxStringLength(15);
        this.posXEdit.setText(Integer.toString(blockpos.getX()));
        this.tabOrder.add(this.posXEdit);
        (this.posYEdit = new GuiTextField(4, this.fontRendererObj, this.width / 2 - 72, 80, 80, 20)).setMaxStringLength(15);
        this.posYEdit.setText(Integer.toString(blockpos.getY()));
        this.tabOrder.add(this.posYEdit);
        (this.posZEdit = new GuiTextField(5, this.fontRendererObj, this.width / 2 + 8, 80, 80, 20)).setMaxStringLength(15);
        ...
        (this.sizeXEdit = new GuiTextField(6, this.fontRendererObj, this.width / 2 - 152, 120, 80, 20)).setMaxStringLength(15);
        this.sizeXEdit.setText(Integer.toString(blockpos2.getX()));
        this.tabOrder.add(this.sizeXEdit);
        (this.sizeYEdit = new GuiTextField(7, this.fontRendererObj, this.width / 2 - 72, 120, 80, 20)).setMaxStringLength(15);
        this.sizeYEdit.setText(Integer.toString(blockpos2.getY()));
        this.tabOrder.add(this.sizeYEdit);
        (this.sizeZEdit = new GuiTextField(8, this.fontRendererObj, this.width / 2 + 8, 120, 80, 20)).setMaxStringLength(15);
        this.sizeZEdit.setText(Integer.toString(blockpos2.getZ()));
        this.tabOrder.add(this.sizeZEdit);
        (this.integrityEdit = new GuiTextField(15, this.fontRendererObj, this.width / 2 - 152, 120, 80, 20)).setMaxStringLength(15);
        this.integrityEdit.setText(this.decimalFormat.format(this.tileStructure.getIntegrity()));
        this.tabOrder.add(this.integrityEdit);
        (this.seedEdit = new GuiTextField(16, this.fontRendererObj, this.width / 2 - 72, 120, 80, 20)).setMaxStringLength(31);
        this.seedEdit.setText(Long.toString(this.tileStructure.getSeed()));
        this.tabOrder.add(this.seedEdit);
        (this.dataEdit = new GuiTextField(17, this.fontRendererObj, this.width / 2 - 152, 120, 240, 20)).setMaxStringLength(128);
    ...
    private static boolean isValidCharacterForName(final char p_190301_0_, final int p_190301_1_) {
        boolean flag = true;
        int[] legal_KEY_CODES;
        for (int length = (legal_KEY_CODES = GuiEditStructure.LEGAL_KEY_CODES).length, j = 0; j < length; ++j) {
            final int i = legal_KEY_CODES[j];
            if (i == p_190301_1_) {
                return true;
            }
        }
        char[] illegal_STRUCTURE_CHARACTERS;
        for (int length2 = (illegal_STRUCTURE_CHARACTERS = ChatAllowedCharacters.ILLEGAL_STRUCTURE_CHARACTERS).length, k = 0; k < length2; ++k) {
            final char c0 = illegal_STRUCTURE_CHARACTERS[k];
            if (c0 == p_190301_0_) {
                flag = false;
                break;
            }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (tileentitystructure$mode == TileEntityStructure.Mode.SAVE) {
            ...
            final int j = this.fontRendererObj.getStringWidth(s3);
            this.drawString(this.fontRendererObj, s3, this.width / 2 + 154 - j, 70, 10526880);
        }
        if (tileentitystructure$mode == TileEntityStructure.Mode.LOAD) {
            ...
            this.drawString(this.fontRendererObj, s4, this.width / 2 + 154 - l, 70, 10526880);
        }
        if (tileentitystructure$mode == TileEntityStructure.Mode.DATA) {
        ...
        this.drawString(this.fontRendererObj, I18n.format(s5, new Object[0]), this.width / 2 - 153, 174, 10526880);
