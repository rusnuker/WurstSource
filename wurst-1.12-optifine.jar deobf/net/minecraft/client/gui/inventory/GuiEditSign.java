...
public class GuiEditSign extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        final ITextComponent[] autoSignText = WurstClient.INSTANCE.hax.autoSignMod.getSignText();
        if (autoSignText != null) {
            this.tileSign.signText = autoSignText;
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled && button.id == 0) {
            WurstClient.INSTANCE.hax.autoSignMod.setSignText(this.tileSign.signText);
