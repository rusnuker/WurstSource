...
public class GuiEditCommandBlockMinecart extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui() {
        ...
        (this.commandField = new GuiTextField(2, this.fontRendererObj, this.width / 2 - 150, 50, 300, 20)).setMaxStringLength(32500);
        this.commandField.setFocused(true);
        this.commandField.setText(this.commandBlockLogic.getCommand());
        (this.previousEdit = new GuiTextField(3, this.fontRendererObj, this.width / 2 - 150, 150, 276, 20)).setMaxStringLength(32500);
