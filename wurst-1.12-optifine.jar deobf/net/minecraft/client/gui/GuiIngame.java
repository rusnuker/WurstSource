...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        if (this.mc.gameSettings.keyBindPlayerList.isPressed() && (!this.mc.isIntegratedServerRunning() || this.mc.player.connection.getPlayerInfoMap().size() > 1 || scoreobjective2 != null)) {
    ...
    protected void renderHotbar(final ScaledResolution sr, final float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.selectedSlot * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
    ...
    private void renderScoreboard(final ScoreObjective objective, final ScaledResolution scaledRes) {
        ...
        for (final Score score2 : collection) {
            ...
            final String s3 = new StringBuilder().append(TextFormatting.RED).append(score2.getScorePoints()).toString();
