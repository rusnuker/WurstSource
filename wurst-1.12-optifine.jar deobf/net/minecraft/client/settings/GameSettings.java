...
public class GameSettings
{
    ...
    public GameSettings(final Minecraft mcIn, final File optionsFileIn) {
        ...
        this.mipmapLevels = 4;
        this.soundLevels = Maps.newEnumMap((Class)SoundCategory.class);
        ...
        this.keyBindZoom = new KeyBinding("Wurst Zoom", 47, "key.categories.misc");
        this.ofFogType = 1;
        ...
        this.keyBindings = (KeyBinding[])ArrayUtils.addAll((Object[])new KeyBinding[] { this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindFullscreen, this.keyBindSpectatorOutlines, this.keyBindSwapHands, this.field_193629_ap, this.field_193630_aq, this.field_194146_ao, this.keyBindZoom }, (Object[])this.keyBindsHotbar);
        ...
        this.ofKeyBindZoom = new KeyBinding("of.key.zoom", 0, "key.categories.misc");
    ...
    public void loadOptions() {
        try {
            ...
            final List<String> list = IOUtils.readLines((InputStream)new FileInputStream(this.optionsFile), StandardCharsets.UTF_8);
            NBTTagCompound nbttagcompound = new NBTTagCompound();
            for (final String s : list) {
                try {
                    final Iterator<String> iterator = GameSettings.COLON_SPLITTER.omitEmptyStrings().limit(2).split((CharSequence)s).iterator();
                    nbttagcompound.setString(iterator.next(), iterator.next());
                }
                catch (final Exception var12) {
                    GameSettings.LOGGER.warn("Skipping bad option: {}", (Object)s);
                }
            }
            ...
            for (final String s2 : nbttagcompound.getKeySet()) {
                ...
                try {
                    ...
                    GameSettings.LOGGER.warn("Skipping bad option: {}:{}", (Object)s2, (Object)s3);
    ...
    public void saveOptions() {
        ...
        Label_1777: {
            try {
                ...
                printwriter.println("incompatibleResourcePacks:" + GameSettings.GSON.toJson((Object)this.incompatibleResourcePacks));
    ...
    public enum Options
    {
        ...
        private Options(final String name, final int ordinal, final String str, final boolean isFloat, final boolean isBoolean, final float valMin, final float valMax, final float valStep) {
            this.enumString = str;
