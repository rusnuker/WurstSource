...
public class CreativeSettings
{
    ...
    public void func_192562_a() {
        try {
            ...
            CreativeSettings.field_192566_b.error("Failed to load creative mode options", (Throwable)exception);
        }
    }
    ...
    public void func_192564_b() {
        try {
            ...
            CreativeSettings.field_192566_b.error("Failed to save creative mode options", (Throwable)exception);
        }
    }
