...
public abstract class Team
{
    ...
    public enum CollisionRule
    {
        ...
        private CollisionRule(final String name, final int ordinal, final String nameIn, final int idIn) {
            this.name = nameIn;
            this.id = idIn;
        }
    }
    ...
    public enum EnumVisible
    {
        ...
        private EnumVisible(final String name, final int ordinal, final String nameIn, final int idIn) {
