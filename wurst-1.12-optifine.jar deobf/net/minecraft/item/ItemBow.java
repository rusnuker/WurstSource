...
public class ItemBow extends Item
{
    ...
    private ItemStack findAmmo(final EntityPlayer player) {
        ...
        for (int i = 0; i < player.inventory.getSizeInventory(); ++i) {
            final ItemStack itemstack = player.inventory.getInvStack(i);
    ...
    public void onPlayerStoppedUsing(final ItemStack stack, final World worldIn, final EntityLivingBase entityLiving, final int timeLeft) {
        if (entityLiving instanceof EntityPlayer) {
            ...
            final boolean flag = entityplayer.abilities.creativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, stack) > 0;
            ...
            if (!itemstack.func_190926_b() || flag) {
                ...
                if (f >= 0.1) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        if (flag2 || (entityplayer.abilities.creativeMode && (itemstack.getItem() == Items.SPECTRAL_ARROW || itemstack.getItem() == Items.TIPPED_ARROW))) {
                    ...
                    if (!flag2 && !entityplayer.abilities.creativeMode) {
    ...
    public ActionResult<ItemStack> onItemRightClick(final World itemStackIn, final EntityPlayer worldIn, final EnumHand playerIn) {
        ...
        if (!worldIn.abilities.creativeMode && !flag) {
