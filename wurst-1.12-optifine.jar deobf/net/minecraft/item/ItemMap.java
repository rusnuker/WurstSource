...
public class ItemMap extends ItemMapBase
{
    ...
    public static ItemStack func_190906_a(final World p_190906_0_, final double p_190906_1_, final double p_190906_3_, final byte p_190906_5_, final boolean p_190906_6_, final boolean p_190906_7_) {
        final ItemStack itemstack = new ItemStack(Items.FILLED_MAP, 1, p_190906_0_.getUniqueDataId("map"));
        final String s = "map_" + itemstack.getMetadata();
        final MapData mapdata = new MapData(s);
        p_190906_0_.setItemData(s, mapdata);
        mapdata.calculateMapCenter(p_190906_1_, p_190906_3_, mapdata.scale = p_190906_5_);
                                        ...
                                        for (int j5 = 0; j5 < i; ++j5) {
                                            ...
                                            if (k5 <= 1) {
                                                ...
                                                do {
                                                    ...
                                                    blockpos$mutableblockpos.setPos((chunk.xPosition << 4) + i5 + i4, k5, (chunk.zPosition << 4) + j5 + j4);
                                                ...
                                                if (k5 > 0 && iblockstate.getMaterial().isLiquid()) {
                                                    ...
                                                    do {
                                                        ...
                                                        ++k4;
                                                    } while (l5 > 0 && iblockstate2.getMaterial().isLiquid());
                                                }
                                            }
                                            d2 += k5 / (double)(i * i);
    ...
    public static void func_190905_a(final World p_190905_0_, final ItemStack p_190905_1_) {
        if (p_190905_1_.getItem() == Items.FILLED_MAP) {
            final MapData mapdata = Items.FILLED_MAP.getMapData(p_190905_1_, p_190905_0_);
            if (mapdata != null && p_190905_0_.provider.getDimensionType().getId() == mapdata.dimension) {
                final int i = 1 << mapdata.scale;
                final int j = mapdata.xCenter;
                final int k = mapdata.zCenter;
                final Biome[] abiome = p_190905_0_.getBiomeProvider().getBiomes(null, (j / i - 64) * i, (k / i - 64) * i, 128 * i, 128 * i, false);
                for (int l = 0; l < 128; ++l) {
    ...
    protected static void scaleMap(final ItemStack p_185063_0_, final World p_185063_1_, final int p_185063_2_) {
        ...
        if (mapdata != null) {
            ...
            mapdata2.markDirty();
            p_185063_1_.setItemData("map_" + p_185063_0_.getMetadata(), mapdata2);
        }
    }
    ...
    protected static void enableMapTracking(final ItemStack p_185064_0_, final World p_185064_1_) {
        ...
        if (mapdata != null) {
            ...
            mapdata2.dimension = mapdata.dimension;
            mapdata2.markDirty();
            p_185064_1_.setItemData("map_" + p_185064_0_.getMetadata(), mapdata2);
        }
    }
    ...
    public void addInformation(final ItemStack stack, @Nullable final World playerIn, final List<String> tooltip, final ITooltipFlag advanced) {
        if (advanced.func_194127_a()) {
            final MapData mapdata = (playerIn == null) ? null : this.getMapData(stack, playerIn);
            if (mapdata != null) {
    ...
    public static int func_190907_h(final ItemStack p_190907_0_) {
