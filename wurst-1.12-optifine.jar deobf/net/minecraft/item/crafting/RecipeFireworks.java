...
public class RecipeFireworks implements IRecipe
{
    ...
    public boolean matches(final InventoryCrafting inv, final World worldIn) {
        ...
        for (int k2 = 0; k2 < inv.getSizeInventory(); ++k2) {
            final ItemStack itemstack = inv.getInvStack(k2);
        ...
        if (j >= 1 && i == 1 && i2 == 0) {
            ...
            if (l > 0) {
                ...
                for (int k3 = 0; k3 < inv.getSizeInventory(); ++k3) {
                    final ItemStack itemstack2 = inv.getInvStack(k3);
        ...
        if (j == 1 && i == 0 && l == 0 && k > 0 && j2 <= 1) {
            ...
            for (int l2 = 0; l2 < inv.getSizeInventory(); ++l2) {
                final ItemStack itemstack3 = inv.getInvStack(l2);
        ...
        for (int i3 = 0; i3 < inv.getSizeInventory(); ++i3) {
            final ItemStack itemstack4 = inv.getInvStack(i3);
            if (!itemstack4.func_190926_b()) {
                if (itemstack4.getItem() == Items.DYE) {
                    ...
                    (this.resultItem = itemstack4.copy()).func_190920_e(1);
                }
            }
        }
