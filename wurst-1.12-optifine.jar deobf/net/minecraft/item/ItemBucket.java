    ...
    public ActionResult<ItemStack> onItemRightClick(final World itemStackIn, final EntityPlayer worldIn, final EnumHand playerIn) {
        ...
        if (flag) {
            ...
            if (this.tryPlaceContainedLiquid(worldIn, itemStackIn, blockpos2)) {
                ...
                worldIn.addStat(StatList.getObjectUseStats(this));
                return worldIn.abilities.creativeMode ? new ActionResult<ItemStack>(EnumActionResult.SUCCESS, itemstack) : new ActionResult<ItemStack>(EnumActionResult.SUCCESS, new ItemStack(Items.BUCKET));
            }
            return new ActionResult<ItemStack>(EnumActionResult.FAIL, itemstack);
        }
    }
