...
public class Item
{
    ...
    public String getItemStackDisplayName(final ItemStack stack) {
        return I18n.translateToLocal(String.valueOf(this.getUnlocalizedNameInefficiently(stack)) + ".name").trim();
    }
    ...
    protected RayTraceResult rayTrace(final World worldIn, final EntityPlayer playerIn, final boolean useLiquids) {
        ...
        final double d4 = 5.0;
        final Vec3d vec3d2 = vec3d.addVector(f7 * 5.0, f6 * 5.0, f8 * 5.0);
    ...
    protected boolean func_194125_a(final CreativeTabs p_194125_1_) {
    ...
    public static void registerItems() {
        ...
        final Item item2 = new ItemGlassBottle().setUnlocalizedName("glassBottle");
        ...
        registerItem(437, "dragon_breath", new Item().setCreativeTab(CreativeTabs.BREWING).setUnlocalizedName("dragon_breath").setContainerItem(item2));
