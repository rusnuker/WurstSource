...
public class ItemLead extends Item
{
    ...
    public static boolean attachToFence(final EntityPlayer player, final World worldIn, final BlockPos fence) {
        ...
        for (final EntityLiving entityliving : worldIn.getEntitiesWithinAABB((Class<? extends EntityLiving>)EntityLiving.class, new Box(i - 7.0, j - 7.0, k - 7.0, i + 7.0, j + 7.0, k + 7.0))) {
