...
public class ItemArmor extends Item
{
    ...
    public static ItemStack dispenseArmor(final IBlockSource blockSource, final ItemStack stack) {
        ...
        final List<EntityLivingBase> list = blockSource.getWorld().getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, new Box(blockpos), (com.google.common.base.Predicate<? super EntityLivingBase>)Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, (Predicate)new EntitySelectors.ArmoredMob(stack)));
        if (list.isEmpty()) {
    ...
    public Multimap<String, AttributeModifier> getItemAttributeModifiers(final EntityEquipmentSlot equipmentSlot) {
        ...
        if (equipmentSlot == this.armorType) {
            multimap.put((Object)SharedMonsterAttributes.ARMOR.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ItemArmor.ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor modifier", this.damageReduceAmount, 0));
            multimap.put((Object)SharedMonsterAttributes.ARMOR_TOUGHNESS.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ItemArmor.ARMOR_MODIFIERS[equipmentSlot.getIndex()], "Armor toughness", this.toughness, 0));
        }
        return multimap;
    }
    ...
    public enum ArmorMaterial
    {
        ...
        private ArmorMaterial(final String name, final int ordinal, final String nameIn, final int maxDamageFactorIn, final int[] damageReductionAmountArrayIn, final int enchantabilityIn, final SoundEvent soundEventIn, final float toughnessIn) {
            this.name = nameIn;
