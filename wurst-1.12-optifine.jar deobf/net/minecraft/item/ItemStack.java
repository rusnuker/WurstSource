...
{
    public static final ItemStack field_190927_a;
    ...
    public ItemStack(final NBTTagCompound p_i47263_1_) {
    ...
    public float getStrVsBlock(final IBlockState blockIn) {
    ...
    public boolean attemptDamageItem(int amount, final Random rand, @Nullable final EntityPlayerMP p_96631_3_) {
    ...
    public void damageItem(final int amount, final EntityLivingBase entityIn) {
        if ((!(entityIn instanceof EntityPlayer) || !((EntityPlayer)entityIn).abilities.creativeMode) && this.isItemStackDamageable() && this.attemptDamageItem(amount, entityIn.getRNG(), (entityIn instanceof EntityPlayerMP) ? ((EntityPlayerMP)entityIn) : null)) {
    ...
    public static boolean areItemStackTagsEqual(final ItemStack stackA, final ItemStack stackB) {
        return (stackA.func_190926_b() && stackB.func_190926_b()) || (!stackA.func_190926_b() && !stackB.func_190926_b() && (stackA.stackTagCompound != null || stackB.stackTagCompound == null) && (stackA.stackTagCompound == null || stackA.stackTagCompound.equals(stackB.stackTagCompound)));
    }
    
    public static boolean areItemStacksEqual(final ItemStack stackA, final ItemStack stackB) {
        return (stackA.func_190926_b() && stackB.func_190926_b()) || (!stackA.func_190926_b() && !stackB.func_190926_b() && stackA.isItemStackEqual(stackB));
    }
    ...
    public static boolean areItemsEqual(final ItemStack stackA, final ItemStack stackB) {
        return stackA == stackB || (!stackA.func_190926_b() && !stackB.func_190926_b() && stackA.isItemEqual(stackB));
    }
    
    public static boolean areItemsEqualIgnoreDurability(final ItemStack stackA, final ItemStack stackB) {
        return stackA == stackB || (!stackA.func_190926_b() && !stackB.func_190926_b() && stackA.isItemEqualIgnoreDurability(stackB));
    }
    ...
    public String toString() {
        return String.valueOf(this.stackSize) + "x" + this.getItem().getUnlocalizedName() + "@" + this.itemDamage;
    }
    ...
    public NBTTagCompound func_190925_c(final String p_190925_1_) {
    ...
    public void func_190919_e(final String p_190919_1_) {
    ...
    public ItemStack func_190924_f(final String p_190924_1_) {
    ...
    public List<String> getTooltip(@Nullable final EntityPlayer playerIn, final ITooltipFlag advanced) {
                ...
                if (nbttagcompound2.getTagId("Lore") == 9) {
                    ...
                    if (!nbttaglist2.hasNoTags()) {
                        for (int l2 = 0; l2 < nbttaglist2.tagCount(); ++l2) {
                            list.add(new StringBuilder().append(TextFormatting.DARK_PURPLE).append(TextFormatting.ITALIC).append(nbttaglist2.getStringTagAt(l2)).toString());
                        }
                    }
                }
            }
        ...
        for (int length = (values = EntityEquipmentSlot.values()).length, n = 0; n < length; ++n) {
            final EntityEquipmentSlot entityequipmentslot = values[n];
    ...
    public void func_190915_d(final int p_190915_1_) {
    ...
    public void func_190920_e(final int p_190920_1_) {
        this.stackSize = p_190920_1_;
        this.func_190923_F();
    }
    
    public void func_190917_f(final int p_190917_1_) {
        this.func_190920_e(this.stackSize + p_190917_1_);
    }
    
    public void func_190918_g(final int p_190918_1_) {
