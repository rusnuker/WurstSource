...
public class ItemGlassBottle extends Item
{
    ...
    public ActionResult<ItemStack> onItemRightClick(final World itemStackIn, final EntityPlayer worldIn, final EnumHand playerIn) {
        final List<EntityAreaEffectCloud> list = itemStackIn.getEntitiesWithinAABB((Class<? extends EntityAreaEffectCloud>)EntityAreaEffectCloud.class, worldIn.getEntityBoundingBox().expandXyz(2.0), (com.google.common.base.Predicate<? super EntityAreaEffectCloud>)new Predicate<EntityAreaEffectCloud>() {
