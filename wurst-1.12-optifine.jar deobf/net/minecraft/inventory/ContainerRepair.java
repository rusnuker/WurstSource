...
public class ContainerRepair extends Container
{
    ...
    public ContainerRepair(final InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, final EntityPlayer player) {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public boolean canTakeStack(final EntityPlayer playerIn) {
                return (playerIn.abilities.creativeMode || playerIn.experienceLevel >= ContainerRepair.this.maximumCost) && ContainerRepair.this.maximumCost > 0 && this.getHasStack();
            }
            
            @Override
            public ItemStack func_190901_a(final EntityPlayer p_190901_1_, final ItemStack p_190901_2_) {
                if (!p_190901_1_.abilities.creativeMode) {
                ...
                if (ContainerRepair.this.materialCost > 0) {
                    final ItemStack itemstack = ContainerRepair.this.inputSlots.getInvStack(1);
                ...
                if (!p_190901_1_.abilities.creativeMode && !worldIn.isRemote && iblockstate.getBlock() == Blocks.ANVIL && p_190901_1_.getRNG().nextFloat() < 0.12f) {
    ...
    public void updateRepairOutput() {
        final ItemStack itemstack = this.inputSlots.getInvStack(0);
        this.maximumCost = 1;
        int i = 0;
        int j = 0;
        int k = 0;
        if (itemstack.func_190926_b()) {
            ...
            final ItemStack itemstack3 = this.inputSlots.getInvStack(1);
                ...
                if (itemstack2.isItemStackDamageable() && itemstack2.getItem().getIsRepairable(itemstack, itemstack3)) {
                    ...
                    for (final Enchantment enchantment1 : map2.keySet()) {
                        if (enchantment1 != null) {
                            ...
                            if (this.thePlayer.abilities.creativeMode || itemstack.getItem() == Items.ENCHANTED_BOOK) {
                                flag4 = true;
                            }
            ...
            if (this.maximumCost >= 40 && !this.thePlayer.abilities.creativeMode) {
                itemstack2 = ItemStack.field_190927_a;
            }
