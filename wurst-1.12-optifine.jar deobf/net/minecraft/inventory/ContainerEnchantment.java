...
public class ContainerEnchantment extends Container
{
    ...
    public void onCraftMatrixChanged(final IInventory inventoryIn) {
        if (inventoryIn == this.tableInventory) {
            final ItemStack itemstack = inventoryIn.getInvStack(0);
    ...
    public boolean enchantItem(final EntityPlayer playerIn, final int id) {
        ItemStack itemstack = this.tableInventory.getInvStack(0);
        final ItemStack itemstack2 = this.tableInventory.getInvStack(1);
        final int i = id + 1;
        if ((itemstack2.func_190926_b() || itemstack2.func_190916_E() < i) && !playerIn.abilities.creativeMode) {
            return false;
        }
        if (this.enchantLevels[id] > 0 && !itemstack.func_190926_b() && ((playerIn.experienceLevel >= i && playerIn.experienceLevel >= this.enchantLevels[id]) || playerIn.abilities.creativeMode)) {
            if (!this.worldPointer.isRemote) {
    ...
    public int getLapisAmount() {
        final ItemStack itemstack = this.tableInventory.getInvStack(1);
