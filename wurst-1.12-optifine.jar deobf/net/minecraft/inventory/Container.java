...
public abstract class Container
{
    ...
    public ItemStack slotClick(final int slotId, final int dragType, final ClickType clickTypeIn, final EntityPlayer player) {
        ...
        if (clickTypeIn == ClickType.QUICK_CRAFT) {
            ...
            final ItemStack itemstack9 = inventoryplayer.getInvStack(dragType);
        ...
        else if (clickTypeIn == ClickType.CLONE && player.abilities.creativeMode && inventoryplayer.getItemStack().func_190926_b() && slotId >= 0) {
    ...
    public void func_192388_b(final int p_192388_1_, final ItemStack p_192388_2_) {
        final ItemStack itemstack = this.getSlot(p_192388_1_).getStack();
    ...
    public static boolean isValidDragMode(final int dragModeIn, final EntityPlayer player) {
        return dragModeIn == 0 || dragModeIn == 1 || (dragModeIn == 2 && player.abilities.creativeMode);
    }
    ...
    public static int calcRedstoneFromInventory(@Nullable final IInventory inv) {
        ...
        for (int j = 0; j < inv.getSizeInventory(); ++j) {
            final ItemStack itemstack = inv.getInvStack(j);
            if (!itemstack.func_190926_b()) {
