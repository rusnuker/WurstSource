...
public class HttpUtil
{
    ...
    public static String buildPostString(final Map<String, Object> data) {
        ...
        for (final Map.Entry<String, Object> entry : data.entrySet()) {
            ...
            if (entry.getValue() != null) {
                ...
                catch (final UnsupportedEncodingException unsupportedencodingexception2) {
    ...
    public static String postMap(final URL url, final Map<String, Object> data, final boolean skipLoggingErrors, @Nullable final Proxy p_151226_3_) {
