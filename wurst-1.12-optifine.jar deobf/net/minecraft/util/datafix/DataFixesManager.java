...
{
    private static void registerFixes(final DataFixer fixer) {
    ...
    public static DataFixer createFixer() {
        final DataFixer datafixer = new DataFixer(1139);
    ...
    public static NBTTagCompound processItemStack(final IDataFixer fixer, final NBTTagCompound compound, final int version, final String key) {
    ...
    public static NBTTagCompound processInventory(final IDataFixer fixer, final NBTTagCompound compound, final int version, final String key) {
        if (compound.hasKey(key, 9)) {
            final NBTTagList nbttaglist = compound.getTagList(key, 10);
