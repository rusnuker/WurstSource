...
public class BlockEntityTag implements IDataWalker
{
    ...
    private static final Map<String, String> field_190892_b;
    ...
    static {
        ...
        Map<String, String> map = BlockEntityTag.field_190892_b;
    ...
    private static String getBlockEntityID(final int blockID, final String p_188267_1_) {
        return (blockID < 515) ? BlockEntityTag.field_190892_b.get(new ResourceLocation(p_188267_1_).toString()) : BlockEntityTag.ITEM_ID_TO_BLOCK_ENTITY_ID.get(new ResourceLocation(p_188267_1_).toString());
    }
