...
public class ResourceLocation implements Comparable<ResourceLocation>
{
    ...
    protected ResourceLocation(final int unused, final String... resourceName) {
        this.resourceDomain = (StringUtils.isEmpty((CharSequence)resourceName[0]) ? "minecraft" : resourceName[0].toLowerCase(Locale.ROOT));
        Validate.notNull((Object)(this.resourcePath = resourceName[1].toLowerCase(Locale.ROOT)));
    }
