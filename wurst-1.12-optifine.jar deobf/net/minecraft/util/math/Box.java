...
public class Box
{
    ...
    public Box(final BlockPos pos) {
        this(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1);
    }
    
    public Box(final BlockPos pos1, final BlockPos pos2) {
        this(pos1.getX(), pos1.getY(), pos1.getZ(), pos2.getX(), pos2.getY(), pos2.getZ());
    }
    
    public Box(final Vec3d min, final Vec3d max) {
        this(min.xCoord, min.yCoord, min.zCoord, max.xCoord, max.yCoord, max.zCoord);
    }
    
    public Box setMaxY(final double y2) {
        return new Box(this.minX, this.minY, this.minZ, this.maxX, y2, this.maxZ);
    }
    ...
    public boolean equals(final Object p_equals_1_) {
        ...
        if (!(p_equals_1_ instanceof Box)) {
            return false;
        }
        final Box axisalignedbb = (Box)p_equals_1_;
    ...
    public Box func_191195_a(final double p_191195_1_, final double p_191195_3_, final double p_191195_5_) {
        double d0 = this.minX;
        double d2 = this.minY;
        double d3 = this.minZ;
        double d4 = this.maxX;
    ...
    public Box addCoord(final double x, final double y, final double z) {
        double d0 = this.minX;
        double d2 = this.minY;
        double d3 = this.minZ;
        double d4 = this.maxX;
    ...
    public Box expandXyz(final double value) {
        return this.expand(value, value, value);
    }
    
    public Box func_191500_a(final Box p_191500_1_) {
    ...
    public Box offset(final BlockPos pos) {
        return new Box(this.minX + pos.getX(), this.minY + pos.getY(), this.minZ + pos.getZ(), this.maxX + pos.getX(), this.maxY + pos.getY(), this.maxZ + pos.getZ());
    }
    
    public Box func_191194_a(final Vec3d p_191194_1_) {
        return this.offset(p_191194_1_.xCoord, p_191194_1_.yCoord, p_191194_1_.zCoord);
    }
    
    public double calculateXOffset(final Box other, double offsetX) {
    ...
    public double calculateYOffset(final Box other, double offsetY) {
    ...
    public double calculateZOffset(final Box other, double offsetZ) {
    ...
    public Box contract(final double value) {
