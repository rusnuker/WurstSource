...
public class Vec3i implements Comparable<Vec3i>
{
    ...
    public double getDistance(final int xIn, final int yIn, final int zIn) {
        final double d0 = this.getX() - xIn;
        final double d2 = this.getY() - yIn;
        final double d3 = this.getZ() - zIn;
    ...
    public int getManhattanDistance(final Vec3i vec3i_1) {
        final float float_1 = (float)Math.abs(vec3i_1.getX() - this.x);
        final float float_2 = (float)Math.abs(vec3i_1.getY() - this.y);
        final float float_3 = (float)Math.abs(vec3i_1.getZ() - this.z);
