...
public class Style
{
    ...
    static /* synthetic */ void access$0(final Style style, final Boolean bold) {
        style.bold = bold;
    }
    
    static /* synthetic */ void access$1(final Style style, final Boolean italic) {
        style.italic = italic;
    }
    
    static /* synthetic */ void access$2(final Style style, final Boolean underlined) {
        style.underlined = underlined;
    }
    
    static /* synthetic */ void access$3(final Style style, final Boolean strikethrough) {
        style.strikethrough = strikethrough;
    }
    
    static /* synthetic */ void access$4(final Style style, final Boolean obfuscated) {
        style.obfuscated = obfuscated;
    }
    
    static /* synthetic */ void access$5(final Style style, final TextFormatting color) {
        style.color = color;
    }
    
    static /* synthetic */ void access$6(final Style style, final String insertion) {
        style.insertion = insertion;
    }
    
    static /* synthetic */ void access$7(final Style style, final ClickEvent clickEvent) {
        style.clickEvent = clickEvent;
    }
    
    static /* synthetic */ void access$8(final Style style, final HoverEvent hoverEvent) {
    ...
    public static class Serializer implements JsonDeserializer<Style>, JsonSerializer<Style>
    {
        ...
        public Style deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            if (jsonobject.has("bold")) {
                Style.access$0(style, jsonobject.get("bold").getAsBoolean());
            }
            if (jsonobject.has("italic")) {
                Style.access$1(style, jsonobject.get("italic").getAsBoolean());
            }
            if (jsonobject.has("underlined")) {
                Style.access$2(style, jsonobject.get("underlined").getAsBoolean());
            }
            if (jsonobject.has("strikethrough")) {
                Style.access$3(style, jsonobject.get("strikethrough").getAsBoolean());
            }
            if (jsonobject.has("obfuscated")) {
                Style.access$4(style, jsonobject.get("obfuscated").getAsBoolean());
            }
            if (jsonobject.has("color")) {
                Style.access$5(style, (TextFormatting)p_deserialize_3_.deserialize(jsonobject.get("color"), (Type)TextFormatting.class));
            }
            if (jsonobject.has("insertion")) {
                Style.access$6(style, jsonobject.get("insertion").getAsString());
            }
            if (jsonobject.has("clickEvent")) {
                ...
                if (jsonobject2 != null) {
                    ...
                    if (clickevent$action != null && s != null && clickevent$action.shouldAllowInChat()) {
                        Style.access$7(style, new ClickEvent(clickevent$action, s));
                    }
                }
            }
            if (jsonobject.has("hoverEvent")) {
                ...
                if (jsonobject3 != null) {
                    ...
                    if (hoverevent$action != null && itextcomponent != null && hoverevent$action.shouldAllowInChat()) {
                        Style.access$8(style, new HoverEvent(hoverevent$action, itextcomponent));
                    }
                }
            }
            return style;
