...
public class TextComponentTranslation extends TextComponentBase
{
    ...
    synchronized void ensureInitialized() {
        ...
        catch (final TextComponentTranslationFormatException textcomponenttranslationformatexception) {
            this.children.clear();
            try {
                this.initializeFromFormat(I18n.translateToFallback(this.key));
            }
            catch (final TextComponentTranslationFormatException var5) {
    ...
    public Iterator<ITextComponent> iterator() {
        ...
        return Iterators.concat((Iterator)TextComponentBase.createDeepCopyIterator(this.children), (Iterator)TextComponentBase.createDeepCopyIterator(this.siblings));
    }
