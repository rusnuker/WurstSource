...
public class CombatTracker
{
        ...
        if (combatentry != null && combatentry2.getDamageSrc() == DamageSource.fall) {
            ...
            if (combatentry.getDamageSrc() != DamageSource.fall && combatentry.getDamageSrc() != DamageSource.outOfWorld) {
                if (itextcomponent2 != null && (itextcomponent1 == null || !itextcomponent2.equals(itextcomponent1))) {
                    ...
                    final ItemStack itemstack1 = (entity2 instanceof EntityLivingBase) ? ((EntityLivingBase)entity2).getHeldItemMainhand() : ItemStack.field_190927_a;
                    ...
                    final ItemStack itemstack2 = (entity instanceof EntityLivingBase) ? ((EntityLivingBase)entity).getHeldItemMainhand() : ItemStack.field_190927_a;
                    if (!itemstack2.func_190926_b() && itemstack2.hasDisplayName()) {
    ...
    public EntityLivingBase getBestAttacker() {
        ...
        for (final CombatEntry combatentry : this.combatEntries) {
            if (combatentry.getDamageSrc().getEntity() instanceof EntityPlayer && (entityplayer == null || combatentry.getDamage() > f2)) {
    ...
    private CombatEntry getBestCombatEntry() {
        ...
        for (int i = 0; i < this.combatEntries.size(); ++i) {
            ...
            if ((combatentry3.getDamageSrc() == DamageSource.fall || combatentry3.getDamageSrc() == DamageSource.outOfWorld) && combatentry3.getDamageAmount() > 0.0f && (combatentry == null || combatentry3.getDamageAmount() > f2)) {
                if (i > 0) {
