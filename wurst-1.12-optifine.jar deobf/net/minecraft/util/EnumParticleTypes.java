...
public enum EnumParticleTypes
{
    ...
    private EnumParticleTypes(final String name, final int ordinal, final String particleNameIn, final int particleIDIn, final boolean shouldIgnoreRangeIn, final int argumentCountIn) {
