...
public class FlyingNodeProcessor extends WalkNodeProcessor
{
    ...
    public PathPoint getStart() {
        ...
        final PathNodeType pathnodetype1 = this.func_192558_a(this.entity, blockpos1.getX(), i, blockpos1.getZ());
        if (this.entity.getPathPriority(pathnodetype1) < 0.0f) {
            ...
            for (final BlockPos blockpos2 : set) {
                final PathNodeType pathnodetype2 = this.func_192559_a(this.entity, blockpos2);
    ...
    public int findPathOptions(final PathPoint[] pathOptions, final PathPoint currentPoint, final PathPoint targetPoint, final float maxDistance) {
        int i = 0;
        final PathPoint pathpoint = this.openPoint(currentPoint.xCoord, currentPoint.yCoord, currentPoint.zCoord + 1);
        final PathPoint pathpoint2 = this.openPoint(currentPoint.xCoord - 1, currentPoint.yCoord, currentPoint.zCoord);
        final PathPoint pathpoint3 = this.openPoint(currentPoint.xCoord + 1, currentPoint.yCoord, currentPoint.zCoord);
        final PathPoint pathpoint4 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord, currentPoint.zCoord - 1);
        final PathPoint pathpoint5 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord + 1, currentPoint.zCoord);
        final PathPoint pathpoint6 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord - 1, currentPoint.zCoord);
        ...
        if (flag && flag4) {
            final PathPoint pathpoint7 = this.openPoint(currentPoint.xCoord - 1, currentPoint.yCoord, currentPoint.zCoord - 1);
            if (pathpoint7 != null && !pathpoint7.visited && pathpoint7.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint7;
            }
        }
        if (flag && flag3) {
            final PathPoint pathpoint8 = this.openPoint(currentPoint.xCoord + 1, currentPoint.yCoord, currentPoint.zCoord - 1);
            if (pathpoint8 != null && !pathpoint8.visited && pathpoint8.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint8;
            }
        }
        if (flag2 && flag4) {
            final PathPoint pathpoint9 = this.openPoint(currentPoint.xCoord - 1, currentPoint.yCoord, currentPoint.zCoord + 1);
            if (pathpoint9 != null && !pathpoint9.visited && pathpoint9.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint9;
            }
        }
        if (flag2 && flag3) {
            final PathPoint pathpoint10 = this.openPoint(currentPoint.xCoord + 1, currentPoint.yCoord, currentPoint.zCoord + 1);
            if (pathpoint10 != null && !pathpoint10.visited && pathpoint10.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint10;
            }
        }
        if (flag && flag5) {
            final PathPoint pathpoint11 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord + 1, currentPoint.zCoord - 1);
            if (pathpoint11 != null && !pathpoint11.visited && pathpoint11.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint11;
            }
        }
        if (flag2 && flag5) {
            final PathPoint pathpoint12 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord + 1, currentPoint.zCoord + 1);
            if (pathpoint12 != null && !pathpoint12.visited && pathpoint12.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint12;
            }
        }
        if (flag3 && flag5) {
            final PathPoint pathpoint13 = this.openPoint(currentPoint.xCoord + 1, currentPoint.yCoord + 1, currentPoint.zCoord);
            if (pathpoint13 != null && !pathpoint13.visited && pathpoint13.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint13;
            }
        }
        if (flag4 && flag5) {
            final PathPoint pathpoint14 = this.openPoint(currentPoint.xCoord - 1, currentPoint.yCoord + 1, currentPoint.zCoord);
            if (pathpoint14 != null && !pathpoint14.visited && pathpoint14.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint14;
            }
        }
        if (flag && flag6) {
            final PathPoint pathpoint15 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord - 1, currentPoint.zCoord - 1);
            if (pathpoint15 != null && !pathpoint15.visited && pathpoint15.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint15;
            }
        }
        if (flag2 && flag6) {
            final PathPoint pathpoint16 = this.openPoint(currentPoint.xCoord, currentPoint.yCoord - 1, currentPoint.zCoord + 1);
            if (pathpoint16 != null && !pathpoint16.visited && pathpoint16.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint16;
            }
        }
        if (flag3 && flag6) {
            final PathPoint pathpoint17 = this.openPoint(currentPoint.xCoord + 1, currentPoint.yCoord - 1, currentPoint.zCoord);
            if (pathpoint17 != null && !pathpoint17.visited && pathpoint17.distanceTo(targetPoint) < maxDistance) {
                pathOptions[i++] = pathpoint17;
            }
        }
        if (flag4 && flag6) {
            final PathPoint pathpoint18 = this.openPoint(currentPoint.xCoord - 1, currentPoint.yCoord - 1, currentPoint.zCoord);
    ...
    protected PathPoint openPoint(final int x, final int y, final int z) {
        ...
        final PathNodeType pathnodetype = this.func_192558_a(this.entity, x, y, z);
    ...
    private PathNodeType func_192559_a(final EntityLiving p_192559_1_, final BlockPos p_192559_2_) {
        return this.func_192558_a(p_192559_1_, p_192559_2_.getX(), p_192559_2_.getY(), p_192559_2_.getZ());
    }
    
    private PathNodeType func_192558_a(final EntityLiving p_192558_1_, final int p_192558_2_, final int p_192558_3_, final int p_192558_4_) {
