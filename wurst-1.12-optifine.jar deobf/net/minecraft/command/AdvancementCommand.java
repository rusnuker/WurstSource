...
public class AdvancementCommand extends CommandBase
{
    ...
    public void execute(final MinecraftServer server, final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (advancementcommand$actiontype != null) {
            ...
            final Mode advancementcommand$actiontype$mode = Mode.func_193547_a(args[2]);
    ...
    public List<String> getTabCompletionOptions(final MinecraftServer server, final ICommandSender sender, final String[] args, @Nullable final BlockPos pos) {
        ...
        if (advancementcommand$actiontype != null) {
            ...
            if (advancementcommand$actiontype$mode != null && advancementcommand$actiontype$mode != Mode.EVERYTHING) {
                ...
                if (args.length == 5 && advancementcommand$actiontype$mode == Mode.ONLY) {
    ...
    enum ActionType
    {
        ...
        private ActionType(final String name, final int ordinal, final String p_i47557_3_) {
    ...
    enum Mode
    {
        ...
        private Mode(final String name, final int ordinal, final String p_i47556_3_, final boolean p_i47556_4_, final boolean p_i47556_5_) {
        ...
        static Mode func_193547_a(final String p_193547_0_) {
            Mode[] values;
            for (int length = (values = values()).length, i = 0; i < length; ++i) {
                final Mode advancementcommand$actiontype$mode = values[i];
