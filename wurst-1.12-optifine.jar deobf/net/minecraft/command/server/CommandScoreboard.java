...
public class CommandScoreboard extends CommandBase
{
    ...
    private boolean handleUserWildcards(final MinecraftServer server, final ICommandSender sender, final String[] args) throws CommandException {
        ...
        final List<String> list1 = Lists.newArrayList((Iterable)this.getScoreboard(server).getObjectiveNames());
    ...
    protected ScorePlayerTeam convertToTeam(final String p_184915_1_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final ScorePlayerTeam scoreplayerteam = scoreboard.getTeam(p_184915_1_);
    ...
    protected void addTeam(final ICommandSender sender, final String[] p_184910_2_, int p_184910_3_, final MinecraftServer server) throws CommandException {
        final String s = p_184910_2_[p_184910_3_++];
        final Scoreboard scoreboard = this.getScoreboard(server);
        ...
        if (p_184910_2_.length > p_184910_3_) {
            final String s2 = CommandBase.getChatComponentFromNthArg(sender, p_184910_2_, p_184910_3_).getUnformattedText();
            if (s2.length() > 32) {
    ...
    protected void setTeamOption(final ICommandSender sender, final String[] p_184923_2_, int p_184923_3_, final MinecraftServer server) throws CommandException {
        final ScorePlayerTeam scoreplayerteam = this.convertToTeam(p_184923_2_[p_184923_3_++], server);
        if (scoreplayerteam != null) {
            final String s = p_184923_2_[p_184923_3_++].toLowerCase(Locale.ROOT);
            ...
            if (p_184923_2_.length == 4) {
                ...
                final String s2 = p_184923_2_[p_184923_3_];
                if ("color".equalsIgnoreCase(s)) {
                ...
                CommandBase.notifyCommandListener(sender, this, "commands.scoreboard.teams.option.success", s, scoreplayerteam.getRegisteredName(), s2);
            }
        }
    }
    
    protected void removeTeam(final ICommandSender sender, final String[] p_184921_2_, final int p_184921_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final ScorePlayerTeam scoreplayerteam = this.convertToTeam(p_184921_2_[p_184921_3_], server);
        if (scoreplayerteam != null) {
    ...
    protected void listTeams(final ICommandSender sender, final String[] p_184922_2_, final int p_184922_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        if (p_184922_2_.length > p_184922_3_) {
            final ScorePlayerTeam scoreplayerteam = this.convertToTeam(p_184922_2_[p_184922_3_], server);
            if (scoreplayerteam == null) {
                return;
            }
            ...
            final TextComponentTranslation textcomponenttranslation = new TextComponentTranslation("commands.scoreboard.teams.list.player.count", new Object[] { collection.size(), scoreplayerteam.getRegisteredName() });
            textcomponenttranslation.getStyle().setColor(TextFormatting.DARK_GREEN);
            sender.addChatMessage(textcomponenttranslation);
            sender.addChatMessage(new TextComponentString(CommandBase.joinNiceString(collection.toArray())));
        }
        else {
            ...
            for (final ScorePlayerTeam scoreplayerteam2 : collection2) {
                sender.addChatMessage(new TextComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] { scoreplayerteam2.getRegisteredName(), scoreplayerteam2.getTeamName(), scoreplayerteam2.getMembershipCollection().size() }));
            }
        }
    }
    
    protected void joinTeam(final ICommandSender sender, final String[] p_184916_2_, int p_184916_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final String s = p_184916_2_[p_184916_3_++];
        ...
        if (sender instanceof EntityPlayer && p_184916_3_ == p_184916_2_.length) {
            ...
            while (p_184916_3_ < p_184916_2_.length) {
                final String s3 = p_184916_2_[p_184916_3_++];
                if (EntitySelector.hasArguments(s3)) {
    ...
    protected void leaveTeam(final ICommandSender sender, final String[] p_184911_2_, int p_184911_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final Set<String> set = Sets.newHashSet();
        final Set<String> set2 = Sets.newHashSet();
        if (sender instanceof EntityPlayer && p_184911_3_ == p_184911_2_.length) {
            ...
            while (p_184911_3_ < p_184911_2_.length) {
                final String s4 = p_184911_2_[p_184911_3_++];
                if (EntitySelector.hasArguments(s4)) {
    ...
    protected void emptyTeam(final ICommandSender sender, final String[] p_184917_2_, final int p_184917_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final ScorePlayerTeam scoreplayerteam = this.convertToTeam(p_184917_2_[p_184917_3_], server);
        if (scoreplayerteam != null) {
            final Collection<String> collection = Lists.newArrayList((Iterable)scoreplayerteam.getMembershipCollection());
    ...
    protected void setDisplayObjective(final ICommandSender sender, final String[] p_184919_2_, int p_184919_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final String s = p_184919_2_[p_184919_3_++];
    ...
    protected void listPlayers(final ICommandSender sender, final String[] p_184920_2_, final int p_184920_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        if (p_184920_2_.length > p_184920_3_) {
            final String s = CommandBase.getEntityName(server, sender, p_184920_2_[p_184920_3_]);
            ...
            for (final Score score : map.values()) {
                sender.addChatMessage(new TextComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[] { score.getScorePoints(), score.getObjective().getDisplayName(), score.getObjective().getName() }));
            }
        }
        else {
    ...
    protected void addPlayerScore(final ICommandSender sender, final String[] p_184918_2_, int p_184918_3_, final MinecraftServer server) throws CommandException {
        final String s = p_184918_2_[p_184918_3_ - 1];
        final int i = p_184918_3_;
        final String s2 = CommandBase.getEntityName(server, sender, p_184918_2_[p_184918_3_++]);
        if (s2.length() > 40) {
            throw new SyntaxErrorException("commands.scoreboard.players.name.tooLong", new Object[] { s2, 40 });
        }
        final ScoreObjective scoreobjective = this.convertToObjective(p_184918_2_[p_184918_3_++], true, server);
        final int j = "set".equalsIgnoreCase(s) ? CommandBase.parseInt(p_184918_2_[p_184918_3_++]) : CommandBase.parseInt(p_184918_2_[p_184918_3_++], 0);
        if (p_184918_2_.length > p_184918_3_) {
            final Entity entity = CommandBase.getEntity(server, sender, p_184918_2_[i]);
            try {
                final NBTTagCompound nbttagcompound = JsonToNBT.getTagFromJson(CommandBase.buildString(p_184918_2_, p_184918_3_));
    ...
    protected void resetPlayerScore(final ICommandSender sender, final String[] p_184912_2_, int p_184912_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final String s = CommandBase.getEntityName(server, sender, p_184912_2_[p_184912_3_++]);
        if (p_184912_2_.length > p_184912_3_) {
            final ScoreObjective scoreobjective = this.convertToObjective(p_184912_2_[p_184912_3_++], false, server);
    ...
    protected void enablePlayerTrigger(final ICommandSender sender, final String[] p_184914_2_, int p_184914_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final String s = CommandBase.getPlayerName(server, sender, p_184914_2_[p_184914_3_++]);
        if (s.length() > 40) {
            throw new SyntaxErrorException("commands.scoreboard.players.name.tooLong", new Object[] { s, 40 });
        }
        final ScoreObjective scoreobjective = this.convertToObjective(p_184914_2_[p_184914_3_], false, server);
    ...
    protected void testPlayerScore(final ICommandSender sender, final String[] p_184907_2_, int p_184907_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final String s = CommandBase.getEntityName(server, sender, p_184907_2_[p_184907_3_++]);
        if (s.length() > 40) {
            throw new SyntaxErrorException("commands.scoreboard.players.name.tooLong", new Object[] { s, 40 });
        }
        final ScoreObjective scoreobjective = this.convertToObjective(p_184907_2_[p_184907_3_++], false, server);
        ...
        final int i = p_184907_2_[p_184907_3_].equals("*") ? Integer.MIN_VALUE : CommandBase.parseInt(p_184907_2_[p_184907_3_]);
        final int j = (++p_184907_3_ < p_184907_2_.length && !p_184907_2_[p_184907_3_].equals("*")) ? CommandBase.parseInt(p_184907_2_[p_184907_3_], i) : Integer.MAX_VALUE;
        final Score score = scoreboard.getOrCreateScore(s, scoreobjective);
    ...
    protected void applyPlayerOperation(final ICommandSender sender, final String[] p_184906_2_, int p_184906_3_, final MinecraftServer server) throws CommandException {
        final Scoreboard scoreboard = this.getScoreboard(server);
        final String s = CommandBase.getEntityName(server, sender, p_184906_2_[p_184906_3_++]);
        final ScoreObjective scoreobjective = this.convertToObjective(p_184906_2_[p_184906_3_++], true, server);
        final String s2 = p_184906_2_[p_184906_3_++];
        final String s3 = CommandBase.getEntityName(server, sender, p_184906_2_[p_184906_3_++]);
        final ScoreObjective scoreobjective2 = this.convertToObjective(p_184906_2_[p_184906_3_], false, server);
        if (s.length() > 40) {
            throw new SyntaxErrorException("commands.scoreboard.players.name.tooLong", new Object[] { s, 40 });
        }
        if (s3.length() > 40) {
    ...
    protected void applyPlayerTag(final MinecraftServer server, final ICommandSender sender, final String[] p_184924_3_, int p_184924_4_) throws CommandException {
        final String s = CommandBase.getEntityName(server, sender, p_184924_3_[p_184924_4_]);
        final Entity entity = CommandBase.getEntity(server, sender, p_184924_3_[p_184924_4_++]);
        final String s2 = p_184924_3_[p_184924_4_++];
        ...
        if ("list".equals(s2)) {
            if (!set.isEmpty()) {
                ...
                textcomponenttranslation.getStyle().setColor(TextFormatting.DARK_GREEN);
                sender.addChatMessage(textcomponenttranslation);
                sender.addChatMessage(new TextComponentString(CommandBase.joinNiceString(set.toArray())));
            }
            ...
            final String s3 = p_184924_3_[p_184924_4_++];
            if (p_184924_3_.length > p_184924_4_) {
                try {
                    final NBTTagCompound nbttagcompound = JsonToNBT.getTagFromJson(CommandBase.buildString(p_184924_3_, p_184924_4_));
                    final NBTTagCompound nbttagcompound2 = CommandBase.entityToNBT(entity);
                    if (!NBTUtil.areNBTEquals(nbttagcompound, nbttagcompound2, true)) {
