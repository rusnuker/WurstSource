...
public abstract class CommandBase implements ICommand
{
    ...
    public static List<EntityPlayerMP> func_193513_a(final MinecraftServer p_193513_0_, final ICommandSender p_193513_1_, final String p_193513_2_) throws CommandException {
        final List<EntityPlayerMP> list = EntitySelector.func_193531_b(p_193513_1_, p_193513_2_);
        return list.isEmpty() ? Lists.newArrayList((Object[])new EntityPlayerMP[] { func_193512_a(p_193513_0_, null, p_193513_2_) }) : list;
    }
    ...
    private static EntityPlayerMP func_193512_a(final MinecraftServer p_193512_0_, @Nullable EntityPlayerMP p_193512_1_, final String p_193512_2_) throws CommandException {
        if (p_193512_1_ == null) {
            try {
    ...
    public static List<Entity> getEntityList(final MinecraftServer server, final ICommandSender sender, final String target) throws EntityNotFoundException, CommandException {
        return EntitySelector.hasArguments(target) ? EntitySelector.matchEntities(sender, target, (Class<? extends Entity>)Entity.class) : Lists.newArrayList((Object[])new Entity[] { getEntity(server, sender, target) });
    }
    ...
    public static String getEntityName(final MinecraftServer server, final ICommandSender sender, final String target) throws EntityNotFoundException, CommandException {
        ...
        catch (final PlayerNotFoundException var6) {
            try {
    ...
    public static IBlockState func_190794_a(final Block p_190794_0_, final String p_190794_1_) throws NumberInvalidException, InvalidBlockStateException {
        try {
            ...
            try {
                final Map<IProperty<?>, Comparable<?>> map = func_190795_c(p_190794_0_, p_190794_1_);
    ...
    private static <T extends Comparable<T>> IBlockState func_190793_a(final IBlockState p_190793_0_, final IProperty<T> p_190793_1_, final Comparable<?> p_190793_2_) {
        return p_190793_0_.withProperty(p_190793_1_, p_190793_2_);
    }
    
    public static Predicate<IBlockState> func_190791_b(final Block p_190791_0_, final String p_190791_1_) throws InvalidBlockStateException {
    ...
    private static Map<IProperty<?>, Comparable<?>> func_190795_c(final Block p_190795_0_, final String p_190795_1_) throws InvalidBlockStateException {
        final Map<IProperty<?>, Comparable<?>> map = Maps.newHashMap();
        ...
        for (final String s : CommandBase.field_190796_b.split((CharSequence)p_190795_1_)) {
            final Iterator<String> iterator2 = CommandBase.field_190797_c.split((CharSequence)s).iterator();
            if (iterator2.hasNext()) {
                final IProperty<?> iproperty = blockstatecontainer.getProperty(iterator2.next());
                if (iproperty != null) {
                    if (iterator2.hasNext()) {
                        final Comparable<?> comparable = func_190792_a(iproperty, iterator2.next());
                        if (comparable != null) {
    ...
    @Nullable
    private static <T extends Comparable<T>> T func_190792_a(final IProperty<T> p_190792_0_, final String p_190792_1_) {
