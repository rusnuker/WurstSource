...
public enum EnumTokenType
{
    ...
    private EnumTokenType(final String name, final int ordinal, final String charsFirst) {
        this.charsFirst = charsFirst;
        this.charsExt = "";
    }
    
    private EnumTokenType(final String name, final int ordinal, final String charsFirst, final int maxLen) {
        this.charsFirst = charsFirst;
        this.charsExt = "";
        this.maxLen = maxLen;
    }
    
    private EnumTokenType(final String name, final int ordinal, final String charsFirst, final String charsExt) {
        this.charsFirst = charsFirst;
