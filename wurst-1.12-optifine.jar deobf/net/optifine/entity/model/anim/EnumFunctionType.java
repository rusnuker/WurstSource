...
public enum EnumFunctionType
{
    ...
    private EnumFunctionType(final String name2, final int ordinal, final String name, final int countArguments) {
        this.name = name;
        this.countArguments = countArguments;
    }
    
    private EnumFunctionType(final String name2, final int ordinal, final String name, final int countArguments, final int precedence) {
        this.name = name;
        this.countArguments = countArguments;
