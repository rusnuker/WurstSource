...
public class ShadersTex
{
    ...
    public static int[][] readImageAndMipmaps(final String name, final int width, final int height, final int numLevels, final boolean border, final int defColor) {
        ...
        boolean flag = false;
        final BufferedImage bufferedimage = readImage(ShadersTex.updatingTextureMap.completeResourceLocation(new ResourceLocation(name)));
    ...
    public static void loadLayeredTexture(final LayeredTexture tex, final IResourceManager manager, final List<String> list) {
        int i = 0;
        int j = 0;
        int k = 0;
        int[] aint = null;
    ...
    static void updateTextureMinMagFilter() {
        ...
        final ITextureObject itextureobject = texturemanager.getTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
