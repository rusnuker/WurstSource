...
public class Iterator3d implements Iterator<BlockPos>
{
    ...
    public Iterator3d(BlockPos posStart, BlockPos posEnd, final int width, final int height) {
        ...
        this.kY = (flag2 ? -1 : 1);
        this.kZ = (flag3 ? -1 : 1);
        final Vec3d vec3d = new Vec3d(posEnd.getX() - posStart.getX(), posEnd.getY() - posStart.getY(), posEnd.getZ() - posStart.getZ());
        final Vec3d vec3d2 = vec3d.normalize();
        final Vec3d vec3d3 = new Vec3d(1.0, 0.0, 0.0);
        final double d0 = vec3d2.dotProduct(vec3d3);
        final double d2 = Math.abs(d0);
        final Vec3d vec3d4 = new Vec3d(0.0, 1.0, 0.0);
        final double d3 = vec3d2.dotProduct(vec3d4);
        final double d4 = Math.abs(d3);
        final Vec3d vec3d5 = new Vec3d(0.0, 0.0, 1.0);
        final double d5 = vec3d2.dotProduct(vec3d5);
